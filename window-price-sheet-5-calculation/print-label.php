...
$window_price_sheet_5_calculation_quote_tables_SKINS = "";
$window_price_sheet_5_calculation_quote_tables_TUBES = "";
$window_price_sheet_5_calculation_quote_tables_FB = "";
...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_2 = "SELECT name FROM window_price_sheet_5_calculation_quote_item_per_meters WHERE window_price_sheet_5_calculation_quote_item_code = ? AND window_price_sheet_5_calculation_code = ? AND cid = ?";
            ...
            $stmt_3_2->execute();
            $stmt_3_2->bind_result($window_price_sheet_5_calculation_quote_item_per_meter_name);
            $stmt_3_2->fetch();
            $stmt_3_2->close();

            while ($stmt_3_1->fetch()) {

                // if ($window_price_sheet_5_calculation_field_name === 'Location_1') {
                ...
                if ($window_price_sheet_5_calculation_field_name === 'Bottom Rail Size') {
                    $window_price_sheet_5_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_5_calculation_quote_item_field_name;
                }

                if ($window_price_sheet_5_calculation_field_name === 'Control Option') {
                    $window_price_sheet_5_calculation_quote_item_Control_Option = $window_price_sheet_5_calculation_quote_item_field_name;
                }

                if ($window_price_sheet_5_calculation_field_name === 'Contorl Size') {
                    $window_price_sheet_5_calculation_quote_item_Contorl_Size = $window_price_sheet_5_calculation_quote_item_field_name;
                }

                if ($window_price_sheet_5_calculation_field_name === 'Control Type') {
                    $window_price_sheet_5_calculation_quote_item_Control_Type = explode(' | ', $window_price_sheet_5_calculation_quote_item_field_name)[0];
            ...
            $window_price_sheet_5_calculation_quote_tables_SKINS .= '<table cellspacing="0" cellpadding="2" style="border:1px solid #000;" nobr="true">'
                    . '<tr>'
                    ...
                    . $window_price_sheet_5_calculation_quote_item_width_skins . ' x ' . $window_price_sheet_5_calculation_quote_item_drop_skins
                    . '</td>'
                    ...
                    . strtoupper(explode('<->', $window_price_sheet_5_calculation_quote_item_material)[0])
                    . '</td>'
                    . '<td style="text-align: center; border:1px solid #000; line-height: 10px; font-size: 8px;">'
                    . strtoupper(explode('<->', $window_price_sheet_5_calculation_quote_item_colour)[0])
                    . '</td>'
                    . '<td rowspan="2" style="text-align: center; border:1px solid #000; line-height: 20px;  font-size: 8px;">'
                    . strtoupper($window_price_sheet_5_calculation_quote_item_Direction)
                    . '</td>'
                    . '</tr>'
                    . '<tr>'
                    . '<td style="text-align: center; border:1px solid #000; line-height: 10px; font-size: 8px;">'
                    ...
                    . '</td>'
                    . '<td style="text-align: center; border:1px solid #000; line-height: 10px; font-size: 8px;">'
                    . strtoupper(explode('<->', $window_price_sheet_5_calculation_quote_item_location)[0])
                    . '</td>'
                    . '</tr>'
                    . '</table>';

            $window_price_sheet_5_calculation_quote_tables_TUBES .= '<table cellspacing="0" cellpadding="2" style="border:1px solid #000;" nobr="true">'
                    . '<tr>'
                    ...
                    . $window_price_sheet_5_calculation_quote_item_width_skins_Tube_Length . 'mm'
                    . '</td>'
                    ...
                    . '<tr>'
                    . '<td style="width: 105px; font-weight: bold; text-align: center; border:1px solid #000; line-height: 22px; font-size: 14px;">'
                    . strtoupper($window_price_sheet_5_calculation_quote_item_Tube_Type)
                    . '</td>'
                    . '</tr>'
                    . '</table>';

        $window_price_sheet_5_calculation_quote_tables_FB .= '<table cellspacing="0" cellpadding="2" style="border:1px solid #000;" nobr="true">'
                    . '<tr>'
                    ...
                    . $window_price_sheet_5_calculation_quote_item_width . ' x ' . $window_price_sheet_5_calculation_quote_item_drop
                    . '</td>'
                    ...
                    . strtoupper($window_price_sheet_5_calculation_quote_item_Control_Type)
                    . '</td>'
                    . '<td style="text-align: center; border:1px solid #000; line-height: 9px; font-size: 8px;">'
                    . strtoupper( $window_price_sheet_5_calculation_quote_item_Bottom_Rail_Size)
                    . '</td>'
                    . '</tr>'
                    . '<tr>'
                    . '<td style="text-align: center; border:1px solid #000; line-height: 9px; font-size: 8px;">'
