    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                if ($form_no_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #787877;">' . $form_no_calculation_quote_item_field_name . '</td>';
                }
                if ($form_no_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #787877;">' . $form_no_calculation_quote_item_field_name . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $location_td = $locations_select === 1 && $location_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $form_no_calculation_quote_item_location)[0] . '</td>' : '';
            $cost_td = $cost_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . $form_no_calculation_quote_item_cost . '</td>' : '';
            $markup_td = $markup_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . $form_no_calculation_quote_item_markup . '</td>' : '';
            $price_td = $price_print[1] === '1' ? '<td style="text-align: right; border: 0.5px solid #787877;">' . number_format($form_no_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($form_no_calculation_quote_item_notes || $form_no_calculation_quote_item_accessories || $form_no_calculation_quote_item_per_meters || $form_no_calculation_quote_item_fitting_charges) {
                ...
                if ($accessories_select === 1 && $accessory_print[1] === '1' && $form_no_calculation_quote_item_accessories ||
