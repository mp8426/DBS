...
while ($stmt_1->fetch()) {
    ...
    $dynamic_field_qty_th = $dynamic_field_qty_select === 1 && $dynamic_field_qty_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">Qty</td>' : '';
    $price_th = $price_print[0] === '1' ? '<th style="text-align: right; border: 0.5px solid #000000;">Price</th>' : '';
    $qty_th = $qty_select === 1 && $total_print[0] === '1' ? '<th style="text-align: center; border: 0.5px solid #000000;">Qty</th>' : '';
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $cost_td = $cost_select === 1 && $cost_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_cost . '</td>' : '';
            $markup_td = $markup_select === 1 && $markup_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_markup . '</td>' : '';
            $dynamic_field_qty_td = $dynamic_field_qty_select === 1 && $dynamic_field_qty_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_dynamic_field_qty . '</td>' : '';
            ...
            $qty_td = $qty_select === 1 && $qty_print[0] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_qty . '</td>' : '';
            $total_td = $qty_select === 1 && $total_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($form_no_calculation_quote_item_total, 2) . '</td>' : '';

            $cost_td_num_rows = $cost_select === 1 && $cost_print[0] === '1' ? 1 : 0;
            $markup_td_num_rows = $markup_select === 1 && $markup_print[0] === '1' ? 1 : 0;
            $dynamic_field_qty_td_num_rows = $dynamic_field_qty_select === 1 && $dynamic_field_qty_print[0] === '1' ? 1 : 0;
            ...
            if ($form_no_calculation_quote_item_notes || $form_no_calculation_quote_item_accessories || $form_no_calculation_quote_item_per_meters || $form_no_calculation_quote_item_fitting_charges) {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[0] === '1' && $form_no_calculation_quote_item_accessories ||
