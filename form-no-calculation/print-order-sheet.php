...
$query_1 = "SELECT name, locations, accessories, per_meters, fitting_charges FROM form_no_calculations WHERE code = ? ORDER BY position ASC";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('s', $form_no_calculation_code);
$stmt_1->execute();
$stmt_1->bind_result($form_no_calculation_name, $locations_select, $accessories_select, $per_meters_select, $fitting_charges_select);
$stmt_1->store_result();
...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM form_no_calculation_fields WHERE order_sheet = 1 AND form_no_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $form_no_calculation_quote_item_price_sub_total = $form_no_calculation_quote_item_price_sub_total + $form_no_calculation_quote_item_price;
            ...
            $query_3_1 = "SELECT form_no_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "form_no_calculation_fields.order_sheet = 1 AND "
            ...
            $stmt_3_1->execute();
            $stmt_3_1->bind_result($form_no_calculation_quote_item_field_name, $form_no_calculation_field_side);
            ...
            $location_td = $locations_select === 1 && $location_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $form_no_calculation_quote_item_location)[0] . '</td>' : '';
            $cost_td = $cost_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_cost . '</td>' : '';
            $markup_td = $markup_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_markup . '</td>' : '';
            $price_td = $price_print[2] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($form_no_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($form_no_calculation_quote_item_notes || $form_no_calculation_quote_item_accessories || $form_no_calculation_quote_item_per_meters || $form_no_calculation_quote_item_fitting_charges) {
                ...
                if ($form_no_calculation_quote_item_notes && $note_print[2] === '1') {
                ...
                if ($form_no_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[2] === '1') {
                ...
                if ($form_no_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[2] === '1') {
                ...
                if ($form_no_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[2] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[2] === '1' && $form_no_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[2] === '1' && $form_no_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[2] === '1' && $form_no_calculation_quote_item_fitting_charges
                ) {
            ...
            if ($group_discount_print[2] === '1') {
                ...
                $form_no_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $form_no_calculation_total_table_colspan . '">Sub Total </th>'
                        ...
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $form_no_calculation_total_table_colspan . '">Discount (' . $form_no_calculation_quote_item_discount . '%) </th>'
