...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM form_no_calculation_fields WHERE " . $print_type . " = 1 AND form_no_calculation_code = ? ORDER BY position ASC";
    ...
    $form_no_calculation_table_header = '<table><thead>'
            . '<tr><th colspan="' . $tot_th_colspan_x . '"><strong>' . $form_no_calculation_name . '</strong></th></tr>'
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT form_no_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "form_no_calculation_fields." . $print_type . " = 1 AND "
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($form_no_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_field_name . $form_no_calculation_quote_item_field_price_x . '</td>';
                }
                if ($form_no_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_field_name . $form_no_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $form_no_calculation_quote_item_accessories .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Accessory - ' . $form_no_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $form_no_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $form_no_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($form_no_calculation_quote_item_accessory_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $form_no_calculation_quote_item_per_meters .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Per Meter - ' . $form_no_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $form_no_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $form_no_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($form_no_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $form_no_calculation_quote_item_fitting_charges .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Fitting Charge - ' . $form_no_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $form_no_calculation_quote_item_fitting_charge_price . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            $location_td = $locations_select === 1 && $location_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $form_no_calculation_quote_item_location)[0] . '</td>' : '';
            $cost_td = $cost_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_cost . '</td>' : '';
            $markup_td = $markup_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $form_no_calculation_quote_item_markup . '</td>' : '';
            $price_td = $price_print[$no] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($form_no_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($form_no_calculation_quote_item_notes || $form_no_calculation_quote_item_accessories || $form_no_calculation_quote_item_per_meters || $form_no_calculation_quote_item_fitting_charges) {
                ...
                if ($form_no_calculation_quote_item_notes && $note_print[$no] === '1') {

                    $form_no_calculation_quote_item_notes_table = '<tr>'
                ...
                if ($form_no_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[$no] === '1') {

                    $form_no_calculation_quote_item_accessories_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                ...
                if ($form_no_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[$no] === '1') {

                    $form_no_calculation_quote_item_per_meters_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($form_no_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1') {

                    $form_no_calculation_quote_item_fitting_charges_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($accessories_select === 1 && $accessory_print[$no] === '1' && $form_no_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[$no] === '1' && $form_no_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1' && $form_no_calculation_quote_item_fitting_charges
                ) {


                    $table_more .= $form_no_calculation_quote_item_accessories_table
                            . $form_no_calculation_quote_item_per_meters_table
                            . $form_no_calculation_quote_item_fitting_charges_table;
                } else {
                    $table_more .= "";
            ...
            $form_no_calculation_quote_items .= '<tr>'
            ...
            if ($group_discount_print[$no] === '1') {
                ...
                $form_no_calculation_total_table_colspan = $location_td_num_rows + $field_td_num_rows + $price_td_num_rows + $cost_td_num_rows + $markup_td_num_rows;
                $form_no_calculation_total = '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $form_no_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($form_no_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $form_no_calculation_total_table_colspan . '">Discount (' . $form_no_calculation_quote_item_discount . ' % ) </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">-' . number_format($form_no_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        . '<tr>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $form_no_calculation_total_table_colspan . '">Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($form_no_calculation_quote_item_price_total, 2) . '</th>'
                        . '</tr>';
            } else {
        ...
        $form_no_calculation_quote_tables .= $form_no_calculation_table_header . $form_no_calculation_quote_items . $form_no_calculation_total . "</tbody></table>";
        $form_no_calculation_quote_tables_2 .= "";
    } else {
        $form_no_calculation_quote_tables .= "";
        $form_no_calculation_quote_tables_2 .= "";
    }
