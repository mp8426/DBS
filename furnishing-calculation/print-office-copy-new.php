...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        $furnishing_calculation_quote_tables .='<span nobr="true">' . $furnishing_calculation_table_header . $furnishing_calculation_quote_items . $furnishing_calculation_total . "</span><div></div>";
    } else {
        $furnishing_calculation_quote_tables .= "";
    }
    $stmt_3->close();
