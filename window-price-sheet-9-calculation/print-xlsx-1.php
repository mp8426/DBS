    ...
    if($calculation_name === 'Ziptrak'){
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_price_sheet_9_calculation_field_name === 'Track Colour') {
                ...
                if ($window_price_sheet_9_calculation_field_name === 'Hood / Brackets') {
                    $window_price_sheet_9_calculation_quote_item_Hood_Type = $window_price_sheet_9_calculation_quote_item_field_name;
                }

                if ($window_price_sheet_9_calculation_field_name === 'Hood / Bracket Colour') {
            ...
            $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_9_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_9_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_9_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_9_calculation_quote_item_Hood_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Hood_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_fitting_type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_track_Colour . '</td>'
                    . '</tr>';

                    $window_price_sheet_9_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_9_calculation_quote_item_location)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_9_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_9_calculation_quote_item_type)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_9_calculation_quote_item_colour)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_width . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_drop . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Skins_width_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Skins_drop_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Tube_Type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_9_calculation_quote_item_Tube_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_9_calculation_quote_item_Hood_Type . '</td>'
                            //. '<td>' . $window_price_sheet_9_calculation_quote_item_mounting_rail_length . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Hood_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Hood_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Size . '</td>'
        
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                            
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Fittment . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_fitting_type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_track_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Weight_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                    ...
                    $window_price_sheet_9_calculation_quote_tables_2 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_drop_skins . '</td>'
            ...
            $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_9_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Tube_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_width_skins_Tube_Length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bracket_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Size . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_width . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_9_calculation_quote_item_drop . '</td>'
                    //. '<td>' . $window_price_sheet_9_calculation_quote_item_mounting_rail_length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Direction . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Fit . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Chain_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_Chain_Size . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_width_skins . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_drop_skins . '</td>'
                    //. '<td>' . get_price_from_csv($csv_price_sheet, $window_price_sheet_9_calculation_quote_item_width, $window_price_sheet_9_calculation_quote_item_drop) . '</td>'
                    //. '<td style="background-color: #ff0;">' . $window_price_sheet_9_calculation_quote_item_No_Of_Rail_Brackets . '</td>'
                    //. '<td>' . $window_price_sheet_9_calculation_quote_item_Bracket_Covers . '</td>'
                    . '</tr>';
