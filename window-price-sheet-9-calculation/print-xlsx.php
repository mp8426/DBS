        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $window_price_sheet_9_calculation_quote_item_accessories .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="10">Accessory - ' . $window_price_sheet_9_calculation_quote_item_accessory_name . '</td>'
            ...
            while ($stmt_3_3->fetch()) {
                ...
                . '<td style="border: 1px solid #000000; text-align: left;">' . $quote_item_no . '. ' . $quote_item_per_meter_no . '</td>'
                        . '<td style=" text-align: left; border-right: 0.5px solid #000000;" colspan="10">Permeter - ' . $window_price_sheet_9_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_9_calculation_quote_item_per_meter_width . '</td>'
                        . '</tr>';
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_9_calculation_quote_item_Skins_drop_size = $window_price_sheet_9_calculation_quote_item_drop + 310; if ($window_price_sheet_9_calculation_quote_item_notes) {
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_9_calculation_quote_item_Skins_drop_size = $window_price_sheet_9_calculation_quote_item_drop + 400; if ($window_price_sheet_9_calculation_quote_item_notes) {
