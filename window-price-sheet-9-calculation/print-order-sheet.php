...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        $window_price_sheet_9_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.9em; text-align: center;" border="1">'
            ...
            $window_price_sheet_9_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.9em; text-align: center;" border="1">'
                    . '<tr>'
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $window_price_sheet_9_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="text-align: left; border-right: 0.5px solid #000000;">' . $quote_item_accessory_no . '. ' . $window_price_sheet_9_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="text-align: center;">' . $window_price_sheet_9_calculation_quote_item_accessory_qty . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $window_price_sheet_9_calculation_quote_item_per_meters .= '<tr>'
                        . '<td style=" text-align: left; border-right: 0.5px solid #000000;">' . $quote_item_per_meter_no . '. ' . $window_price_sheet_9_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="text-align: center;">' . $window_price_sheet_9_calculation_quote_item_per_meter_width . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_price_sheet_9_calculation_field_name === 'Location') {
                ...
                if ($window_price_sheet_9_calculation_field_name === 'Tube Type') {
                    ...
                    $window_price_sheet_9_calculation_quote_item_Tube_Type = explode(' | ', $window_price_sheet_9_calculation_quote_item_field_name)[0];
                    $window_price_sheet_9_calculation_quote_item_Tube_Type_width_deduction = explode(' | ', $window_price_sheet_9_calculation_quote_item_field_name)[3];
                }
                ...
                if ($window_price_sheet_9_calculation_field_name === 'Control Type') {
                    ...
                    // if(!$window_price_sheet_9_calculation_quote_item_width_skins){
                    //     $window_price_sheet_9_calculation_quote_item_width_skins = $window_price_sheet_9_calculation_quote_item_width - explode(' | ', $window_price_sheet_9_calculation_quote_item_field_name)[3];
                    // }
                ...
                if ($window_price_sheet_9_calculation_field_name === 'Main Slat Colour') {
                    $window_price_sheet_9_calculation_quote_item_Main_Slat_Colour = $window_price_sheet_9_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_9_calculation_field_name === 'Stripe Required?') {
                    $window_price_sheet_9_calculation_quote_item_Stripe_Required = $window_price_sheet_9_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_9_calculation_field_name === 'Stripe Type (From Bottom)') {
                    $window_price_sheet_9_calculation_quote_item_Stripe_Type = $window_price_sheet_9_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_9_calculation_field_name === 'Stripe Colour') {
                    $window_price_sheet_9_calculation_quote_item_Stripe_Colour = $window_price_sheet_9_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_9_calculation_field_name === 'Box Colour') {
                    $window_price_sheet_9_calculation_quote_item_Box_Colour = $window_price_sheet_9_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_9_calculation_field_name === 'Guide Colour') {
                    $window_price_sheet_9_calculation_quote_item_Guide_Colour = $window_price_sheet_9_calculation_quote_item_field_name;
                }
		...
		if($calculation_name === 'Roller Shutters'){
			$main_slat_size = $window_price_sheet_9_calculation_quote_item_width + $window_price_sheet_9_calculation_quote_item_fit_type_width - 71;
			$box_length = $window_price_sheet_9_calculation_quote_item_width - 10;
			$axle_size = $window_price_sheet_9_calculation_quote_item_width - 91;
			$width = $window_price_sheet_9_calculation_quote_item_width + $window_price_sheet_9_calculation_quote_item_fit_type_width;
            

            if($window_price_sheet_9_calculation_quote_item_fit_type_height === 'Finished Size'){
                $window_price_sheet_9_calculation_quote_item_fit_type_height_num = 0;
                }
                else{                       
                    $window_price_sheet_9_calculation_quote_item_fit_type_height_num = + $window_price_sheet_9_calculation_quote_item_box_size;
                    // $window_price_sheet_9_calculation_quote_item_fit_type_height_num = is_numeric($window_price_sheet_9_calculation_quote_item_fit_type_height);
                }

			$drop = $window_price_sheet_9_calculation_quote_item_drop + $window_price_sheet_9_calculation_quote_item_fit_type_height_num ;
            $guide_size = $drop - $window_price_sheet_9_calculation_quote_item_box_size;
			// $width = $window_price_sheet_9_calculation_quote_item_width + $window_price_sheet_9_calculation_quote_item_fit_type_width;
			$main_slat_qty = $main_slat_size;

            if ($window_price_sheet_9_calculation_quote_item_notes) {

                $window_price_sheet_9_calculation_quote_item_notes_table = '<tr>'
            ...
            if ($window_price_sheet_9_calculation_quote_item_accessories) {

                $window_price_sheet_9_calculation_quote_item_accessories_table =  '<tr>'
            ...
            if ($window_price_sheet_9_calculation_quote_item_per_meters) {

                $window_price_sheet_9_calculation_quote_item_per_meters_table =  '<tr style="font-size: 0.9em;">'
                        . '<td style="border: 0.5px solid #000000;" colspan="20">'
                        . '<table cellpadding="4" cellspacing="0" style="line-height: 6px;">'
                        . '<tr style="font-weight: bold; background-color: #f2f2f2;">'
            ...
            $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                    . '<td>' . $quote_item_no . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_location_1 . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_9_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_9_calculation_quote_item_type)[0] . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Main_Slat_Colour . '</td>'
                    . '<td>' . $main_slat_size . '</td>'
                    . '<td></td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Stripe_Required . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Stripe_Type . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Stripe_Colour . '</td>'
                    . '<td> </td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Box_Colour . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_box_size . '</td>'
                    . '<td>' . $box_length . '</td>'
                    . '<td>' . $axle_size . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Guide_Colour .'</td>'
                    . '<td>' . $guide_size . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_fit_type_width . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_fit_type_height . '</td>'
                    . '<td>' . $width . '</td>'
                    . '<td>' . $drop . '</td>'
                ...
                // if ($window_price_sheet_9_calculation_quote_item_accessories || $window_price_sheet_9_calculation_quote_item_per_meters
                // ) {
                ...
                $window_price_sheet_9_calculation_quote_tables_1 .= '<tr nobr="true">'
                . '<td>' . $quote_item_no . '</td>'
                . '<td>' . explode('<->', $window_price_sheet_9_calculation_quote_item_material)[0] . '</td>'
                . '<td>' . explode('<->', $window_price_sheet_9_calculation_quote_item_colour)[0] . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Colour . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Hood_Type . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Hood_Colour . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_fitting_type . '</td>'
                . '<td>' . $window_price_sheet_9_calculation_quote_item_track_Colour . '</td>'
                . '</tr>'
                . $window_price_sheet_9_calculation_quote_item_notes_table
                . $window_price_sheet_9_calculation_quote_item_accessories_table;
                // . $window_price_sheet_9_calculation_quote_item_per_meters_table;
                ...
                $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                        . '<td>' . $quote_item_no . '</td>'
                        . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_width . '</td>'
                        . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_drop . '</td>'
                        . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_Skins_width_size . '</td>'
                        . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_Skins_drop_size . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Size . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Tube_Type . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Tube_size . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Hood_size . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Size . '</td>'
                        . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_Weight_Size . '</td>'
                        // . '<td>' . $window_price_sheet_9_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                        . '</tr>';
                }
                    ...
                    $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                            ...
                            . '<td>' . $window_price_sheet_9_calculation_quote_item_Hood_size . '</td>'
                            . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Size . '</td>'
                            . '<td>' . $window_price_sheet_9_calculation_quote_item_Weight_Size . '</td>'
                            . '<td>' . $window_price_sheet_9_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                            . '</tr>';
                    }
                        ...
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                        . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_Hood_Type . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Hood_Colour . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                        . '<td>' . $window_price_sheet_9_calculation_quote_item_fitting_type . '</td>'
                        ...
                        $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                            ...
                            $window_price_sheet_9_calculation_quote_tables_1 .= '<tr nobr="true">'
                            . '<td>' . $quote_item_no . '</td>'
                            . '<td colspan="2">' . explode('<->', $window_price_sheet_9_calculation_quote_item_material)[0] . '</td>'
                            . '<td colspan="2">' . explode('<->', $window_price_sheet_9_calculation_quote_item_colour)[0] . '</td>'
                            // . '<td>' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                            // . '<td>' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                            // . '<td>' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Colour . '</td>'
                            . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_Hood_Type . '</td>'
                            ...
                            . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                            // . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                            . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_valance_type . '</td>'
                            . '<td>' . $window_price_sheet_9_calculation_quote_item_arm_size . '</td>'
                            . '</tr>'
                            . $window_price_sheet_9_calculation_quote_item_notes_table
                            . $window_price_sheet_9_calculation_quote_item_accessories_table;
                            // . $window_price_sheet_9_calculation_quote_item_per_meters_table;
                            ...
                            $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                                    ...
                                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_Skins_drop_size . '</td>'
                                    // . '<td>' . $window_price_sheet_9_calculation_quote_item_Side_Spline_Size . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_Tube_Type . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_Tube_size . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_Hood_size . '</td>'
                                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Size . '</td>'
                                    // . '<td>' . $window_price_sheet_9_calculation_quote_item_Weight_Size . '</td>'
                                    // . '<td>' . $window_price_sheet_9_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                                    . '</tr>';
                                ...
                                . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                                // . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                                . '<td>' . $window_price_sheet_9_calculation_quote_item_valance_type . '</td>'
                                . '<td>' . $window_price_sheet_9_calculation_quote_item_arm_size . '</td>'
                                . '</tr>'
                                . $window_price_sheet_9_calculation_quote_item_notes_table
                                . $window_price_sheet_9_calculation_quote_item_accessories_table;
                                ...
                                $window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                                    ...
                                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                                    // . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_9_calculation_quote_item_fitting_type . '</td>'
                                    . '<td>' . $window_price_sheet_9_calculation_quote_item_valance_type . '</td>'
                                    . '</tr>'
                                    . $window_price_sheet_9_calculation_quote_item_notes_table
                                    . $window_price_sheet_9_calculation_quote_item_accessories_table;
            ...
            $window_price_sheet_9_calculation_quote_item_width_skins_de = $window_price_sheet_9_calculation_quote_item_width_skins - $window_price_sheet_9_calculation_quote_item_Tube_Type_width_deduction;
			...
			$window_price_sheet_9_calculation_quote_tables .= '<tr nobr="true">'
                    . '<td>' . $quote_item_no . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_9_calculation_quote_item_location)[0] . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_9_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_9_calculation_quote_item_type)[0] . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_9_calculation_quote_item_colour)[0] . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Tube_Type . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_width_skins_Tube_Length . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Control_Side . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Controls . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Bracket_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Size . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Type . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Bottom_Bar_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_width . '</td>'
                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_drop . '</td>'
                    //. '<td>' . $window_price_sheet_9_calculation_quote_item_mounting_rail_length . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Direction . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Fit . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Chain_Colour . '</td>'
                    . '<td>' . $window_price_sheet_9_calculation_quote_item_Chain_Size . '</td>'
                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_width_skins_de . '</td>'
                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_9_calculation_quote_item_drop_skins . '</td>'
                    //. '<td>' . get_price_from_csv($csv_price_sheet, $window_price_sheet_9_calculation_quote_item_width, $window_price_sheet_9_calculation_quote_item_drop) . '</td>'
                    //. '<td style="background-color: #ff0;">' . $window_price_sheet_9_calculation_quote_item_No_Of_Rail_Brackets . '</td>'
                    //. '<td>' . $window_price_sheet_9_calculation_quote_item_Bracket_Covers . '</td>'
                    . '</tr>'
