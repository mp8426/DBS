    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            if ($twc_calculation_quote_item_notes || $twc_calculation_quote_item_accessories || $twc_calculation_quote_item_per_meters || $twc_calculation_quote_item_fitting_charges) {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[1] === '1' && $twc_calculation_quote_item_accessories ||
            ...
            if ($group_discount_print[1] === '1') {
                ...
                $twc_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                    . '<tr style="font-size: 0.9em;">'
                    . '<th style="width:800px; border-top: 0.5px solid #616060; border-left: 0.5px solid #616060; border-bottom: 0.5px solid #616060; color:#303030; font-size: 1.9em; text-align: center; font-weight: 14px; vertical-align: middle;" rowspan="3">'.$twc_calculation_name.'</th>'

                    . '<th style="width:100px; border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $twc_calculation_total_table_colspan . '">Sub Total </th>'
                    . '<th style="width:100px; border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($twc_calculation_quote_item_price_sub_total, 2) . '</th>'
                    . '</tr>'
