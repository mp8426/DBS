<?php
    ...
    include '../../cPanel/connect.php';
        ...
        $query_1 = "DELETE FROM twc_calculation_quote_item_accessories WHERE code = ? AND twc_calculation_quote_item_code = ? AND twc_calculation_code = ? AND cid = ?";
        
        $stmt_1 = $mysqli -> prepare( $query_1 );
        $stmt_1 -> bind_param( 'ssss', $accessory_code, $twc_calculation_quote_item_code, $twc_calculation_code, $cid );
