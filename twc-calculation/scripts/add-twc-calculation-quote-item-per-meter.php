...
$query_1 = "INSERT INTO twc_calculation_quote_item_per_meters ( code, name, price, width, twc_calculation_quote_item_code, twc_calculation_code, cid ) VALUES( ?, ?, ?, ?, ?, ?, ? )";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('sssssss', $per_meter_code, $per_meter_name, $per_meter_price, $per_meter_width, $twc_calculation_quote_item_code, $twc_calculation_code, $cid);
