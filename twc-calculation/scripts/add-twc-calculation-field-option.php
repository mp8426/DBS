...
$twc_calculation_field_code = filter_input(INPUT_POST, 'field_code');
$twc_calculation_code = filter_input(INPUT_POST, 'twc_calculation_code');

if ($name !== "") {

    $query_1 = "INSERT INTO twc_calculation_field_options ( code, name, twc_calculation_field_code, twc_calculation_code ) VALUES( ?, ?, ?, ? )";

    $stmt_1 = $mysqli->prepare($query_1);
    $stmt_1->bind_param('ssss', $code, $name, $twc_calculation_field_code, $twc_calculation_code);
