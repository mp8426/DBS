<?php
    ...
    include '../../cPanel/connect.php';
        ...
        $query_1 = "INSERT INTO twc_calculation_quote_item_fitting_charges ( code, name, price, twc_calculation_quote_item_code, twc_calculation_code, cid ) VALUES( ?, ?, ?, ?, ?, ? )";
        
        $stmt_1 = $mysqli -> prepare( $query_1 );
        $stmt_1 -> bind_param( 'ssssss', $fitting_charge_code, $fitting_charge_name, $fitting_charge_price, $twc_calculation_quote_item_code, $twc_calculation_code, $cid );
