$(function () {
    ...
    $.ajax({
        url: "twc-calculation/scripts/get-twc-calculations.php",
        type: "POST",
        dataType: "json",
        data: {cid: cid},
        beforeSend: function () {
        ...
        success: function (data) {
            ...
            if (data[0] === 1) {
                ...
                $.each(data[1], function (index, value) {
                    ...
                    var twc_calculation_code = value.code;
                    ...
                    $.each(value.fields, function (field_index, field_value) {
                        ...
                        if (field_value.side === 1) { //left side
                            ...
                            if (field_value.field_type === 0) {
                                ...
                                field_options += '<option class="twc-calculation-add-field-option-x" data-field-code="' + field_value.code + '" value="add-new">Add New</option>';

                                field_element_left += '<td>\n\
                                                        <select name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="twc-calculation-field data-field">\n\
                                                            <option value=""></option>\n\
                                                            ' + field_options + '\
                                                        </select>\n\
                                ...
                                field_element_left += '<td>\n\
                                                        <input type="text" name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="twc-calculation-field data-field text-field" autocomplete="off">\n\
                                                    </td>';
                            }
                        }
                    ...
                    if (value.accessories_select === 1) {
                        ...
                        accessory_element = '<span class="twc-calculation-accessories-wrapper">\n\
                    ...
                    if (value.per_meters_select === 1) {
                        ...
                        per_meter_element = '<span class="twc-calculation-accessories-wrapper">\n\
                    ...
                    if (value.fitting_charges_select === 1) {
                        ...
                        fitting_charge_element = '<span class="twc-calculation-fitting-charges-wrapper">\n\
                    ...
                    if (value.status === 1) {
                        ...
                        $('<li><a href="#tab-' + value.code + '">' + value.name + '</a></li>').prependTo("#twc-calculation-tabs .tabs ul");
                        $('<div id="tab-' + value.code + '" class="twc-calculation-tab-div"></div>')
                                .append($('<form class="add-twc-calculation-quote-item-form" action="./" method="POST"></form>')
                                        .append('<input type="hidden" class="cid" name="cid" value="' + cid + '">')
                                        .append('<input type="hidden" class="twc-calculation-code" name="twc-calculation-code" value="' + twc_calculation_code + '">')
                                        .append($('<table class="twc-calculation-table"></table>')
                                                ...
                                                .append($('<tbody></tbody>')
                                                        .append($('<tr class="tbody-tr"></tr>')
                                                                ...
                                                                .append('<td><input type="tel" name="width" data-column="width_x" class="twc-calculation-width number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="mm"></td>')
                                                                .append('<td><input type="tel" name="drop" data-column="drop_x" class="twc-calculation-drop number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="mm"></td>')
                                                                .append(type_element)
                                        ...
                                        ).prependTo("#twc-calculation-tabs .calculation-results").find(".bttn-input").button();
                    }
                    // End of prepend Calculation methods

                    if (JSON.stringify(value.quote_items) !== '[]') {

                        $('<div id="twc-calculation-quote-items-wrapper-' + twc_calculation_code + '" class="twc-calculation-quote-items-wrapper"></div>')
                                .append('<h2 class="twc-calculation-header">' + value.name + '</h2>')
                                .append('<div id="quote-items-body-' + twc_calculation_code + '" class="twc-calculation-quote-items-body"></div>')
                                .append('<div class="bulk-action-button-wrapper">\n\
                                            ...
                                            <a href="print/order-sheet-twc-calculation-' + twc_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 145px;">Print Order Sheet</a>\n\
                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-twc-calculation-' + twc_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 175px;">Print Order Sheet Xlsx</a>\n\
                                            <form class="group-discount-form" style="float: right; margin-right: -6px; font-size: 12px;">\n\
                                                ...
                                                <input type="hidden" class="twc-calculation-code" value="' + twc_calculation_code + '">\n\
                                        ...
                                        ).prependTo("#twc-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button();
                        ...
                        $.each(value.quote_items, function (quote_item_index, quote_item_value) {
                            ...
                            $('<form id="calculation-form-' + quote_item_value.code + '" class="update-twc-calculation-quote-item-form" action="./" method="POST">\n\
                                    <input type="hidden" name="cid" class="cid" value="' + cid + '">\n\
                                    <input type="hidden" name="twc-calculation-code" class="twc-calculation-code" value="' + twc_calculation_code + '">\n\
                                    <input type="hidden" name="twc-calculation-quote-item-code" class="twc-calculation-quote-item-code" value="' + quote_item_value.code + '">\n\
                                    <table class="twc-calculation-table">\n\
                                        ...
                                        <tbody>\n\
                                            <tr>\n\
                                                ...
                                                ' + field_element_left + '\
                                                ' + location_element + '\
                                                <td><input type="tel" name="width" data-column="width_x" class="twc-calculation-width number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.width + '" placeholder="mm"></td>\n\
                                                <td><input type="tel" name="drop" data-column="drop_x" class="twc-calculation-drop number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.drop + '" placeholder="mm"></td>\n\
                                                ' + type_element + '\
                                                ' + material_element + '\
                                                ' + colour_element + '\
                                                ' + field_element_right + '\
                                                <td>\n\
                                                    <table class="right-fixed-column" style="margin-top: -20px;">\n\
                                                        <tr>\n\
                                                            <td><input type="tel" name="price" data-column="price" class="twc-calculation-price price-input data-field ui-state-default" autocomplete="off" value="' + quote_item_value.price + '"></td>\n\
                                    ...
                                    <table id="calculation-table-more-' + quote_item_value.code + '"  class="twc-calculation-table-more">\n\
                                        <tr>\n\
                                            <td class="table-more-notes" colspan="3">\n\
                                                <textarea name="notes" data-column="notes" class="twc-calculation-notes data-field" placeholder="Notes">' + quote_item_value.notes + '</textarea>\n\
                                            </td>\n\
                                        </tr>\n\
                                        <tr>\n\
                                ...
                                </form>').appendTo("#quote-items-body-" + twc_calculation_code).queue(function () {
                                ...
                                $.each(quote_item_value.fields, function (quote_item_fields_index, quote_item_fields_value) {
                                    ...
                                    var twc_calculation_field_code = quote_item_fields_value.twc_calculation_field_code;
                                    //this_form.find("[name='field[" + twc_calculation_field_code + "]']").val(field_name + '<->' + field_code);

                                    if (this_form.find("[name='field[" + twc_calculation_field_code + "]']").is('input')) {
                                        this_form.find("[name='field[" + twc_calculation_field_code + "]']").val(field_name);
                                    } else {
                                        this_form.find("[name='field[" + twc_calculation_field_code + "]']").val(field_name + '<->' + field_code + '<->' + field_price);
                                    }
                                });
                                ...
                                $.each(quote_item_value.accessories, function (quote_item_accessories_index, quote_item_accessories_value) {
                                    ...
                                    this_form.find(".table-more-accessories").append('<span class="twc-calculation-accessories-wrapper">\n\
                                                                                            <input type="text" class="twc-calculation-accessory" readonly disabled value="' + accessory_name + ' | ' + accessory_price + ' x ' + accessory_qty + ' = ' + accessory_total + '">\n\
                                                                                            <input type="button" class="delete-twc-calculation-accessory bttn-input" data-code="' + accessory_code + '" value="✖">\n\
                                                                                        </span>');

                                    this_form.find('.twc-calculation-accessories option[data-code="' + accessory_code + '"]').hide();
                                });
                                ...
                                $.each(quote_item_value.per_meters, function (quote_item_per_meters_index, quote_item_per_meters_value) {
                                    ...
                                    this_form.find(".table-more-per-meters").append('<span class="twc-calculation-per-meters-wrapper">\n\
                                                                                            <input type="text" class="twc-calculation-per-meter" readonly disabled value="' + per_meter_name + ' | ' + per_meter_price + ' x ' + per_meter_width + ' = ' + per_meter_total + '">\n\
                                                                                            <input type="button" class="delete-twc-calculation-per-meter bttn-input" data-code="' + per_meter_code + '" value="✖">\n\
                                                                                        </span>');

                                    this_form.find('.twc-calculation-per-meters option[data-code="' + per_meter_code + '"]').hide();
                                });
                                ...
                                $.each(quote_item_value.fitting_charges, function (quote_item_fitting_charges_index, quote_item_fitting_charges_value) {
                                    ...
                                    this_form.find(".table-more-fitting-charges").append('<span class="twc-calculation-fitting-charges-wrapper">\n\
                                                                                                <input type="text" class="twc-calculation-fitting-charge" readonly disabled value="' + fitting_charge_name + ' | ' + fitting_charge_price + '">\n\
                                                                                                <input type="button" class="delete-twc-calculation-fitting-charge bttn-input" data-code="' + fitting_charge_code + '" value="✖">\n\
                                                                                            </span>');

                                    this_form.find('.twc-calculation-fitting-charges option[data-code="' + fitting_charge_code + '"]').hide();
                                });

                                var note_length = quote_item_value.notes;
                                var accessory_length = this_form.find('.twc-calculation-accessory').length;
                                var per_meter_length = this_form.find('.twc-calculation-per-meter').length;
                                var fitting_charge_length = this_form.find('.twc-calculation-fitting-charge').length;

                                if (note_length || accessory_length || per_meter_length || fitting_charge_length) {
                                    this_form.find('.twc-calculation-table-more-bttn').addClass("red");
                                } else {
                                    this_form.find('.twc-calculation-table-more-bttn').removeClass("red");
                                }
                        ...
                        $("#twc-calculation-quote-items-wrapper-" + twc_calculation_code)
                        ...
                        $(".twc-calculation-quote-items-body .twc-calculation-table .thead").first().html(table_header); // Add Table headers for each calculation
                    } else {
                        ...
                        $('<div id="twc-calculation-quote-items-wrapper-' + twc_calculation_code + '" class="twc-calculation-quote-items-wrapper"></div>')
                                ...
                                .prependTo("#twc-calculation-quote-items-results").hide();
                    }
                });
    ...
    $(document).on("click", ".twc-calculation-select-all-bttn", function () {
        var this_bttn = $(this);
        var this_text = this_bttn.val();
        var this_parent = this_bttn.parents(".twc-calculation-quote-items-wrapper");
    ...
    $(document).on("click", ".twc-calculation-bulk-delete-bttn", function () {

        var this_bttn = $(this);
        var this_parent = this_bttn.parents(".twc-calculation-quote-items-wrapper");
        var table_header = this_parent.find(".twc-calculation-table .thead .thead-tr").clone();
        ...
        if (datas) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/delete-bulk-twc-calculation-quote-items.php",
                type: 'POST',
                dataType: 'json',
                data: datas,
                beforeSend: function () {
                ...
                success: function (data) {
                    ...
                    if (data[0] === 1) {
                        ...
                        if (!this_parent.find('.update-twc-calculation-quote-item-form').length) {
                            ...
                            this_parent.find(".twc-calculation-table .thead").first().html(table_header);
                        }

                        this_bttn.prop('disabled', false).removeClass('field-loader');

                        twc_calculation_group_discount(this_bttn);
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    this_bttn.prop('disabled', false).removeClass('field-loader');
                    alert(JSON.stringify(jqXHR));
                    alert("Error! @delete-bulk-twc-calculation-quote-item");
                }
            });
        }
    });
    ...
    $(document).on("click", ".twc-calculation-bulk-copy-bttn", function () {
        ...
        if (datas) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/copy-bulk-twc-calculation-quote-items.php",
                type: 'POST',
                dataType: 'json',
                data: datas,
                beforeSend: function () {
                ...
                success: function (data) {
                    ...
                    if (data[0] === 1) {
                        $.each(data[1], function (old_code, new_code) {
                            ...
                            calculation_form.find(".twc-calculation-quote-item-code").val(new_code);
                            ...
                            calculation_form.find(".twc-calculation-table-more").attr("id", "calculation-table-more-" + new_code).hide();
                            calculation_form.find(".twc-calculation-table .thead").empty();

                            $(calculation_form).appendTo(this_parent.find('.twc-calculation-quote-items-body')).queue(function () {
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    this_bttn.prop('disabled', false).removeClass('field-loader');
                    alert(JSON.stringify(jqXHR));
                    alert("Error! @copy-bulk-twc-calculation-quote-item");
                }
            });
        }
    });

    $(document).on("click", ".delete-twc-calculation-quote-item", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents(".update-twc-calculation-quote-item-form");
        var code = this_form.find(".twc-calculation-quote-item-code").val();

        var this_parent = this_form.parents(".twc-calculation-quote-items-wrapper");
        var table_header = this_parent.find(".twc-calculation-table .thead .thead-tr").clone();

        $.ajax({
            url: "twc-calculation/scripts/delete-twc-calculation-quote-item.php",
            type: 'POST',
            dataType: 'json',
            ...
            success: function (data) {
                ...
                if (data[0] === 1) {
                    ...
                    twc_calculation_group_discount(this_form);
                    $('#getsum').load('getsum.php?cid=' + cid).fadeIn("fast");
                    $('#totalx').load('megaTotal.php?cid=' + cid).fadeIn("fast");
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @delete-twc-calculation-quote-item");
            }
        });
    });

    $(document).on("click", ".twc-calculation-table-more-bttn", function () {
        var this_bttn = $(this);
        var this_form = this_bttn.parents("form");

        this_form.find(".twc-calculation-table-more").toggle("slide", {direction: "up"}, "fast");
    });

    $(document).on("change", ".checkbox-input", function () {
        var this_checkbox = $(this);
        var this_table = this_checkbox.parents(".twc-calculation-table");
    ...
    $(document).on("change", ".add-twc-calculation-quote-item-form .twc-calculation-width,\n\
                                .add-twc-calculation-quote-item-form .twc-calculation-drop,\n\
                                .add-twc-calculation-quote-item-form .twc-calculation-type,\n\
                                .add-twc-calculation-quote-item-form .twc-calculation-field", function () {

        check_twc_calculation_max_min_dimensions(this);
        get_twc_calculation_price(this);

    });

    function check_twc_calculation_max_min_dimensions(this_elelemnt) {

        var this_form = $(this_elelemnt).parents("form");

        var width_element = this_form.find(".twc-calculation-width");
        var drop_element = this_form.find(".twc-calculation-drop");
        var type_element = this_form.find(".twc-calculation-type");
    ...
    function get_twc_calculation_price(this_elelemnt) {

        var this_form = $(this_elelemnt).parents("form");
        var price_element = this_form.find(".twc-calculation-price");
        var dyn_field = this_form.find(".twc-calculation-field");

        var code = this_form.find(".twc-calculation-code").val();
        var type_code = this_form.find(".twc-calculation-type").val().split("<->")[1];
        var width = this_form.find(".twc-calculation-width").val();
        var drop = this_form.find(".twc-calculation-drop").val();

        if (code && type_code && width && drop) {

            ajax_get_price_request = $.ajax({
                url: "twc-calculation/scripts/get-twc-calculation-price.php",
                type: 'POST',
                dataType: 'json',
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    alert("Error! @get-twc-calculation-price");
                }
            });
        } else {
            //price_element.val( "" );
    ...
    $(document).on("change", ".twc-calculation-width, .twc-calculation-type", function () {
        if (quote_status !== '1' || $(this).parents("form").hasClass('add-twc-calculation-quote-item-form')) {
            update_material(this);
        }
    });
    function update_material(this_elelemnt) {
        ...
        var material_element = this_form.find(".twc-calculation-material");
        material_element.val("");
        material_element.find('option').not(':first').remove();

        var colour_element = this_form.find(".twc-calculation-colour");
        colour_element.val("");
    ...
    $(document).on("change", ".twc-calculation-material", function () {
        if (quote_status !== '1' || $(this).parents("form").hasClass('add-twc-calculation-quote-item-form')) {
            update_colour(this);
        }
    });
    function update_colour(this_elelemnt) {
        ...
        var type_code = this_form.find('.twc-calculation-type option:selected').attr('data-code');
        ...
        if (colours) {
            ...
            colour_element.append('<option class="twc-calculation-add-colour-option" data-material-code="' + material_code + '" data-type-code="' + type_code + '" value="add-new">Add New</option>');
        }
    }
    $(document).on("change", ".twc-calculation-colour", function (event) {
        var this_element = $(this);
        var this_form = this_element.parents("form");
        var add_colour_element_parent = this_form.find(".twc-calculation-add-colour-wrapper");
        var add_colour_element = this_form.find(".twc-calculation-add-colour");
    ...
    function twc_calculation_add_colour(type_code, material_code, colour_name, this_elelemnt) {
        ...
        var add_colour_element_parent = this_form.find(".twc-calculation-add-colour-wrapper");
        var add_colour_element = this_form.find(".twc-calculation-add-colour");
        var add_colour_submit = this_form.find(".twc-calculation-add-colour-submit");
        var data_fields = this_form.find(".data-field, .number-input, select, [type='submit']");
        ...
        if (material_code && colour_name) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/add-twc-calculation-colour.php",
                type: "POST",
                dataType: "json",
                    ...
                    if (data[0] === 1) {
                        ...
                        $.each(materials_and_colours, function (material_index, material_value) {
                            if (material_value.code === material_code) {
                                ...
                                $(".twc-calculation-type option[data-code=" + type_code + "]").attr('data-materials-and-colours', JSON.stringify(materials_and_colours));
                            }
                        });

                        colours.push({code: data[1], name: data[2]});

                        $(".twc-calculation-material option[data-code=" + material_code + "]").attr('data-colours', JSON.stringify(colours));
                        $(".twc-calculation-add-colour-option[data-material-code=" + material_code + "][data-type-code=" + type_code + "]").before('<option value="' + data[2] + '<->' + data[1] + '">' + data[2] + '</option>');
    ...
    $(document).on("keypress", ".twc-calculation-add-colour", function (event) {
        if (event.keyCode === 13) {
            ...
            twc_calculation_add_colour(type_code, material_code, colour_name, this_element);
            return false;
        }
    });

    $(document).on("click", ".twc-calculation-add-colour-submit", function (event) {
        event.preventDefault();
    ...
    $(document).on("click", ".twc-calculation-add-colour-close", function () {
        var this_element = $(this);
        var this_form = this_element.parents("form");
        var colour_element = this_form.find(".twc-calculation-colour");
        var add_colour_element_parent = this_form.find(".twc-calculation-add-colour-wrapper");
    ...
    $(document).on("change", ".twc-calculation-field", function (event) {
        var this_element = $(this);
        var this_form = this_element.parents("form");
        var add_field_option_element_parent = this_element.siblings(".twc-calculation-add-field-option-wrapper");
        var add_field_option_element = add_field_option_element_parent.find(".twc-calculation-add-field-option");
        var data_fields = this_form.find(".data-field, .number-input, select, [type='submit']");

        // If bulk Selected
        var this_chcekedbox = this_form.find(".checkbox-input");
        var checked_checkbox = this_form.parents(".twc-calculation-quote-items-body").find(".checkbox-input:checked");

        if (this_chcekedbox.is(":checked") && checked_checkbox.length) {

            checked_checkbox.not(this_chcekedbox).each(function () {
                var this_form_x = $(this).parents(".update-twc-calculation-quote-item-form");
    ...
    function twc_calculation_add_field_option(field_option_name, this_elelemnt) {

        var this_element = $(this_elelemnt);
        var this_form = this_element.parents("form");
        var add_field_option_element_parent = this_element.parents(".twc-calculation-add-field-option-wrapper");
        var add_field_option_element = add_field_option_element_parent.find(".twc-calculation-add-field-option");
        var add_field_option_submit = add_field_option_element_parent.find(".twc-calculation-add-field-option-submit");

        var field_element = add_field_option_element_parent.siblings(".twc-calculation-field");
        var field_code = field_element.attr("data-code");
        var twc_calculation_code = this_form.find(".twc-calculation-code").val();
        var data_fields = this_form.find(".data-field, .number-input, select, [type='submit']");
        ...
        if (field_option_name) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/add-twc-calculation-field-option.php",
                type: "POST",
                dataType: "json",
                data: {field_code: field_code, field_option_name: field_option_name, twc_calculation_code: twc_calculation_code},
                beforeSend: function () {
                ...
                success: function (data) {
                    ...
                    if (data[0] === 1) {
                        ...
                        $(".twc-calculation-add-field-option-x[data-field-code=" + field_code + "]").before('<option value="' + data[2] + '<->' + data[1] + '<->0.00">' + data[2] + '</option>');
    ...
    $(document).on("keypress", ".twc-calculation-add-field-option", function (event) {
        if (event.keyCode === 13) {
            event.preventDefault();
            ...
            twc_calculation_add_field_option(field_option_name, this_element);
            return false;
        }
    });

    $(document).on("click", ".twc-calculation-add-field-option-submit", function (event) {
        event.preventDefault();

        var this_element = $(this);
        var add_field_option_element = this_element.siblings(".twc-calculation-add-field-option");
    ...
    $(document).on("click", ".twc-calculation-add-field-option-close", function () {
        var this_element = $(this);
        var this_form = this_element.parents("form");
        var add_field_option_element_parent = this_element.parents(".twc-calculation-add-field-option-wrapper");
        var add_field_option_element = add_field_option_element_parent.find(".twc-calculation-add-field-option");
    ...
    function twc_calculation_group_discount(this_element) {

        var result_parent = $(this_element).parents(".twc-calculation-quote-items-wrapper");
        var quote_items_parent = result_parent.find(".twc-calculation-quote-items-body");
    ...
    $(document).on("submit", ".add-twc-calculation-quote-item-form", function (event) {
        event.preventDefault();

        var this_form = $(this);
        var this_submit_bttn = this_form.find('[type="submit"]');
        var this_table_thead_tr = this_form.find(".twc-calculation-table .thead-tr");
        var this_table_tbody_tr = this_form.find(".twc-calculation-table .tbody-tr");
        var twc_calculation_code = this_form.find(".twc-calculation-code").val();
        ...
        var result_parent = $("#twc-calculation-quote-items-wrapper-" + twc_calculation_code);
        ...
        $.ajax({
            url: "twc-calculation/scripts/add-twc-calculation-quote-item.php",
            type: 'POST',
            dataType: 'json',
            data: datas,
            ...
            success: function (data) {
                ...
                if (data[0] === 1) {
                    ...
                    $.each(data[1], function (index, code) {
                        ...
                        if (!$("#quote-items-body-" + twc_calculation_code + " .twc-calculation-table").length) {
                            ...
                            $("#twc-calculation-quote-items-wrapper-" + twc_calculation_code).show();
                        } else {
                        ...
                        if (per_meter_option_array) {
                            ...
                            per_meter_element = '<span class="twc-calculation-per-meters-wrapper">\n\
                                                    <select class="twc-calculation-per-meters">\n\
                                                        <option value="">Per Meters</option>\n\
                                                        ' + per_meter_options + '\
                                                    </select>\n\
                        ...
                        $('<form id="calculation-form-' + code + '" class="update-twc-calculation-quote-item-form" action="./" method="POST">\n\
                                <input type="hidden" name="cid" class="cid" value="' + cid + '">\n\
                                <input type="hidden" name="twc-calculation-code" class="twc-calculation-code" value="' + twc_calculation_code + '">\n\
                                <input type="hidden" name="twc-calculation-quote-item-code" class="twc-calculation-quote-item-code" value="' + code + '">\n\
                                <table class="twc-calculation-table">\n\
                                    <thead class="thead">\n\
                                ...
                                <table id="calculation-table-more-' + code + '"  class="twc-calculation-table-more">\n\
                                    <tr>\n\
                                        <td class="table-more-notes" colspan="3">\n\
                    ...
                    result_parent.find('.bulk-action-button-wrapper').html('<input type="button" class="bulk-action-button twc-calculation-select-all-bttn" value="✔">\n\
                                                                            <input type="button" class="bulk-action-button twc-calculation-bulk-delete-bttn" value="Delete">\n\
                                                                            <input type="button" class="bulk-action-button twc-calculation-bulk-copy-bttn" value="Copy">\n\
                                                                            <a href="print/order-sheet-twc-calculation-' + twc_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 145px;">Print Order Sheet</a>\n\
                                                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-twc-calculation-' + twc_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 175px;">Print Order Sheet Xlsx</a>\n\
                    ...
                    this_form[0].reset();
                    this_form.find(".twc-calculation-material").val("").find('option').not(':first').remove();
                    this_form.find(".twc-calculation-colour").val("").find('option').not(':first').remove();
                    this_submit_bttn.prop('disabled', false).removeClass('field-loader');

                    twc_calculation_group_discount(result_parent.find(".group-discount-form"));
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_submit_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @add-twc-calculation-quote-item");
            }
        });
    });

    function update_twc_calculation_quote_item(this_element, quote_items_array) {
        ...
        var this_form = this_field.parents(".update-twc-calculation-quote-item-form");
        var this_chcekedbox = this_form.find(".checkbox-input");
        var checked_checkbox = this_form.parents(".twc-calculation-quote-items-body").find(".checkbox-input:checked");

        $.ajax({
            url: "twc-calculation/scripts/update-twc-calculation-quote-item.php",
            type: 'POST',
            dataType: 'json',
                ...
                if (data[0] === 1) {
                    ...
                    if (this_chcekedbox.is(":checked") && checked_checkbox.length) {
                        checked_checkbox.each(function () {
                            ...
                            var note_length = this_form_x.find('.twc-calculation-notes').val().length;
                            var accessory_length = this_form_x.find('.twc-calculation-accessory').length;
                            var per_meter_length = this_form_x.find('.twc-calculation-per-meter').length;
                            var fitting_charge_length = this_form_x.find('.twc-calculation-fitting-charge').length;

                            if (note_length || accessory_length || per_meter_length || fitting_charge_length) {
                                this_form_x.find('.twc-calculation-table-more-bttn').addClass("red");
                            } else {
                                this_form_x.find('.twc-calculation-table-more-bttn').removeClass("red");
                            }
                        });

                    } else {

                        var note_length = this_form.find('.twc-calculation-notes').val().length;
                        var accessory_length = this_form.find('.twc-calculation-accessory').length;
                        var per_meter_length = this_form.find('.twc-calculation-per-meter').length;
                        var fitting_charge_length = this_form.find('.twc-calculation-fitting-charge').length;
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_field.removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @update-twc-calculation-quote-item");
            }
        });
    }

    $(document).on("change", ".update-twc-calculation-quote-item-form .data-field", function (event) {
        event.preventDefault();
        ...
        if (this_chcekedbox.is(":checked") && checked_checkbox.length) {
            ...
            checked_checkbox.each(function () {
                ...
                if (this_field_x.attr("name") === "width" || this_field_x.attr("name") === "drop" || this_field_x.attr("name") === "type" || this_field_x.hasClass('twc-calculation-field')) {
                    if (quote_status !== '1') {
                        get_twc_calculation_price(this_field_x);
                    }
                }
                    ...
                    if (quote_status !== '1') {
                        ajax_get_price_request.done(function () {
                            ...
                            if (checked_checkbox.length === no) {
                                update_twc_calculation_quote_item(this_field, quote_items_array);
                            }
                        });
                    } else {
                        no = no + 1;
            ...
            if (this_field.attr("name") === "width" || this_field.attr("name") === "drop" || this_field.attr("name") === "type" || this_field.hasClass('twc-calculation-field')) {
                if (quote_status !== '1') {
                    get_twc_calculation_price(this_field);
                }
            }
    ...
    $(document).on("keypress", ".add-twc-calculation-accessory-qty", function (event) {
        if (event.keyCode === 13) {
            event.preventDefault();
            var this_element = $(this);
            var add_bttn = this_element.siblings('.add-twc-calculation-accessories');
            add_bttn.click();
        }
    });

    $(document).on("click", ".add-twc-calculation-accessories", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-twc-calculation-quote-item-form');
        var accessory_element = this_bttn.siblings('.twc-calculation-accessories');
        var accessory_qty_element = this_bttn.siblings('.add-twc-calculation-accessory-qty');

        var twc_calculation_code = this_form.find('.twc-calculation-code').val();
        var twc_calculation_quote_item_code = this_form.find('.twc-calculation-quote-item-code').val();
        ...
        if (accessory) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/add-twc-calculation-quote-item-accessory.php",
                type: 'POST',
                dataType: 'json',
                data: {cid: cid, twc_calculation_code: twc_calculation_code, twc_calculation_quote_item_code: twc_calculation_quote_item_code, accessory: accessory, accessory_qty: accessory_qty},
                beforeSend: function () {
                    this_bttn.prop('disabled', false).addClass('field-loader');
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    ...
                    accessory_qty_element.removeClass('field-loader');
                    alert(JSON.stringify(jqXHR));
                    alert("Error! @add-twc-calculation-quote-item-accessory");
                }
            });
        }
    });

    $(document).on("click", ".delete-twc-calculation-accessory", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-twc-calculation-quote-item-form');
        var accessory_element = this_form.find('.twc-calculation-accessories');
        var this_wrapper = this_bttn.parent('.twc-calculation-accessories-wrapper');
        ...
        $.ajax({
            url: "twc-calculation/scripts/delete-twc-calculation-quote-item-accessory.php",
            type: 'POST',
            dataType: 'json',
            data: {cid: cid, twc_calculation_code: twc_calculation_code, twc_calculation_quote_item_code: twc_calculation_quote_item_code, accessory_code: accessory_code},
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            },
            success: function (data) {
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @delete-twc-calculation-quote-item-accessory");
            }
        });
    });

    $(document).on("keypress", ".add-twc-calculation-per-meter-width", function (event) {
        if (event.keyCode === 13) {
            event.preventDefault();
            var this_element = $(this);
            var add_bttn = this_element.siblings('.add-twc-calculation-per-meters');
            add_bttn.click();
        }
    });

    $(document).on("click", ".add-twc-calculation-per-meters", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-twc-calculation-quote-item-form');
        var per_meter_element = this_bttn.siblings('.twc-calculation-per-meters');
        var per_meter_width_element = this_bttn.siblings('.add-twc-calculation-per-meter-width');
        ...
        if (per_meter) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/add-twc-calculation-quote-item-per-meter.php",
                type: 'POST',
                dataType: 'json',
                data: {cid: cid, twc_calculation_code: twc_calculation_code, twc_calculation_quote_item_code: twc_calculation_quote_item_code, per_meter: per_meter, per_meter_width: per_meter_width},
                beforeSend: function () {
                    this_bttn.prop('disabled', false).addClass('field-loader');
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    ...
                    per_meter_width_element.removeClass('field-loader');
                    alert(JSON.stringify(jqXHR));
                    alert("Error! @add-twc-calculation-quote-item-per-meter");
                }
            });
        }
    });

    $(document).on("click", ".delete-twc-calculation-per-meter", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-twc-calculation-quote-item-form');
        var per_meter_element = this_form.find('.twc-calculation-per-meters');
        var this_wrapper = this_bttn.parent('.twc-calculation-per-meters-wrapper');
        ...
        $.ajax({
            url: "twc-calculation/scripts/delete-twc-calculation-quote-item-per-meter.php",
            type: 'POST',
            dataType: 'json',
            data: {cid: cid, twc_calculation_code: twc_calculation_code, twc_calculation_quote_item_code: twc_calculation_quote_item_code, per_meter_code: per_meter_code},
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            },
            success: function (data) {
    ...
    $(document).on("click", ".add-twc-calculation-fitting-charges", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-twc-calculation-quote-item-form');
        var fitting_charge_element = this_bttn.siblings('.twc-calculation-fitting-charges');
        ...
        if (fitting_charge) {
            ...
            $.ajax({
                url: "twc-calculation/scripts/add-twc-calculation-quote-item-fitting-charge.php",
                type: 'POST',
                dataType: 'json',
                data: {cid: cid, twc_calculation_code: twc_calculation_code, twc_calculation_quote_item_code: twc_calculation_quote_item_code, fitting_charge: fitting_charge},
                beforeSend: function () {
                    this_bttn.prop('disabled', false).addClass('field-loader');
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    ...
                    fitting_charge_element.toggleClass('field-loader');
                    alert(JSON.stringify(jqXHR));
                    alert("Error! @add-twc-calculation-quote-item-fitting-charge");
                }
            });
        }
    });

    $(document).on("click", ".delete-twc-calculation-fitting-charge", function () {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-twc-calculation-quote-item-form');
        var fitting_charge_element = this_form.find('.twc-calculation-fitting-charges');
        var this_wrapper = this_bttn.parent('.twc-calculation-fitting-charges-wrapper');
        ...
        $.ajax({
            url: "twc-calculation/scripts/delete-twc-calculation-quote-item-fitting-charge.php",
            type: 'POST',
            dataType: 'json',
            data: {cid: cid, twc_calculation_code: twc_calculation_code, twc_calculation_quote_item_code: twc_calculation_quote_item_code, fitting_charge_code: fitting_charge_code},
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            },
            success: function (data) {
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @delete-twc-calculation-quote-item-fitting-charge");
            }
        });
    });

    $(document).on("submit", "#twc-calculation-quote-items-results .group-discount-form", function (event) {
        event.preventDefault();
        ...
        $.ajax({
            url: "twc-calculation/scripts/update-twc-calculation-group-discount.php",
            type: 'POST',
            dataType: 'json',
            data: {cid: cid, discount: discount, twc_calculation_code: twc_calculation_code},
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            },
            success: function (data) {
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @update-twc-calculation-group-discount");
            }
        });
