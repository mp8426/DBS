$(function () {
                ...
                $.each(data[1], function (index, value) {
                        ...
                        if (field_value.side === 1) { //left side
                            ...
                            if (field_value.field_type === 0) {
                                ...
                                field_element_left += '<td>\n\
                                                        <select name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="form-no-2-calculation-field data-field">\n\
                                                            <option value=""></option>\n\
                                                            ' + field_options + '\
                                                        </select>\n\
                                                        <span class="form-no-2-calculation-add-field-option-wrapper">\n\
                                                            <input type="text" class="form-no-2-calculation-add-field-option text-input">\n\
                    ...
                    if (value.status === 1) {
                        ...
                        $('<div id="tab-' + value.code + '" class="form-no-2-calculation-tab-div"></div>')
                                .append($('<form class="add-form-no-2-calculation-quote-item-form" action="./" method="POST"></form>')
                                        ...
                                        .append($('<table class="form-no-2-calculation-table"></table>')
                                                ...
                                                .append($('<tbody></tbody>')
                                                        ...
                                                        <table class="right-fixed-column" style="margin-top: -20px;">\n\
                                                            <tr>\n\
                                                                <td><input type="tel" name="price" class="form-no-2-calculation-price price-input data-field" autocomplete="off"></td>\n\
                                                                <td><input type="number" name="qty" class="form-no-2-calculation-qty number-input" autocomplete="off" min="1" value="1"></td>\n\
                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="form-no-2-calculation-quote-items-wrapper-' + form_no_2_calculation_code + '" class="form-no-2-calculation-quote-items-wrapper"></div>')
                                ...
                                .append('<div id="quote-items-body-' + form_no_2_calculation_code + '" class="form-no-2-calculation-quote-items-body"></div>')
                                .append('<div class="bulk-action-button-wrapper">\n\
                                            <input type="button" class="bulk-action-button form-no-2-calculation-select-all-bttn" value="✔">\n\
                                            <input type="button" class="bulk-action-button form-no-2-calculation-bulk-delete-bttn" value="Delete">\n\
                                            <input type="button" class="bulk-action-button form-no-2-calculation-bulk-copy-bttn" value="Copy">\n\
                                            <a href="https://dbs.blinq.com.au/print/order-sheet-form-no-2-calculation-' + form_no_2_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 145px;">Print Order Sheet</a>\n\
                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-form-no-2-calculation-' + form_no_2_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 175px;">Print Order Sheet Xlsx</a>\n\
                                        ...
                                        ).prependTo("#form-no-2-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button();
                            ...
                            $('<form id="calculation-form-' + quote_item_value.code + '" class="update-form-no-2-calculation-quote-item-form" action="./" method="POST">\n\
                                    ...
                                    <table class="form-no-2-calculation-table">\n\
                                        ...
                                        <tbody>\n\
                                            <tr>\n\
                                                ...
                                                ' + location_element + '\
                                                ' + field_element_right + '\
                                                <td><input type="tel" name="cost" data-column="cost" class="form-no-2-calculation-cost number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.cost + '" placeholder=""></td>\n\
                                                <td><input type="tel" name="markup" data-column="markup" class="form-no-2-calculation-markup number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.markup + '" placeholder="%"></td>\n\
                                                <td>\n\
                                                    <table class="right-fixed-column" style="margin-top: -20px;">\n\
                                                        <tr>\n\
                                                            <td><input type="tel" name="price" data-column="price" class="form-no-2-calculation-price price-input data-field ui-state-default" autocomplete="off" value="' + quote_item_value.price + '"></td>\n\
                                                            <td><input type="button" class="form-no-2-calculation-table-more-bttn bttn-input" value="★"></td>\n\
                                                            <td><input type="button" class="bttn-input delete-form-no-2-calculation-quote-item" value="✖"></td>\n\
                                                        </tr>\n\
                                                    </table>\n\
                                                </td>\n\
                                            </tr>\n\
                                ...
                                $.each(quote_item_value.fields, function (quote_item_fields_index, quote_item_fields_value) {
                                    ...
                                    if (this_form.find("[name='field[" + form_no_2_calculation_field_code + "]']").is('input')) {
                                        ...
                                        this_form.find("[name='field[" + form_no_2_calculation_field_code + "]']").val(field_name + '<->' + field_code + '<->' + field_price);
                                    }
                                });
    ...
    $(document).on("click", ".form-no-2-calculation-bulk-delete-bttn", function () {
        ...
        var this_bttn = $(this);
        var this_parent = this_bttn.parents(".form-no-2-calculation-quote-items-wrapper");
        var table_header = this_parent.find(".form-no-2-calculation-table .thead .thead-tr").clone();
    ...
    function get_form_no_2_calculation_price(this_elelemnt) {
        ...
        var cost = +this_form.find(".form-no-2-calculation-cost").val();
        var markup = +this_form.find(".form-no-2-calculation-markup").val();
    ...
    function form_no_2_calculation_add_field_option(field_option_name, this_elelemnt) {
        ...
        if (field_option_name) {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                data: {field_code: field_code, field_option_name: field_option_name, form_no_2_calculation_code: form_no_2_calculation_code},
                beforeSend: function () {
                ...
                success: function (data) {
                    ...
                    if (data[0] === 1) {
                        ...
                        $(".form-no-2-calculation-add-field-option-x[data-field-code=" + field_code + "]").before('<option value="' + data[2] + '<->' + data[1] + '<->0.00">' + data[2] + '</option>');
    ...
    $(document).on("keypress", ".form-no-2-calculation-add-field-option", function (event) {
        if (event.keyCode === 13) {
            ...
            form_no_2_calculation_add_field_option(field_option_name, this_element);
            return false;
        }
    });
                ...
                if (data[0] === 1) {
                    ...
                    $.each(data[1], function (index, code) {
                        ...
                        newe_table_body_tr.find(".right-fixed-column").html('<tr>\n\
                                                                                <td><input type="tel" name="price" data-column="price" class="form-no-2-calculation-price price-input data-field ui-state-default" autocomplete="off"></td>\n\
                                                                                <td><input type="button" class="form-no-2-calculation-table-more-bttn bttn-input" value="★"></td>\n\
                                                                                <td><input type="button" class="bttn-input delete-form-no-2-calculation-quote-item" value="✖"></td>\n\
                                                                            </tr>');
                    ...
                    result_parent.find('.bulk-action-button-wrapper').html('<input type="button" class="bulk-action-button form-no-2-calculation-select-all-bttn" value="✔">\n\
                                                                            <input type="button" class="bulk-action-button form-no-2-calculation-bulk-delete-bttn" value="Delete">\n\
                                                                            <input type="button" class="bulk-action-button form-no-2-calculation-bulk-copy-bttn" value="Copy">\n\
                                                                            <a href="https://dbs.blinq.com.au/print/order-sheet-form-no-2-calculation-' + form_no_2_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 145px;">Print Order Sheet</a>\n\
                                                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-form-no-2-calculation-' + form_no_2_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 175px;">Print Order Sheet Xlsx</a>\n\
    ...
    $(document).on("change", ".update-form-no-2-calculation-quote-item-form .data-field", function (event) {
        ...
        if (this_chcekedbox.is(":checked") && checked_checkbox.length) {
            ...
            checked_checkbox.each(function () {
                ...
                if (this_field_x.attr("name") === "cost" || this_field_x.attr("name") === "markup" || this_field_x.hasClass('form-no-2-calculation-field')) {
                    if (quote_status !== '1') {
            ...
            if (this_field.attr("name") === "cost" || this_field.attr("name") === "markup" || this_field.hasClass('form-no-2-calculation-field')) {
                if (quote_status !== '1') {
