...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $html = '<table border="0" cellspacing="0" cellpadding="5">'
            ...
            . '<b>25-27 Industrial Ave </b><br>'
            . ' Hoppers Crossing<br>'
            // . $business_phone . '<br>'
            . 'orders@doorsblindsandshutters.com.au <br>'
            // . $business_web . '<br><br>'
            . 'Tax Invoice <br>'
            . 'ABN: 65162848197'
...
$pdf->SetAuthor('');
$pdf->SetTitle('Wholesale Invoice ' . $inv_no);
$pdf->SetSubject('');
$pdf->SetKeywords('');
...
$html .= '<table cellspacing="0" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>TOTAL PRICE </strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($main_prices, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>ACCESSORIES</strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($calc_acc_price, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>EXTRA`S</strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($total_extras, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>' . $tax_name . '</strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($tax, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>DISCOUNT (' . $discount_1 . '%)</strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($discount_1_val, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 30%;" rowspan="4"><strong>Customer Signature:</strong><br>' . $signature . '</td>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>DISCOUNT ( ' . $currency_sign . ' )</strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($discount_2, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>CASH, CARD OR EFT PRICE</strong></td>'
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($grand_total, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>DEPOSIT</strong></td>'
    ...
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 15%;">' . number_format($deposit, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 20%;"><strong>BALANCE</strong></td>'
    ...
    . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 15%;">' . number_format(round($balance, 2), 2) . '</td>'
    . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
...
if (!isset($_GET['email'])) {
    $pdf->Output('Wholesale-Invoice-' . $inv_no . '.pdf', 'I');
} else {
    print $pdf->Output('Wholesale-Invoice-' . $inv_no . '.pdf', 'S');
}
