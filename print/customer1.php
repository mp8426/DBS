...
$deposit_details = '<table border="0" cellspacing="0" cellpadding="5"><tr><td style="width: 690; font-weight: bold;">DEPOSIT HISTORY</td></tr></table>';
...
while ($stmt_10->fetch()) {
    $deposit_details .= '<table border="0" cellspacing="0" cellpadding="5"><tr><td style="width: 600; border-top: 1px solid #000000; text-align: left;">' . $deposit_detail_description . ' - ' . $deposit_detail_date . '</td><td style="width: 80; border-top: 1px solid #000000; text-align: right; line-height: 22px;">' . number_format($deposit_detail_amount, 2) . '</td></tr></table>';
}
$stmt_10->close();
...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
    ...
    . '<td style="font-size: 1.0em; border: 1px solid #000000; width: 165px; text-align: center; line-height: 22px;"><strong>CUSTOMER COPY</strong></td>'
    . '</tr>'
    . '<tr>'
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 300px; text-align: left;" rowspan="5"><strong></strong><br><br></td>'
    . '<td style="border: 1px solid #000000; width: 200px; text-align: left; font-size: 0.9em;" rowspan="10">' . $deposit_details . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>TOTAL PRICE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($main_prices, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>ACCESSORIES</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($calc_acc_price, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border-top: 1px solid #000000; border-right: 1px solid #000000; width: 300px; text-align: center; font-size: 0.9em;" rowspan="5"><strong>THAT BY ACCEPTING THE QUOTE YOU HAVE READ OUR <br> TERMS & CONDITIONS</strong><br>' . $signature . '</td>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>EXTRA`S</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($calc_per_met_price + $calc_fit_cha_price + $total_fitting_charge, 2) . '</td>'
    . '</tr>'
    . '<!--tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>SUB TOTAL</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($total_1, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>MARKUP ( ' . $extras . '% )</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($extras_amount, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>TOTAL + MARKUP</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($sub_total, 2) . '</td>'
    . '</tr-->'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>' . $tax_name . '</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($tax, 2) . '</td>'
    . '</tr>'
    . '<!--tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>Package DISCOUNTS (' . $discount_1 . '%)</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($discount_1_val, 2) . '</td>'
    . '</tr-->'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em; color:red;"><strong>Package DISCOUNTS</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px; color:red;">' . number_format($discount_1_val + $discount_2, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><img src="../profile/humm-logo.jpg" style="height: 15px; width: auto;"></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px; ' . $humm_methad . '">' . number_format($grand_total_defult + ($grand_total_defult * 0.15), 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>CASH, CARD OR EFT PRICE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px; ' . $cash_methad . '">' . number_format($grand_total_defult, 2) . '</td>'
    . '</tr>'
    // . '<tr>'
    // . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>DEPOSIT</strong></td>'
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format($deposit, 2) . '</td>'
    // . '</tr>'
    // . '<tr>'
    // . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>BALANCE (HUMM)</strong></td>'
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format(round($grand_total_defult + ($grand_total_defult * 0.15) - $deposit, 2), 2) . '</td>'
    // . '</tr>'
    // . '<tr>'
    // . '<td style="border: 1px solid #000000; width: 135px; font-size: 0.9em;"><strong>BALANCE</strong></td>'
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 70px;">' . number_format(round($grand_total_defult - $deposit, 2), 2) . '</td>'
    // . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
  ...
  $html .= '<table cellspacing="0" cellpadding="0" style="font-size: 0.7em;" nobr="true">'
        . '<tr>'
        . '<td style="width:350px;" align="left">'
        . '<table cellpadding="1" style="border: 1px solid #fff;">'
        . '<tr>'
        . '<td style="width:70px; font-weight: bold;" colspan="2" >1. Definitions</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="text-align: right;width:20px;" >I.</td>'
        . '<td style="width:330px;">“Seller” shall mean Doors Blinds and Shutters Pty its successors and assigns or any person acting on behalf of
        ...
        . '<td>“Price” shall mean the cost of the Goods as agreed between the Seller and the Client subject to clause 3 of the contract.<br></td>'
        . '</tr>'
        . '<tr>'
...
address and/or any other change in the Client’s details.</td>'
        ...
        . '<td style="text-align: right;" >IV.</td>'
        . '<td>The Client undertakes to give the Seller at least fourteen (14) days notice of any changes in the Client’s name,
address and/or any other change in the Client’s details.<br></td>'
        . '</tr>'
        . '<tr>'
...
no time is stated, then payment shall be due seven (7) days following the date of invoice.</td>'
        ...
        . '<tr>'
        . '<td style="text-align: right;" >V.</td>'
        . '<td>Payment will be made by cash, or by credit card, or by
debit card, or by any other method as agreed to by the Client and the Seller.</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="text-align: right;" >VI.</td>'
        . '<td>GST and other taxes and duties that may be applicable shall be added to the Price except when they are expressly included in the Price.<br></td>'
        . '</tr>'
        . '<tr>'
...
greater or less than the quantity purchased provided that;</td>'
        ...
        . '<td>The Seller shall not be liable for any loss of damage whatever due to failure by the Seller to deliver the Goods (or any of them) promptly at all.<br></td>'
        . '</tr>'
        . '<tr>'
...
the need for any person dealing with the Seller to make further enquiries.<br></td>'
        . '</tr>'
        . '<tr>'
...
into other products, the parties agree that the Seller will be the owner of the products.<br></td>'
        . '</tr>'
		. '<tr>'
...
that the Goods are bought retrying solely upon the Client’s skill and judgement.<br></td>'
        . '</tr>'
		. '<tr>'
...
Goods or repairing the Goods.<br></td>'
        . '</tr>'
		. '<tr>'
...
representation or warranty given by the manufacturer of the Goods.<br></td>'
        . '</tr>'
		. '<tr>'
...
Australia, except to the extent by those Acts where applicable.<br></td>'
        . '</tr>'
        . '</table>'
        . '</td>'
        ...
        . '<table cellpadding="1" style="border: 1px solid #fff;">'
		. '<tr>'
        . '<td style="text-align: left;font-weight: bold; width:350px;" colspan="2">11. Intellectual Property</td>'
        . '</tr>'
		. '<tr>'
        . '<td style="text-align: right; width:20px;" >I.</td>'
        . '<td style="width:330px;">Where the Seller had designed, drawn or written Goods for the Client, then the copyright in those designs and
...
registered design or trademark in the execution or the Client’s order.<br></td>'
        . '</tr>'
		. '<tr>'
        ...
        . '<tr>'
        . '<td style="text-align: right; width:20px;">I.</td>'
        . '<td style="width:330px;">Interest on overdue invoices shall accrue from the date when payment becomes due daily until the date of
...
Attorney to perform all necessary Acts to give effect to the provisions to this clause 13.1<br></td>'
        . '</tr>'
		. '<tr>'
...
installation has been appointed.</td>'
		...
		. '<tr>'
        . '<td style="text-align: right;" >IV.</td>'
        . '<td> All cancellation of orders must be by written notice.<br></td>'
        . '</tr>'
		. '<tr>'
...
outstanding in the Client’s account in relation to the Goods.</td>'
		...
		. '<tr>'
        . '<td style="text-align: right;" ></td>'
        . '<td>ii. allow the credit reporting agency to create or maintain a credit information file containing information about the Client<br></td>'
        . '</tr>'
		. '<tr>'
