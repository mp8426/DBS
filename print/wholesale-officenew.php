...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        /*      $html = '<table border="0" cellspacing="6" cellpadding="0" style="font-size: 0.9em; color: #666; line-height: 10px;">'
            ...
            . '<div>'
            . '<img src="' . __DIR__ . '../../profile/wholesalebanner.jpg" style="height: 48px; width: auto;">'
            . '</div>'
            . '</td>'
        ...
        $html = '<table border="0" cellspacing="6" cellpadding="0" style="font-size: 0.9em; color: #666; line-height: 10px;">'
            ...
            . '<td style="width: 160px;">'
            . '<div>'
            . '<img src="' . __DIR__ . '/../profile/wholesalebanner.jpg" style="height: 55px; width: auto;">'
            . '</div>'
            . '</td>'
            ...
            $html = '<table border="0" cellspacing="0" cellpadding="5">'
                ...
                . '<img src="' . __DIR__ . '/../profile/wholesalebanner.jpg" style="height: 100px; width: auto;">'
                . '</td>'
...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
    ...
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 120px; text-align: center; line-height: 12px;"><strong>Date:</strong><br>' . $q_created_date . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 120px; text-align: center; line-height: 12px;"><strong>Appointment:</strong><br>' . $assign_date . '</td>'
    ...
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 150px; text-align: left;">Office Use:</td>'
    . '<td style="font-size: 1.2em; border: 1px solid #000000; width: 165px; text-align: center; line-height: 22px;"><strong>OFFICE COPY</strong></td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;"><strong>Customer Details:</strong> ' . $c_contact_name . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;"><strong>Location Details:</strong> ' . $q_name_1 . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 165px; text-align: left;" rowspan="6"><strong>Records:</strong><br><br>' . nl2br($records) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;">Name: ' . $c_name_1 . ' ' . $c_name_2 . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;">Name: ' . $q_name_2 . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;">Address: ' . $customer_address . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;">Address: ' . $quote_address . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Suburb: ' . $c_suburb . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Postcode: ' . $c_postcode . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Suburb: ' . $q_suburb . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Postcode: ' . $q_postcode . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;">Email: ' . $c_email . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 270px; text-align: left;">Email: ' . $q_email . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Phone: ' . $c_phone . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Mobile: ' . $c_mobile . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Phone: ' . $q_phone . '</td>'
    . '<td style="font-size: 0.9em; border: 1px solid #000000; width: 135px; text-align: left;">Mobile: ' . $q_mobile . '</td>'
    . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 300px; text-align: left;" rowspan="12"><strong>Instructions:</strong><br><br>' . nl2br($instruction) . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>TOTAL PRICE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($main_prices, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>ACCESSORIES</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($calc_acc_price, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>PER METERS</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($calc_per_met_price, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>FITTING CHARGE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($calc_fit_cha_price + $total_fitting_charge, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>SUB TOTAL</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($total_1, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>MARKUP ( ' . $extras . '% )</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($extras_amount, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>TOTAL + MARKUP</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($sub_total, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>' . $tax_name . '</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($tax, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>DISCOUNT (' . $discount_1 . '%)</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($discount_1_val, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border-top: 1px solid #000000; border-right: 1px solid #000000; width: 175px; text-align: center;" rowspan="4"><strong>ACCEPTANCE OF QUOTATION</strong><br>' . $signature . '</td>'
    . '<td style="border-top: 1px solid #000000; width: 175px; text-align: center;"><strong>FITTED & OPERATING TO MY SATISFACTION</strong></td>'
    . '<td style="border: 1px solid #000000; width: 150px;" rowspan="2"><strong>FITTER:</strong></td>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>DISCOUNT ( ' . $currency_sign . ' )</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($discount_2, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="width: 175px; font-size: 0.9em;">NAME:</td>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>CASH, CARD OR EFT PRICE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($grand_total, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="width: 175px; font-size: 0.9em;" rowspan="2">SIGNATURE:</td>'
    . '<td style="border: 1px solid #000000; width: 150px;" rowspan="2"><strong>DATE FITTED:</strong></td>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>DEPOSIT</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format($deposit, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 115px;"><strong>BALANCE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 90px;">' . number_format(round($balance, 2), 2) . '</td>'
    . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
