...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
  ...
  //  . '<td style="border: 1px solid #000000; width: 700px; text-align: left;" rowspan="6"><strong>Instructions:</strong><br><br>' . nl2br($instruction) . '</td>'
    ...
    . '<td style="border: 1px solid #000000; width: 155px;"><strong><img src="../profile/humm-logo.jpg" style="height: 15px; width: auto;"></strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 150px; ' . $humm_methad . '"><strong>' . number_format($grand_total_defult + ($grand_total_defult * 0.15), 2) . '</strong></td>'
