...
$html .= '</td>'
    ...
    if (!empty($calc_acc_price)) {
        ...
        $ex_tr .= '<tr>'
            . '<td style="border: 0.5px solid #616060; color:#303030; width: 115px;"><strong>ACCESSORIES</strong></td>'
            . '<td style="border-bottom: 1px solid #616060; text-align: right; width: 190px;">' . number_format($calc_acc_price, 2) . '</td>'
            . '</tr>';
    ...
    if (!empty($calc_per_met_price)) {
        ...
        $ex_tr .= '<tr>'
            . '<td style="border: 0.5px solid #616060; color:#303030; width: 115px;"><strong>PER METERS</strong></td>'
            . '<td style="border-bottom: 1px solid #616060; text-align: right; width: 190px;">' . number_format($calc_per_met_price, 2) . '</td>'
            . '</tr>';
    ...
    if (!empty($calc_fit_cha_price) || !empty($total_fitting_charge)) {
        ...
        $ex_tr .= '<tr>'
            . '<td style="border: 0.5px solid #616060; color:#303030; width: 115px;"><strong>FITTING CHARGE</strong></td>'
            . '<td style="border-bottom: 1px solid #616060; text-align: right; width: 190px;">' . number_format($calc_fit_cha_price + $total_fitting_charge, 2) . '</td>'
            . '</tr>';
    ...
    if (!empty($ex_tr)) {
        ...
        $ex_tr .= '<tr>'
            . '<td style="border: 0.5px solid #616060; color:#303030; width: 115px;"><strong>SUB TOTAL</strong></td>'
    ...
    if (!empty($discount_1_val)) {
        ...
        $ex_tr_2 .= '<tr>'
            . '<td style="border: 0.5px solid #616060; color: #277cbe width: 115px;"><strong>DISCOUNT (' . $discount_1 . '%)</strong></td>'
            . '<td style="border-bottom: 1px solid #616060; text-align: right; width: 190px;">' . number_format($discount_1_val, 2) . '</td>'
            . '</tr>';
    ...
    if (!empty($discount_2)) {
        ...
        $ex_tr_2 .= '<tr>'
            . '<td style="border: 0.5px solid #616060; color: #277cbe; width: 115px;"><strong>DISCOUNT ( ' . $currency_sign . ' )</strong></td>'
            . '<td style="border-bottom: 1px solid #616060; text-align: right; width: 190px;">' . number_format($discount_2, 2) . '</td>'
            . '</tr>';
    ...
    $deposit_tr = '<td style="border: 0.5px solid #616060; color:#303030; width: 115px; font-size: 15px;"><br><br><strong>BALANCE</strong></td>'
