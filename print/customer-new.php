...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
    ...
    . '<td style="font-size: 1.3em; border: 1px solid #000000; width: 305px; text-align: center; line-height: 22px;"><strong>CUSTOMER COPY</strong></td>'
    . '</tr>'
    . '<tr>'
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '<tr>'
  //  . '<td style="border: 1px solid #000000; width: 700px; text-align: left;" rowspan="6"><strong>Instructions:</strong><br><br>' . nl2br($instruction) . '</td>'
    . '<td style="border: 1px solid #000000; width: 700px; text-align: left; font-size: 0.9em;" rowspan="5">' . $payment_credit_card_text . '<br>' . $deposit_details . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 155px;"><strong>TOTAL</strong></td>'
    ...
    // . '</tr>'
    . '<tr>'
    . '<td style="border-top: 1px solid #000000; border-right: 1px solid #000000; width: 250px; text-align: center;" rowspan="5"><strong>THAT BY ACCEPTING THE QUOTE YOU HAVE READ OUR TERMS & CONDITIONS</strong><br>' . $signature . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="width: 250px; font-size: 0.9em;">SIGNATURE:</td>'
    . '<td style="border: 1px solid #000000; width: 200px;"><strong>DATE FITTED:</strong></td>'
    . '<td style="border: 1px solid #000000; width: 155px;"><strong>CASH, CARD OR EFT PRICE</strong></td>'
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 150px; ' . $cash_methad . '">' . number_format($grand_total_defult, 2) . '</td>'
    ...
    . '</tr>'
    // . '<tr>'
    // . '<td style="border: 1px solid #000000; width: 155px;"><strong>BALANCE (HUMM)</strong></td>'
    ...
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 100px;">' . number_format(round($grand_total + ($grand_total * 0.15) - $deposit, 2), 2) . '</td>'
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 100px;">' . number_format(round($grand_total_defult + ($grand_total_defult * 0.15) - $deposit, 2), 2) . '</td>'
    // . '</tr>'
    // . '<tr>'
    ...
    // . '<td style="border-bottom: 1px solid #000000; border-right: 1px solid #000000; text-align: center; width: 50px;">' . $balance_payment_button . '</td>'
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 100px;">' . number_format(round($grand_total + ($grand_total * 0.15) - $deposit, 2), 2) . '</td>'
    // . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 100px;">' . number_format(round($grand_total_defult - $deposit, 2), 2) . '</td>'
    // . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
