...
$queryt_2 = "SELECT q_name_1, q_name_2, q_address_1, q_address_2, q_suburb, q_postcode, q_email, q_phone, q_mobile, q_fax, c_ref, c_hdfu, DATE_FORMAT(created_date,'%d/%m/%Y'), customer_id FROM quotes WHERE quote_no = ?";
...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
        ...
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 100px; text-align: center; line-height: 12px;"><strong>Date:</strong><br>' . $q_created_date . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 100px; text-align: center; line-height: 12px;"><strong>Appointment:</strong><br>' . $assign_date . '</td>'
        ...
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Office Use:</td>'
        ...
        . '</tr>'
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;"><strong>Customer Details:</strong> ' . $c_contact_name . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;"><strong>Location Details:</strong> ' . $q_name_1 . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 305px; text-align: left;" rowspan="6"><strong>Records:</strong><br><br>' . nl2br($records) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Name: ' . $c_name_1 . ' ' . $c_name_2 . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Name: ' . $q_name_2 . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Address: ' . $customer_address . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Address: ' . $quote_address . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 175px; text-align: left;">Suburb: ' . $c_suburb . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 175px; text-align: left;">Postcode: ' . $c_postcode . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 175px; text-align: left;">Suburb: ' . $q_suburb . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 175px; text-align: left;">Postcode: ' . $q_postcode . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Email: ' . $c_email . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 350px; text-align: left;">Email: ' . $q_email . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 116.66px; text-align: left;">Phone: ' . $c_phone . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 116.66px; text-align: left;">Mobile: ' . $c_mobile . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 116.66px; text-align: left;">Fax: </td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 116.66px; text-align: left;">Phone: ' . $q_phone . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 116.66px; text-align: left;">Mobile: ' . $q_mobile . '</td>'
        . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 116.66px; text-align: left;">Fax: ' . $q_fax . '</td>'
        . '</tr>'
        . '</table>'
        . '</td>'
        . '</tr>'
...
//        include_once '../' . $calculation_x . '/print-office-copy.php';
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
        ...
        . '<tr>'
        . '<td style="border: 1px solid #000000; width: 500px; text-align: left;" rowspan="11"><strong>Instructions:</strong><br><br>' . nl2br($instruction) . '</td>'
        ...
        . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 150px;">' . number_format($total_2, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        ...
        . '<td style="border: 1px solid #000000; width: 155px;"><strong>DISCOUNT</strong></td>'
