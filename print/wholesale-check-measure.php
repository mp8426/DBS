...
$pdf->SetAuthor('');
$pdf->SetTitle('Check Measure Copy - ' . $cid);
$pdf->SetSubject('');
$pdf->SetKeywords('');
...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
    ...
    . '<td style="font-size: 1.3em; border: 1px solid #000000; width: 305px; text-align: center; line-height: 22px;"><strong>CHECK MEASURE COPY</strong></td>'
    . '</tr>'
    . '<tr>'
    ...
    . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 305px; text-align: left;" rowspan="4"><strong>Records:</strong><br><br>' . nl2br($records) . '</td>'
    . '</tr>'
    . '<tr>'
    ...
    . '<td style="font-size: 0.8em; border: 1px solid #000000; width: 305px; text-align: center;">
        <table>
            <tr>
...
$print_file = $layout == 2 ? 'print-check-measure-2.php' : 'print-check-measure.php';
...
if (!isset($_GET['email'])) {
    $pdf->Output('check-measure-' . $cid . '.pdf', 'I');
} else {
    print $pdf->Output('check-measure-' . $cid . '.pdf', 'S');
}
