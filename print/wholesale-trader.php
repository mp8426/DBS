...
$pdf->SetAuthor('');
$pdf->SetTitle('Wholesaler Copy - ' . $cid);
$pdf->SetSubject('');
$pdf->SetKeywords('');
...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
        ...
        . '<td style="font-size: 1.3em; border: 1px solid #000000; width: 305px; text-align: center; line-height: 22px;"><strong>WHOLESALE COPY</strong></td>'
        . '</tr>'
        . '<tr>'
...
$print_file = $layout == 2 ? 'print-trader-copy-2.php' : 'print-trader-copy.php';
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
        ...
        . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 100px;">' . number_format($deposit, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        ...
        . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 100px;">' . number_format(round($balance, 2), 2) . '</td>'
        . '</tr>'
        . '</table>'
        . '</td>'
        . '</tr>'
