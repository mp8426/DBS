...
$html .= '<table cellspacing="0" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '<td style="border: 1px solid #f1f1f1; width: 30%; text-align: center; font-size: 0.9em;" rowspan="14">' . $deposit_details . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border: 1px solid #f1f1f1; width: 30%;" rowspan="6"><strong>Customer Signature:</strong><br>' . $signature . '</td>'
