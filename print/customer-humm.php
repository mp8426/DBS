...
if($numcount != 1 || empty($numcount)){
    ...
    $humm_div = 'display:none;';
}else{
    $cash_methad = 'color:#ffffff;';
    $cash_div = 'display:none;';
}
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
  ...
  //  . '<td style="border: 1px solid #000000; width: 700px; text-align: left;" rowspan="6"><strong>Instructions:</strong><br><br>' . nl2br($instruction) . '</td>'
    . '<td style="border: 1px solid #000000; width: 700px; text-align: left; font-size: 0.9em;" rowspan="7">' . $payment_credit_card_text . '<br>' . $deposit_details . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border-top: 1px solid #000000; border-right: 1px solid #000000; width: 250px; text-align: center;" rowspan="4"><strong>THAT BY ACCEPTING THE QUOTE YOU HAVE READ OUR TERMS & CONDITIONS</strong><br>' . $signature . '</td>'
    ...
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 150px; ' . $humm_methad . '"><strong>' . number_format($grand_total, 2) . '</strong></td>'
    . '</tr>'
    . '<tr>'
    ...
    . '<td style="border-bottom: 1px solid #000000; text-align: right; width: 150px; ' . $cash_methad . '">' . number_format($grand_total, 2) . '</td>'
    . '</tr>'
    . '<tr>'
