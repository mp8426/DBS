...
$receipt_no = 'R' . preg_replace('/[^0-9]/', '', $cid);
...
while ($stmt_10->fetch()) {
    $deposit_details .= '<tr>'
        . '<td style="border: 1px solid #f1f1f1; width: 80%;">'
        . $deposit_detail_description . ' - on ' . $deposit_detail_date
        . '</td>'
        . '<td style="border: 1px solid #f1f1f1; width: 20%; text-align: right;">'
        . number_format($deposit_detail_amount, 2)
        . '</td>'
        . '</tr>';

    $deposit_total += $deposit_detail_amount;
}
$stmt_10->close();
...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $html = '<table border="0" cellspacing="0" cellpadding="5">'
            ...
            . '<img src="../profile/wholesalebanner.jpg" style="height: 100px; width: auto;">'
            . '</td>'
            ...
            . $business_web . '<br><br>'
            . 'RECIEPT'
            . '<div style="font-size: 2em;"><b>' . $receipt_no . '</b></div>'
...
$html = '<table border="0" cellspacing="0" cellpadding="5">'
    ...
    . $customer_address . ' ' . $c_suburb . ' ' . $c_postcode
    . '</td>'
    . '</tr>'
    . '</table><br><br>';
...
$html .= '<table border="0" cellspacing="0" cellpadding="5">'
    . '<tr>'
    . '<th style="border: 1px solid #f1f1f1; width: 80%; background-color: #ccc;">'
    . '<b>DESCRIPTION</b>'
    . '</th>'
    . '<th style="border: 1px solid #f1f1f1; width: 20%; background-color: #ccc; text-align: right;">'
    . '<b>AMOUNT</b>'
    . '</th>'
    . '</tr>'
    . $deposit_details
    . '<tr>'
    . '<th style="border: 1px solid #f1f1f1; width: 80%;">'
    . '<b>TOTAL</b>'
    . '</th>'
    . '<th style="border: 1px solid #f1f1f1; width: 20%; text-align: right;">'
    . '<b>' . number_format($deposit_total, 2) . '</b>'
    . '</th>'
    . '</tr>'
    . '</table><br><h1 style="text-align: center; font-size: 2em;">THANK YOU</h1>';
...
//     . '<tr>'
//     . '<td style="border: 1px solid #f1f1f1; width: 30%; text-align: center; font-size: 0.9em;" rowspan="4">' . $payment_credit_card_text . '</td>'
//     . '<td style="border: 1px solid #f1f1f1; width: 30%; text-align: center; font-size: 0.9em;" rowspan="8">' . $deposit_details . '</td>'
...
//     . '</tr>'
//     . '<tr>'
//     . '<td style="border: 1px solid #f1f1f1; width: 15%;"><strong>DISCOUNT (' . $discount_1 . '%)</strong></td>'
//     . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 25%;">' . number_format($discount_1_val, 2) . '</td>'
//     . '</tr>'
//     . '<tr>'
//     . '<td style="border: 1px solid #f1f1f1; width: 30%;" rowspan="4"><strong>Customer Signature:</strong><br>' . $signature . '</td>'
//     . '<td style="border: 1px solid #f1f1f1; width: 15%;"><strong>DISCOUNT ( ' . $currency_sign . ' )</strong></td>'
//     . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 25%;">' . number_format($discount_2, 2) . '</td>'
//     . '</tr>'
//     . '<tr>'
//     . '<td style="border: 1px solid #f1f1f1; width: 15%;"><strong>CASH, CARD OR EFT PRICE</strong></td>'
//     . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 25%;">' . number_format($grand_total, 2) . '</td>'
//     . '</tr>'
//     . '<tr>'
//     . '<td style="border: 1px solid #f1f1f1; width: 15%;"><strong>DEPOSIT</strong></td>'
...
//     . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format($deposit, 2) . '</td>'
//     . '</tr>'
//     . '<tr>'
//     . '<td style="border: 1px solid #f1f1f1; width: 15%;"><strong>BALANCE</strong></td>'
...
//     . '<td style="border-bottom: 1px solid #f1f1f1; text-align: right; width: 20%;">' . number_format(round($balance, 2), 2) . '</td>'
//     . '</tr>'
//     . '</table>'
//     . '</td>'
//     . '</tr>'
...
if (!isset($_GET['email'])) {
    ...
    print $pdf->Output('Receipt-' . $receipt_no . '.pdf', 'S');
}
