...
//$pdf = new MYPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);	4.11 × 6.28
$pdf = new MYPDF('P', 'mm', array(104, 159), true, 'UTF-8', false);
...
//     foreach ($calculation as $calculation_x) {
        include_once '../' . $calculation . '/print-label.php';
        ...
        $pdf->writeHTML(${$calculation_x . "_quote_tables_FB"}, true, false, true, false, '');
//     }
// }
