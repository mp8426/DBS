...
$summary .= '<table>'
        ...
        . '<td style="text-align: left; font-size:18px;" valign="center" align="center"><strong>OFFICE COPY</strong></td>'
...
$summary .= '<table>'
        ...
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;" rowspan="11" colspan="2" valign="top">' . nl2br($instruction) . '</td>'
        . '<td style="border: 1px solid #000000;" rowspan="11" valign="top" align="center">' . $deposit_details . '</td>'
        ...
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>TOTAL PRICE</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($main_prices, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>ACCESSORIES</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($calc_acc_price, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>PER METERS</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($calc_per_met_price, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>FITTING CHARGE</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($calc_fit_cha_price + $total_fitting_charge, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>SUB TOTAL</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($total_1, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>MARKUP ( ' . $extras . '% )</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($extras_amount, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>TOTAL + MARKUP</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($sub_total, 2) . '</td>'
        . '</tr>'
        . '<tr>'
        . '<td style="border: 1px solid #000000;"><strong>' . $tax_name . '</strong></td>'
        . '<td style="border-bottom: 1px solid #000000; text-align: right;">' . number_format($tax, 2) . '</td>'
        . '</tr>'
        . '<tr>'
