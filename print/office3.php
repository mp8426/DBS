...
while ($stmt_10->fetch()) {
    $deposit_details .= '<table border="0" cellspacing="0" cellpadding="5"><tr><td style="width: 140; border-top: 0.5px solid #525659;">' . $deposit_detail_description . '<br>' . $deposit_detail_date . '</td><td style="width: 50; border-top: 1px solid #000000; text-align: right; line-height: 22px;">' . number_format($deposit_detail_amount, 2) . '</td></tr></table>';
}
$stmt_10->close();
...
$quote_summary = '<table cellspacing="0" cellpadding="3" style="color: #525252; width:350px;">'
    ...
    . '<td style="font-size: 1em; border-bottom: 0.5px solid #616060; color:#464747; width: 100px; text-align: left;"><strong>Quantity:</strong></td>'
    . '<td style="font-size: 1em; border-bottom: 0.5px solid #616060; color:#464747; width: 100px; text-align: left;"><strong>Price:</strong></td>'
    . '</tr>';

foreach ($price_list as $key) {

    $quote_summary .= '<tr>'
        . '<td style="font-size: 1em; border-top: 0.5px solid #616060; border-bottom: 0.5px solid #616060; color:#464747; width: 145px; text-align: left;"><strong>' . $key['p_name'] . '</strong></td>'
        . '<td style="font-size: 1em; border-top: 0.5px solid #616060; border-bottom: 0.5px solid #616060; color:#464747; width: 100px; text-align: left;">' . $key['quantity'] . '</td>'
        . '<td style="font-size: 1em; border-top: 0.5px solid #616060; border-bottom: 0.5px solid #616060; color:#464747; width: 100px; text-align: left;">' . $key['price'] . '</td>'
        . '</tr>';
}
...
<tr>
    ...
    <td style="font-size: 1em; border-top: 0.5px solid #616060; color:#464747; width: 100px; text-align: left;"><strong></strong></td>
    <td style="font-size: 1em; border-top: 0.5px solid #616060; color:#464747; width: 100px; text-align: left;"><strong>' . number_format($grand_total, 2) . '</strong></td>
</tr>';
$quote_summary  .= '</table>';
...
$html_top_tbl ='<table cellspacing="0" cellpadding="3">'
    . '<tr>'
    . '<td style="font-size: 0.8em; border-bottom: 0.5px solid #616060; background-color:#eaeaea; color:#464747; margin-top:5px; width: 175px; text-align: center; line-height: 12px; height: 18px;"><strong>Date:</strong><br>' . $q_created_date . '</td>'
    . '<td style="font-size: 0.8em; border-bottom: 0.5px solid #616060; background-color:#eaeaea; color:#464747; margin-top:5px; width: 175px; text-align: center; line-height: 12px; height: 18px;"><strong>Appointment:</strong><br>' . $assign_date . '</td>'
    . '<td style="font-size: 0.8em; border-bottom: 0.5px solid #616060; background-color:#eaeaea; color:#464747; margin-top:5px; width: 175px; text-align: center; line-height: 12px; height: 18px;"><strong>Lead Source:</strong><br>' . $c_hdfu . '</td>'
    . '<td style="font-size: 0.8em; border-bottom: 0.5px solid #616060; background-color:#eaeaea; color:#464747; margin-top:5px; width: 175px; text-align: left; line-height: 12px; height: 18px;"><strong>Office Use:</strong></td>'
    ...
    . '<tr>'
    . '<td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 350px; text-align: left;"><strong>Customer Details:</strong> ' . $c_contact_name . '</td>'
    // . '<td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 350px; text-align: left;"><strong>Location Details:</strong> ' . $q_name_1 . '</td>'
    ...
    . '<td style="padding: 0; font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 350px; text-align: left;" rowspan="6">' . $quote_summary . '</td>'

    . '<td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 305px; text-align: left;" rowspan="6"><strong>Records:</strong><br><br>' . nl2br($records) . '</td>'
    . '</tr>';
...
$html_top_tbl .= '<tr>
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 350px; text-align: left;"><strong>Name:</strong> ' . $c_name_1 . ' ' . $c_name_2 . '</td>
            </tr>' .
    '<tr>
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 350px; text-align: left;"><strong>Address:</strong> ' . $customer_address . '</td> 
            </tr>' .
    '<tr>
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 175px; text-align: left;"><strong>Suburb:</strong> ' . $c_suburb . '</td>
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 175px; text-align: left;">Postcode: ' . $c_postcode . '</td>
            </tr>' .
    '<tr>
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 350px; text-align: left;"><strong>Email:</strong> ' . $c_email . '</td>
            </tr>
            <tr> 
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 175px; text-align: left;"><strong>Phone:</strong> ' . $c_phone . '</td>
                <td style="font-size: 0.8em; border: 0.5px solid #616060; color:#464747; width: 175px; text-align: left;">Mobile: ' . $c_mobile . '</td>
            </tr>';
...
$html = '<table border="0" cellspacing="6" cellpadding="0">'
    ...
    . '<tr>'
    . '<td style="font-size:0.9em; border: 1px solid #525659; width: 410px; text-align: left; color:#464747;" rowspan="4"><br><strong>Instructions:</strong><br>' . nl2br($instruction) . '</td>'
    . '<td style="font-size:0.8em; width: 10px; text-align: left; color:#464747;"></td>'
    . '<td style="font-size:0.9em; width: 120px; text-align: left; color:#464747;">Roller Blind Pulldowns</td>'
    . '<td style="font-size:0.8em; width: 50px; text-align: left; color:#464747;">' .$rbp_details.'</td>'
    . '<td style="font-size:0.9em; width: 155px; text-align: left; color:#464747;">Extension Lader Required</td>'
    . '<td style="font-size:0.8em; width: 60px; text-align: left; color:#464747;">' .$elr_details.'</td>'
    . '<td style="font-size:0.9em; width: 160px; text-align: left; color:#464747;">Check Measure Required</td>'
    . '<td style="font-size:0.8em; width: 40px; text-align: left; color:#464747;">' .$cmr_details.'</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="font-size:0.8em; width: 10px; text-align: left; color:#464747;"></td>'
    ...
    . '<tr>'
    . '<td style="width: 200px; text-align: left; color:#464747;"><br><br><strong>Customer Name:</strong> ' . nl2br($w_customer_name) . '</td>'
    . '<td style="width: 190px; text-align: left; color:#464747;"><br><br><strong>Customer Phone:</strong> ' . nl2br($w_customer_phone) . '</td>'
    . '<td style="width: 180px; text-align: left; color:#464747;"><br><br><strong>Balance To Collect: </strong> ' . nl2br($balance_to_collect) . '</td>'
    . '<td style="width: 425px; text-align: left; color:#464747;"><br><br><strong>Installation Address:</strong> ' . nl2br($installation_address_1) . ' ' . nl2br($installation_address_2) . '</td>'
    . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    . '<tr>'
    . '<td>'
    . '<table cellpadding="5" style="color:#464747; border: 0.5px solid #525659;">'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 500px; text-align: left;" rowspan="12"></td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 200px; text-align: left; font-size: 0.9em;" rowspan="12">' . $deposit_details . '</td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; text-align: center; width: 305px;"><strong>Payment Method</strong></td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border-right: 0.5px solid #525659; text-align: center; width: 305px;" colspan="2">' . $bank_account_name . '<br>' . $bank_account_no . '<br>' . $bsb_no . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; text-align: center; width: 305px;"><strong>Quote No. Required with electronic deposits</strong></td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>TOTAL PRICE</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($main_prices, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>ACCESSORIES</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($calc_acc_price, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>PER METERS</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($calc_per_met_price, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>FITTING CHARGE</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($calc_fit_cha_price + $total_fitting_charge, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>SUB TOTAL</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($total_1, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>MARKUP ( ' . $extras . '% )</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($extras_amount, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>TOTAL + MARKUP</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($sub_total, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>' . $tax_name . '</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($tax, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>DISCOUNT (' . $discount_1 . '%)</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($discount_1_val, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="border-top: 0.5px solid #525659; border-right: 0.5px solid #525659; width: 250px; text-align: center;" rowspan="4"><strong>ACCEPTANCE OF QUOTATION</strong><br>' . $signature . '</td>'
    . '<td style="border-top: 0.5px solid #525659; width: 250px; text-align: center;"><strong>FITTED & OPERATING TO MY SATISFACTION</strong></td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 200px;" rowspan="2"><strong>FITTER:</strong></td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>DISCOUNT ( ' . $currency_sign . ' )</strong></td>' 
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px; color: #277cbe;">' . number_format($discount_2, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="width: 250px; font-size: 0.9em;">NAME:</td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>CASH, CARD OR EFT PRICE</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($grand_total, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="width: 250px; font-size: 0.9em;" rowspan="2">SIGNATURE:</td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 200px;" rowspan="2"><strong>DATE FITTED:</strong></td>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>DEPOSIT</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format($deposit, 2) . '</td>'
    . '</tr>'
    . '<tr>'
    . '<td style="color:#464747; border: 0.5px solid #525659; width: 155px;"><strong>BALANCE</strong></td>'
    . '<td style="border-bottom: 0.5px solid #525659; text-align: right; width: 150px;">' . number_format(round($balance, 2), 2) . '</td>'
    . '</tr>'
    . '</table>'
    . '</td>'
    . '</tr>'
