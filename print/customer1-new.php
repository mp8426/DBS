...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '<td style="border: 1px solid #000000; width: 200px; text-align: left; font-size: 0.9em;" rowspan="9">' . $deposit_details . '</td>'
    ...
    . '</tr>'
    . '<tr>'
    . '<td style="border-top: 1px solid #000000; border-right: 1px solid #000000; width: 300px; text-align: center; font-size: 0.9em;" rowspan="4"><strong>THAT BY ACCEPTING THE QUOTE YOU HAVE READ OUR <br> TERMS & CONDITIONS</strong><br>' . $signature . '</td>'
