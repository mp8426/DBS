...
class MYPDF extends TCPDF
{
   ...
   /*     $html = '<table border="0" cellspacing="6" cellpadding="0" style="font-size: 0.9em; color: #666; line-height: 10px;">'
            ...
            . '<div>'
            . '<img src="../profile/wholesalebanner.jpg" style="height: 48px; width: auto;">'
            . '</div>'
            . '</td>'
        ...
        $html = '<table border="0" cellspacing="6" cellpadding="0" style="font-size: 0.9em; color: #666; line-height: 10px;">'
                ...
                . '<td style="width: 160px;">'
                . '<div>'
                . '<img src="../profile/wholesalebanner.jpg" style="height: 55px; width: auto;">'
                . '</div>'
                . '</td>'
...
$html .= '<table cellspacing="6" cellpadding="0" style="font-size: 0.8em;" nobr="true">'
    ...
    . '<tr>'
    . '<td style="border: 1px solid #000000; width: 300px; text-align: left;" rowspan="7"><strong></strong><br><br></td>'
