...
$query_1 = "INSERT INTO flooring_lab_2_calculation_quote_item_fitting_charges ( code, name, price, flooring_lab_2_calculation_quote_item_code, flooring_lab_2_calculation_code, cid ) VALUES( ?, ?, ?, ?, ?, ? )";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('ssssss', $fitting_charge_code, $fitting_charge_name, $fitting_charge_price, $flooring_lab_2_calculation_quote_item_code, $flooring_lab_2_calculation_code, $cid);
