...
$query_1 = "INSERT INTO flooring_lab_2_calculation_quote_item_accessories ( code, name, price, qty, flooring_lab_2_calculation_quote_item_code, flooring_lab_2_calculation_code, cid ) VALUES( ?, ?, ?, ?, ?, ?, ? )";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('sssssss', $accessory_code, $accessory_name, $accessory_price, $accessory_qty, $flooring_lab_2_calculation_quote_item_code, $flooring_lab_2_calculation_code, $cid);
