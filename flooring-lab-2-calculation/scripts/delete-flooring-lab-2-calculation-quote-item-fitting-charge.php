...
$query_1 = "DELETE FROM flooring_lab_2_calculation_quote_item_fitting_charges WHERE code = ? AND flooring_lab_2_calculation_quote_item_code = ? AND flooring_lab_2_calculation_code = ? AND cid = ?";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('ssss', $fitting_charge_code, $flooring_lab_2_calculation_quote_item_code, $flooring_lab_2_calculation_code, $cid);
