...
$flooring_lab_2_calculation_field_code = filter_input(INPUT_POST, 'field_code');
$flooring_lab_2_calculation_code = filter_input(INPUT_POST, 'flooring_lab_2_calculation_code');

if ($name !== "") {

    $query_1 = "INSERT INTO flooring_lab_2_calculation_field_options ( code, name, flooring_lab_2_calculation_field_code, flooring_lab_2_calculation_code ) VALUES( ?, ?, ?, ? )";

    $stmt_1 = $mysqli->prepare($query_1);
    $stmt_1->bind_param('ssss', $code, $name, $flooring_lab_2_calculation_field_code, $flooring_lab_2_calculation_code);
