    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            if ($flooring_lab_2_calculation_quote_item_notes || $flooring_lab_2_calculation_quote_item_accessories || $flooring_lab_2_calculation_quote_item_fitting_charges) {
                ...
                if ($accessories_select === 1 && $accessory_print[0] === '1' && $flooring_lab_2_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[0] === '1' && $flooring_lab_2_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[0] === '1' && $flooring_lab_2_calculation_quote_item_fitting_charges
                ) {
