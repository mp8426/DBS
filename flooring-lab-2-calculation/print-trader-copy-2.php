...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM flooring_lab_2_calculation_fields WHERE office_copy = 1 AND flooring_lab_2_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT flooring_lab_2_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_lab_2_calculation_fields.office_copy = 1 AND "
...
//                }
            ...
            if ($flooring_lab_2_calculation_quote_item_notes && $note_print[0] === '1') {
