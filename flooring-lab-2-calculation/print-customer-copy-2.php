...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM flooring_lab_2_calculation_fields WHERE customer_copy = 1 AND flooring_lab_2_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $price_sub_total = $price_sub_total + $flooring_lab_2_calculation_quote_item_total;
            ...
            $query_3_1 = "SELECT flooring_lab_2_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_lab_2_calculation_fields.customer_copy = 1 AND "
...
//                }
                ...
                if ($flooring_lab_2_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $flooring_lab_2_calculation_quote_item_field_name . '</td>';
                }
                if ($flooring_lab_2_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $flooring_lab_2_calculation_quote_item_field_name . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $quote_item_accessories_total_td = $total_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_2_calculation_quote_item_accessory_total, 2) . '</td>' : '';

                $quote_item_accessories .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $flooring_lab_2_calculation_quote_item_accessory_name . ' ($' . $flooring_lab_2_calculation_quote_item_accessory_price . ' x ' . $flooring_lab_2_calculation_quote_item_accessory_qty . ')</td>'
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $quote_item_per_meters_total_td = $total_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_2_calculation_quote_item_per_meter_total, 2) . '</td>' : '';

                $quote_item_per_meters .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $flooring_lab_2_calculation_quote_item_per_meter_name . ' ($' . $flooring_lab_2_calculation_quote_item_per_meter_price . ' x ' . $flooring_lab_2_calculation_quote_item_per_meter_width . ')</td>'
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $quote_item_fitting_charges_total_td = $total_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_2_calculation_quote_item_fitting_charge_price, 2) . '</td>' : '';

                $quote_item_fitting_charges .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $flooring_lab_2_calculation_quote_item_fitting_charge_name . '</td>'
                        . $quote_item_fitting_charges_total_td
                        . '</tr>';
            }
            $stmt_3_4->close();

            $location_td = $locations_select === 1 && $location_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_2_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_lab_2_calculation_quote_item_unit . '</td>' : '';
            $installation_type_td = $installation_type_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_2_calculation_quote_item_installation_type)[0] . '</td>' : '';
            $price_td = $price_print[1] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_2_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[1] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_2_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($flooring_lab_2_calculation_quote_item_notes && $note_print[1] === '1') {
            ...
            if ($group_discount_print[1] === '1') {
                ...
                $flooring_lab_2_calculation_quote_item_discount_value = $price_sub_total * $flooring_lab_2_calculation_quote_item_discount / 100;
                $flooring_lab_2_calculation_quote_item_price_total = $price_sub_total - $flooring_lab_2_calculation_quote_item_discount_value;
                ...
                $flooring_lab_2_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        ...
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $total_table_colspan . '">Discount (' . $flooring_lab_2_calculation_quote_item_discount . '%) </th>'
        ...
        $flooring_lab_2_calculation_quote_tables .= $flooring_lab_2_calculation_table_header . $quote_items . $table_more . $flooring_lab_2_calculation_total . "<div></div>";
    } else {
        $flooring_lab_2_calculation_quote_tables .= "";
    }
    $stmt_3->close();
