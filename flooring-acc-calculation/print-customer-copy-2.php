...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $price_sub_total = $price_sub_total + $flooring_acc_calculation_quote_item_total;
...
//                }
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $quote_item_accessories_total_td = $total_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_acc_calculation_quote_item_accessory_total, 2) . '</td>' : '';

                $quote_item_accessories .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $flooring_acc_calculation_quote_item_accessory_name . ' ($' . $flooring_acc_calculation_quote_item_accessory_price . ' x ' . $flooring_acc_calculation_quote_item_accessory_qty . ')</td>'
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $quote_item_per_meters_total_td = $total_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_acc_calculation_quote_item_per_meter_total, 2) . '</td>' : '';

                $quote_item_per_meters .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $flooring_acc_calculation_quote_item_per_meter_name . ' ($' . $flooring_acc_calculation_quote_item_per_meter_price . ' x ' . $flooring_acc_calculation_quote_item_per_meter_width . ')</td>'
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $quote_item_fitting_charges_total_td = $total_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_acc_calculation_quote_item_fitting_charge_price, 2) . '</td>' : '';

                $quote_item_fitting_charges .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $flooring_acc_calculation_quote_item_fitting_charge_name . '</td>'
            ...
            if ($group_discount_print[1] === '1') {
                ...
                $flooring_acc_calculation_quote_item_discount_value = $price_sub_total * $flooring_acc_calculation_quote_item_discount / 100;
                $flooring_acc_calculation_quote_item_price_total = $price_sub_total - $flooring_acc_calculation_quote_item_discount_value;
                ...
                $flooring_acc_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        ...
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $total_table_colspan . '">Discount (' . $flooring_acc_calculation_quote_item_discount . '%) </th>'
        ...
        $flooring_acc_calculation_quote_tables .= $flooring_acc_calculation_table_header . $quote_items . $table_more . $flooring_acc_calculation_total . "<div></div>";
    } else {
        $flooring_acc_calculation_quote_tables .= "";
    }
    $stmt_3->close();
