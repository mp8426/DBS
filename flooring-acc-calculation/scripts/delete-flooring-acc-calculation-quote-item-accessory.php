...
$query_1 = "DELETE FROM flooring_acc_calculation_quote_item_accessories WHERE code = ? AND flooring_acc_calculation_quote_item_code = ? AND flooring_acc_calculation_code = ? AND cid = ?";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('ssss', $accessory_code, $flooring_acc_calculation_quote_item_code, $flooring_acc_calculation_code, $cid);
