    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                if ($flooring_acc_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $flooring_acc_calculation_quote_item_field_name . '</td>';
                }
                if ($flooring_acc_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $flooring_acc_calculation_quote_item_field_name . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $location_td = $locations_select === 1 && $location_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_acc_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_acc_calculation_quote_item_unit . '</td>' : '';
            $manufacturer_td = $manufacturer_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_acc_calculation_quote_item_manufacturer)[0] . '</td>' : '';
            $collection_td = $collection_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_acc_calculation_quote_item_collection)[0] . '</td>' : '';
            $colour_td = $colour_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_acc_calculation_quote_item_colour)[0] . '</td>' : '';
            $cost_td = $cost_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . number_format($flooring_acc_calculation_quote_item_collection_cost, 2) . '</td>' : '';
            $markup_td = $markup_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_acc_calculation_quote_item_collection_markup . '%</td>' : '';
            $required_unit_td = $required_unit_print[1] === '1' ? '' : '';
            $price_td = $price_print[1] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_acc_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[1] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_acc_calculation_quote_item_total, 2) . '</td>' : '';
