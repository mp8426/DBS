...
$query_1 = "SELECT code, name, locations, materials_and_colours, accessories, per_meters, fitting_charges FROM window_price_sheet_12_calculations ORDER BY position ASC";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->execute();
$stmt_1->bind_result($window_price_sheet_12_calculation_code, $window_price_sheet_12_calculation_name, $locations_select, $materials_and_colours_select, $accessories_select, $per_meters_select, $fitting_charges_select);
$stmt_1->store_result();
...
while ($stmt_1->fetch()) {
    ...
    $qty_th = $qty_print[0] === '1' ? '<th style="text-align: center; border: 0.5px solid #000000;">Qty</th>' : '';
    ...
    $qty_td_num_rows = $qty_print[0] === '1' ? 1 : 0;
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            // $price_sub_total += $window_price_sheet_12_calculation_quote_item_price;
            $price_sub_total += $window_price_sheet_12_calculation_quote_item_total;
            ...
            $table_colspan = $table_th_num_rows + $field_td_num_rows + $qty_td_num_rows + $total_td_num_rows;
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $quote_item_accessories_price_td = $price_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($window_price_sheet_12_calculation_quote_item_accessory_total, 2) . '</td>' : '';

                $quote_item_accessories .= '<tr>'
                    . '<td style="border: 0.5px solid #000000; text-align: center;">' . $row_no . '</td>'
                    . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $window_price_sheet_12_calculation_quote_item_accessory_name . ' ($' . $window_price_sheet_12_calculation_quote_item_accessory_price . ' x ' . $window_price_sheet_12_calculation_quote_item_accessory_qty . ')</td>'
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $quote_item_per_meters_price_td = $price_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($window_price_sheet_12_calculation_quote_item_per_meter_total, 2) . '</td>' : '';

                $quote_item_per_meters .= '<tr>'
                    . '<td style="border: 0.5px solid #000000; text-align: center;">' . $row_no . '</td>'
                    . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $window_price_sheet_12_calculation_quote_item_per_meter_name . ' ($' . $window_price_sheet_12_calculation_quote_item_per_meter_price . ' x ' . $window_price_sheet_12_calculation_quote_item_per_meter_width . ')</td>'
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $quote_item_fitting_charges_price_td = $price_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($window_price_sheet_12_calculation_quote_item_fitting_charge_price, 2) . '</td>' : '';

                $quote_item_fitting_charges .= '<tr>'
                    . '<td style="border: 0.5px solid #000000; text-align: center;">' . $row_no . '</td>'
                    . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $window_price_sheet_12_calculation_quote_item_fitting_charge_name . '</td>'
            ...
            $qty_td = $qty_print[0] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_qty . '</td>' : '';
            $total_td = $total_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_price_sheet_12_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($group_discount_print[0] === '1') {
                ...
                $window_price_sheet_12_calculation_quote_item_discount_value = $price_sub_total * $window_price_sheet_12_calculation_quote_item_discount / 100;
                $window_price_sheet_12_calculation_quote_item_price_total = $price_sub_total - $window_price_sheet_12_calculation_quote_item_discount_value;
                ...
                $window_price_sheet_12_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                    ...
                    . '</tr>'
                    . '<tr style="font-size: 0.9em;">'
                    . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $total_table_colspan . '">Discount (' . $window_price_sheet_12_calculation_quote_item_discount . '%) </th>'
        ...
        $window_price_sheet_12_calculation_quote_tables .= $window_price_sheet_12_calculation_table_header . $quote_items . $table_more . $window_price_sheet_12_calculation_total . "<div></div>";
    } else {
        $window_price_sheet_12_calculation_quote_tables .= "";
    }
    $stmt_3->close();
