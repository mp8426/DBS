...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM window_price_sheet_12_calculation_fields WHERE office_copy = 1 AND window_price_sheet_12_calculation_code = ? ORDER BY position ASC";
    ...
    // $query_3 = "SELECT code, location, width_x, drop_x, type, material, colour, notes, price, qty, total, discount FROM window_price_sheet_12_calculation_quote_items WHERE window_price_sheet_12_calculation_code = ? AND cid = ? ORDER BY id ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT window_price_sheet_12_calculation_quote_item_fields.name, "
                ...
                . "WHERE "
                . "window_price_sheet_12_calculation_fields.office_copy = 1 AND "
            ...
            $location_td = $locations_select === 1 && $location_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_price_sheet_12_calculation_quote_item_location)[0] . '</td>' : '';
            $width_x_td = $width_x_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_drop . '</td>' : '';
            $type_td = $type_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_price_sheet_12_calculation_quote_item_type)[0] . '</td>' : '';
            $material_td = $materials_and_colours_select === 1 && $material_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_price_sheet_12_calculation_quote_item_material)[0] . '</td>' : '';
            $colour_td = $materials_and_colours_select === 1 && $colour_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_price_sheet_12_calculation_quote_item_colour)[0] . '</td>' : '';
            ...
            $price_td = $price_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_price_sheet_12_calculation_quote_item_price, 2) . '</td>' : '';
            $qty_td = $qty_select === 1 && $price_print[0] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_qty . '</td>' : '';
            $total_td = $qty_select === 1 && $price_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_price_sheet_12_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($window_price_sheet_12_calculation_quote_item_notes || $window_price_sheet_12_calculation_quote_item_accessories || $window_price_sheet_12_calculation_quote_item_per_meters || $window_price_sheet_12_calculation_quote_item_fitting_charges) {
                ...
                if ($window_price_sheet_12_calculation_quote_item_notes && $note_print[0] === '1') {
                ...
                if ($window_price_sheet_12_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[0] === '1') {
                ...
                if ($window_price_sheet_12_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[0] === '1') {
                ...
                if ($window_price_sheet_12_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[0] === '1') {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[0] === '1' && $window_price_sheet_12_calculation_quote_item_accessories ||
                    $per_meters_select === 1 && $per_meter_print[0] === '1' && $window_price_sheet_12_calculation_quote_item_per_meters ||
                    $fitting_charges_select === 1 && $fitting_charge_print[0] === '1' && $window_price_sheet_12_calculation_quote_item_fitting_charges
                ) {
