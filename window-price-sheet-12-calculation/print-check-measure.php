...
while ($stmt_1->fetch()) {
    ...
    $query_2x = "SELECT location, width_x, drop_x, type, material, colour, price, note, group_discount, accessory, per_meter, fitting_charge FROM window_price_sheet_12_calculation_fixed_fields_visibility WHERE window_price_sheet_12_calculation_code = ?";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $width_x_td = $width_x_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_width . '</td>' : ''; // Permission from office Copy
            $drop_x_td = $drop_x_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_drop . '</td>' : ''; // Permission from office Copy
            ...
            //     $window_price_sheet_12_calculation_total_table_colspan = $table_td_num_rows + $field_td_num_rows + $price_td_num_rows;
        ...
        $window_price_sheet_12_calculation_quote_tables .= $window_price_sheet_12_calculation_table_header . $window_price_sheet_12_calculation_quote_items . "<div></div>";
    } else {
        $window_price_sheet_12_calculation_quote_tables .= "";
    }
    $stmt_3->close();
