...
while ($stmt_1->fetch()) {
    ...
    $qty_th = $qty_print[1] === '1' ? '<th style="text-align: center; border: 0.5px solid #000000;">Qty</th>' : '';
    ...
    $qty_td_num_rows = $qty_print[1] === '1' ? 1 : 0;
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $qty_td = $qty_print[1] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_price_sheet_12_calculation_quote_item_qty . '</td>' : '';
            $total_td = $total_print[1] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_price_sheet_12_calculation_quote_item_total, 2) . '</td>' : '';
