$(function () {
    ...
    $.ajax({
        url: "form-no-1-calculation/scripts/get-form-no-1-calculations.php",
        type: "POST",
        dataType: "json",
        data: { cid: cid },
        beforeSend: function () {
                ...
                if (data[0] === 2) {
                    ...
                    if (data[0] === 1) {
                        ...
                        $.each(data[1], function (index, value) {
                            ...
                            var form_no_1_calculation_code = value.code;
                            ...
                            $.each(value.fields, function (field_index, field_value) {
                                ...
                                if (field_value.side === 1) { //left side
                                    ...
                                    if (field_value.field_type === 0) {
                                        ...
                                        field_options += '<option class="form-no-1-calculation-add-field-option-x" data-field-code="' + field_value.code + '" value="add-new">Add New</option>';
                                        ...
                                        field_element_left += '<td>\n\
                                                        <select name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="form-no-1-calculation-field data-field ' + sub_option_class + '">\n\
                                                            <option value=""></option>\n\
                                                            ' + field_options + '\
                                                        </select>\n\
                                                        ' + sub_option_btn + '\
                                                        <span class="form-no-1-calculation-add-field-option-wrapper">\n\
                                        ...
                                        field_element_left += '<td>\n\
                                                        <input type="text" name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="form-no-1-calculation-field data-field text-field" autocomplete="off">\n\
                                                    </td>';
                                    }
                                }
                            ...
                            if (value.accessories_select === 1) {
                                ...
                                accessory_element = '<span class="form-no-1-calculation-accessories-wrapper">\n\
                            ...
                            if (value.per_meters_select === 1) {
                                ...
                                per_meter_element = '<span class="form-no-1-calculation-accessories-wrapper">\n\
                            ...
                            if (value.fitting_charges_select === 1) {
                                ...
                                fitting_charge_element = '<span class="form-no-1-calculation-fitting-charges-wrapper">\n\
                            ...
                            if (value.qty_select === 1) {
                                ...
                                var add_qty_element = '<td><input type="tel" name="price" class="form-no-1-calculation-price price-input data-field" autocomplete="off"></td>' +
                                    '<td><input type="number" name="qty" class="form-no-1-calculation-qty number-input" autocomplete="off" min="1" value="1"></td><td><input type="number" name="total" class="form-no-1-calculation-total number-input" autocomplete="off" min="1" value="" readonly><input type="hidden" class="data-field" name="qty_field" value="on"></td>';
                            ...
                            if (value.status === 1) {
                                ...
                                $('<li><a href="#tab-' + value.code + '">' + value.name + '</a></li>').prependTo("#form-no-1-calculation-tabs .tabs ul");
                                $('<div id="tab-' + value.code + '" class="form-no-1-calculation-tab-div"></div>')
                                    .append($('<form class="add-form-no-1-calculation-quote-item-form ' + qty_class + '" action="./" method="POST"></form>')
                                        .append('<input type="hidden" name="calc-name" class="calc-name" value="form_no_1">')
                                        .append('<input type="hidden" class="cid" name="cid" value="' + cid + '">')
                                        .append('<input type="hidden" class="form-no-1-calculation-code" name="form-no-1-calculation-code" value="' + form_no_1_calculation_code + '">')
                                        .append($('<table class="form-no-1-calculation-table"></table>')
                                            ...
                                            .append($('<tbody></tbody>')
                                                .append($('<tr class="tbody-tr"></tr>')
                                                    ...
                                                    // .append('<td><input type="tel" name="cost" data-column="cost" class="form-no-1-calculation-cost number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder=""></td>')
                                                    // .append('<td><input type="tel" name="markup" data-column="markup" class="form-no-1-calculation-markup number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="%"></td>')
                                                    .append('<td>\n\
                                    ...
                                    ).prependTo("#form-no-1-calculation-tabs .calculation-results").find(".bttn-input").button();
                            }
                            // End of prepend Calculation methods

                            if (JSON.stringify(value.quote_items) !== '[]') {

                                $('<div id="form-no-1-calculation-quote-items-wrapper-' + form_no_1_calculation_code + '" class="form-no-1-calculation-quote-items-wrapper"></div>')
                                    .append('<h2 class="form-no-1-calculation-header">' + value.name + '</h2>')
                                    .append('<div id="quote-items-body-' + form_no_1_calculation_code + '" class="form-no-1-calculation-quote-items-body ' + qty_class + '"></div>')
                                    ...
                                    <a href="print/order-sheet-form-no-1-calculation-' + form_no_1_calculation_code + '-' + cid + '" target="_blank" class="fa-btn tltip dark" data-title="PDF | Order Sheet"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> <small>Order Sheet in PDF</small></a>\n\
                                    <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-form-no-1-calculation-' + form_no_1_calculation_code + '-' + cid + '" target="_blank" class="fa-btn tltip dark" data-title="EXL | Order Sheet"><i class="fa fa-file-excel-o" aria-hidden="true"></i> <small>Order Sheet in EXL</small></a>\n\
                                    <form class="group-discount-form" style="float: right; margin-right: -6px; font-size: 12px;">\n\
                                        ...
                                        <input type="hidden" class="form-no-1-calculation-code" value="' + form_no_1_calculation_code + '">\n\
                                ...
                                </div>').prependTo("#form-no-1-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button();
                                ...
                                $.each(value.quote_items, function (quote_item_index, quote_item_value) {
                                    ...
                                    $('<form id="calculation-form-' + quote_item_value.code + '" class="update-form-no-1-calculation-quote-item-form" action="./" method="POST">\n\
                                    <input type="hidden" name="calc-name" class="calc-name" value="form_no_1">\n\
                                    <input type="hidden" name="cid" class="cid" value="' + cid + '">\n\
                                    <input type="hidden" name="form-no-1-calculation-code" class="form-no-1-calculation-code" value="' + form_no_1_calculation_code + '">\n\
                                    <input type="hidden" name="form-no-1-calculation-quote-item-code" class="form-no-1-calculation-quote-item-code" value="' + quote_item_value.code + '">\n\
                                    ...
                                    <table id="calculation-table-more-' + quote_item_value.code + '"  class="form-no-1-calculation-table-more">\n\
                                        <tr>\n\
                                            <td class="table-more-notes" colspan="3">\n\
                                                <textarea name="notes" data-column="notes" class="form-no-1-calculation-notes data-field" placeholder="Notes">' + quote_item_value.notes + '</textarea>\n\
                                            </td>\n\
                                        </tr>\n\
                                        <tr>\n\
                                ...
                                </form>').appendTo("#quote-items-body-" + form_no_1_calculation_code).queue(function () {
                                        ...
                                        $.each(quote_item_value.fields, function (quote_item_fields_index, quote_item_fields_value) {
                                            ...
                                            var form_no_1_calculation_field_code = quote_item_fields_value.form_no_1_calculation_field_code;
                                            //this_form.find("[name='field[" + form_no_1_calculation_field_code + "]']").val(field_name + '<->' + field_code);

                                            if (this_form.find("[name='field[" + form_no_1_calculation_field_code + "]']").is('input')) {
                                                this_form.find("[name='field[" + form_no_1_calculation_field_code + "]']").val(field_name);
                                            } else {
                                                this_form.find("[name='field[" + form_no_1_calculation_field_code + "]']").val(field_name + '<->' + field_code + '<->' + field_price).attr('data-selected-sub-options', quote_item_fields_value.sub_options);
                                            }
                                        });
                                        ...
                                        $.each(quote_item_value.accessories, function (quote_item_accessories_index, quote_item_accessories_value) {
                                            ...
                                            this_form.find(".table-more-accessories").append('<span class="form-no-1-calculation-accessories-wrapper">\n\
                                                                                            <input type="text" class="form-no-1-calculation-accessory" readonly disabled value="' + accessory_name + ' | ' + accessory_price + ' x ' + accessory_qty + ' = ' + accessory_total + '">\n\
                                                                                            <input type="button" class="delete-form-no-1-calculation-accessory bttn-input" data-code="' + accessory_code + '" value="✖">\n\
                                                                                        </span>');

                                            this_form.find('.form-no-1-calculation-accessories option[data-code="' + accessory_code + '"]').hide();
                                        });
                                        ...
                                        $.each(quote_item_value.per_meters, function (quote_item_per_meters_index, quote_item_per_meters_value) {
                                            ...
                                            this_form.find(".table-more-per-meters").append('<span class="form-no-1-calculation-per-meters-wrapper">\n\
                                                                                            <input type="text" class="form-no-1-calculation-per-meter" readonly disabled value="' + per_meter_name + ' | ' + per_meter_price + ' x ' + per_meter_width + ' = ' + per_meter_total + '">\n\
                                                                                            <input type="button" class="delete-form-no-1-calculation-per-meter bttn-input" data-code="' + per_meter_code + '" value="✖">\n\
                                                                                        </span>');

                                            this_form.find('.form-no-1-calculation-per-meters option[data-code="' + per_meter_code + '"]').hide();
                                        });
                                        ...
                                        $.each(quote_item_value.fitting_charges, function (quote_item_fitting_charges_index, quote_item_fitting_charges_value) {
                                            ...
                                            this_form.find(".table-more-fitting-charges").append('<span class="form-no-1-calculation-fitting-charges-wrapper">\n\
                                                                                                <input type="text" class="form-no-1-calculation-fitting-charge" readonly disabled value="' + fitting_charge_name + ' | ' + fitting_charge_price + '">\n\
                                                                                                <input type="button" class="delete-form-no-1-calculation-fitting-charge bttn-input" data-code="' + fitting_charge_code + '" value="✖">\n\
                                                                                            </span>');

                                            this_form.find('.form-no-1-calculation-fitting-charges option[data-code="' + fitting_charge_code + '"]').hide();
                                        });

                                        var note_length = quote_item_value.notes;
                                        var accessory_length = this_form.find('.form-no-1-calculation-accessory').length;
                                        var per_meter_length = this_form.find('.form-no-1-calculation-per-meter').length;
                                        var fitting_charge_length = this_form.find('.form-no-1-calculation-fitting-charge').length;

                                        if (note_length || accessory_length || per_meter_length || fitting_charge_length) {
                                            this_form.find('.form-no-1-calculation-table-more-bttn').addClass("red");
                                        } else {
                                            this_form.find('.form-no-1-calculation-table-more-bttn').removeClass("red");
                                        }
                                ...
                                $("#form-no-1-calculation-quote-items-wrapper-" + form_no_1_calculation_code)
                                ...
                                $(".form-no-1-calculation-quote-items-body .form-no-1-calculation-table .thead").first().html(table_header); // Add Table headers for each calculation
                            } else {
                                ...
                                $('<div id="form-no-1-calculation-quote-items-wrapper-' + form_no_1_calculation_code + '" class="form-no-1-calculation-quote-items-wrapper"></div>')
                                    ...
                                    .prependTo("#form-no-1-calculation-quote-items-results").hide();
                            }
                        });
...
// $(document).on("click", ".form-no-1-calculation-select-all-bttn", function () {
//     var this_bttn = $(this);
//     var this_text = this_bttn.val();
//     var this_parent = this_bttn.parents(".form-no-1-calculation-quote-items-wrapper");
...
$(document).on("click", ".form-no-1-calculation-bulk-delete-bttn", function () {

    var this_bttn = $(this);
    var this_parent = this_bttn.parents(".form-no-1-calculation-quote-items-wrapper");
    var table_header = this_parent.find(".form-no-1-calculation-table .thead .thead-tr:first").clone();
        ...
        iziToast.question({
            ...
            buttons: [
                ['<button><b>Yes</b></button>', function (instance, toast, button, e, inputs) {
                    ...
                    $.ajax({
                        url: "form-no-1-calculation/scripts/delete-bulk-form-no-1-calculation-quote-items.php",
                        type: 'POST',
                        dataType: 'json',
                        data: datas,
                        beforeSend: function () {
                            ...
                            if (data[0] === 4) {
                                ...
                                if (data[0] === 2) {
                                    ...
                                    if (data[0] === 1) {
                                        ...
                                        if (!this_parent.find('.update-form-no-1-calculation-quote-item-form').length) {
                                            ...
                                            // });
                                            this_parent.find(".form-no-1-calculation-table .thead").first().html(table_header);
                                        }

                                        this_bttn.prop('disabled', false).removeClass('field-loader');

                                        form_no_1_calculation_group_discount(this_bttn);
                        ...
                        error: function (jqXHR, textStatus, errorThrown) {
                            this_bttn.prop('disabled', false).removeClass('field-loader');
                            alert(JSON.stringify(jqXHR));
                            alert("Error! @delete-bulk-form-no-1-calculation-quote-item");
                        }
                    });
...
$(document).on("click", ".form-no-1-calculation-bulk-copy-bttn", function () {
    ...
    var form_no_1_calculation_code = this_bttn.siblings('.group-discount-form').find('.form-no-1-calculation-code').val();

    var max_row_no = -Infinity;
    $(document).find("#quote-items-body-" + form_no_1_calculation_code).find(".quote-item-row-no").each(function () {
    ...
    if (datas) {
        ...
        $.ajax({
            url: "form-no-1-calculation/scripts/copy-bulk-form-no-1-calculation-quote-items.php",
            type: 'POST',
            dataType: 'json',
            data: datas + '&cid=' + cid,
            beforeSend: function () {
                    ...
                    if (data[0] === 2) {
                        ...
                        if (data[0] === 1) {
                            $.each(data[1], function (old_code, new_code) {
                                ...
                                calculation_form.find(".form-no-1-calculation-quote-item-code").val(new_code);
                                ...
                                calculation_form.find(".form-no-1-calculation-table-more").attr("id", "calculation-table-more-" + new_code).hide();
                                calculation_form.find(".form-no-1-calculation-table .thead").empty();

                                this_row_no++;

                                $(calculation_form).appendTo(this_parent.find('.form-no-1-calculation-quote-items-body')).queue(function () {
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @copy-bulk-form-no-1-calculation-quote-item");
            }
        });
    }
});

$(document).on("click", ".delete-form-no-1-calculation-quote-item", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents(".update-form-no-1-calculation-quote-item-form");
    var code = this_form.find(".form-no-1-calculation-quote-item-code").val();

    var this_parent = this_form.parents(".form-no-1-calculation-quote-items-wrapper");
    var table_header = this_parent.find(".form-no-1-calculation-table .thead .thead-tr:first").clone();
    ...
    iziToast.question({
        ...
        buttons: [
            ['<button><b>Yes</b></button>', function (instance, toast, button, e, inputs) {
                ...
                $.ajax({
                    url: "form-no-1-calculation/scripts/delete-form-no-1-calculation-quote-item.php",
                    type: 'POST',
                    dataType: 'json',
                        ...
                        if (data[0] === 4) {
                            ...
                            if (data[0] === 2) {
                                ...
                                if (data[0] === 1) {
                                    ...
                                    form_no_1_calculation_group_discount(this_form);
                                    $('#getsum').load('getsum.php?cid=' + cid).fadeIn("fast");
                                    $('#totalx').load('megaTotal.php?cid=' + cid).fadeIn("fast");
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        this_bttn.prop('disabled', false).removeClass('field-loader');
                        alert(JSON.stringify(jqXHR));
                        alert("Error! @delete-form-no-1-calculation-quote-item");
                    }
                });
...
$(document).on("click", ".form-no-1-calculation-table-more-bttn", function () {
    var this_bttn = $(this);
    var this_form = this_bttn.parents("form");

    this_bttn.find('.fa').toggleClass('rotate');
    this_form.find(".form-no-1-calculation-table-more").toggle("slide", { direction: "up" }, "fast");
});

$(document).on("change", ".checkbox-input", function () {
    var this_checkbox = $(this);
    var this_table = this_checkbox.parents(".form-no-1-calculation-table");
...
$(document).on("change", ".add-form-no-1-calculation-quote-item-form .form-no-1-calculation-cost,\n\
                                .add-form-no-1-calculation-quote-item-form .form-no-1-calculation-markup,\n\
                                .add-form-no-1-calculation-quote-item-form .form-no-1-calculation-field", function () {
    get_form_no_1_calculation_price(this);
});

function get_form_no_1_calculation_price(this_element) {

    var this_form = $(this_element).parents("form");
    var price_element = this_form.find(".form-no-1-calculation-price");
    var dyn_field = this_form.find(".form-no-1-calculation-field");

    var qty_element = this_form.find(".form-no-1-calculation-qty");
    var total_element = this_form.find(".form-no-1-calculation-total");

    var qty_field = this_form.find('input[name="qty_field"]').val();

    var code = this_form.find(".form-no-1-calculation-code").val();
    var cost = this_form.find(".form-no-1-calculation-cost").length ? +this_form.find(".form-no-1-calculation-cost").val() : 0;
    var markup = this_form.find(".form-no-1-calculation-markup").length ? +this_form.find(".form-no-1-calculation-markup").val() : 1;
...
$(document).on("change", ".add-form-no-1-calculation-quote-item-form .form-no-1-calculation-price, .add-form-no-1-calculation-quote-item-form .form-no-1-calculation-qty", function () {

    var this_form = $(this).parents("form");
    update_form_no_1_calculation_total_price(this_form);
});

function update_form_no_1_calculation_total_price(this_form) {
...
$(document).on("change", ".form-no-1-calculation-field", function (event) {
    var this_element = $(this);
    var this_form = this_element.parents("form");
    var add_field_option_element_parent = this_element.siblings(".form-no-1-calculation-add-field-option-wrapper");
    var add_field_option_element = add_field_option_element_parent.find(".form-no-1-calculation-add-field-option");
    ...
    var checked_checkbox = this_form.parents(".form-no-1-calculation-quote-items-body").find(".checkbox-input:checked");

    if (this_chcekedbox.is(":checked") && checked_checkbox.length) {

        checked_checkbox.not(this_chcekedbox).each(function () {
            var this_form_x = $(this).parents(".update-form-no-1-calculation-quote-item-form");
...
function form_no_1_calculation_add_field_option(field_option_name, field_option_price, this_element) {

    var this_element = $(this_element);
    var this_form = this_element.parents("form");
    var add_field_option_element_parent = this_element.parents(".form-no-1-calculation-add-field-option-wrapper");
    var add_field_option_element = add_field_option_element_parent.find(".form-no-1-calculation-add-field-option");
    var add_field_option_submit = add_field_option_element_parent.find(".form-no-1-calculation-add-field-option-submit");

    var field_element = add_field_option_element_parent.siblings(".form-no-1-calculation-field");
    var field_code = field_element.attr("data-code");
    var form_no_1_calculation_code = this_form.find(".form-no-1-calculation-code").val();
    var data_fields = this_form.find(".data-field, .number-input, select, [type='submit']");
    ...
    if (field_option_name) {
        ...
        $.ajax({
            url: "form-no-1-calculation/scripts/add-form-no-1-calculation-field-option.php",
            type: "POST",
            dataType: "json",
            data: { field_code: field_code, field_option_name: field_option_name, field_option_price: field_option_price, form_no_1_calculation_code: form_no_1_calculation_code },
            beforeSend: function () {
                ...
                if (data[0] === 4) {
                    ...
                    if (data[0] === 2) {
                        ...
                        if (data[0] === 1) {
                            ...
                            $(".form-no-1-calculation-add-field-option-x[data-field-code=" + field_code + "]").before('<option value="' + data[2] + '<->' + data[1] + '<->' + price + '">' + data[2] + ' | ' + price + '</option>');
...
$(document).on("keypress", ".form-no-1-calculation-add-field-option, .form-no-1-calculation-add-field-option-price", function (event) {
    if (event.keyCode === 13) {
        ...
        var add_field_option_element_parent = this_element.parents(".form-no-1-calculation-add-field-option-wrapper");
        var add_field_option_element = add_field_option_element_parent.find(".form-no-1-calculation-add-field-option");
        var add_field_option_price_element = add_field_option_element_parent.find(".form-no-1-calculation-add-field-option-price");

        var field_option_name = add_field_option_element.val();
        var field_option_price = add_field_option_price_element.val();

        form_no_1_calculation_add_field_option(field_option_name, field_option_price, this_element);
        return false;
    }
});

$(document).on("click", ".form-no-1-calculation-add-field-option-submit", function (event) {
    event.preventDefault();

    var this_element = $(this);
    var add_field_option_element = this_element.siblings(".form-no-1-calculation-add-field-option");
    var add_field_option_price_element = this_element.siblings(".form-no-1-calculation-add-field-price-option");
...
$(document).on("click", ".form-no-1-calculation-add-field-option-close", function () {
    var this_element = $(this);
    var this_form = this_element.parents("form");
    var add_field_option_element_parent = this_element.parents(".form-no-1-calculation-add-field-option-wrapper");
    var add_field_option_element = add_field_option_element_parent.find(".form-no-1-calculation-add-field-option");
...
function form_no_1_calculation_group_discount(this_element) {

    var result_parent = $(this_element).parents(".form-no-1-calculation-quote-items-wrapper");
    var quote_items_parent = result_parent.find(".form-no-1-calculation-quote-items-body");
...
$(document).on("submit", ".add-form-no-1-calculation-quote-item-form", function (event) {
    event.preventDefault();

    var this_form = $(this);
    var this_submit_bttn = this_form.find('[type="submit"]');
    var this_table_thead_tr = this_form.find(".form-no-1-calculation-table .thead-tr");
    var this_table_tbody_tr = this_form.find(".form-no-1-calculation-table .tbody-tr");
    var form_no_1_calculation_code = this_form.find(".form-no-1-calculation-code").val();
    ...
    var result_parent = $("#form-no-1-calculation-quote-items-wrapper-" + form_no_1_calculation_code);
    ...
    $.ajax({
        url: "form-no-1-calculation/scripts/add-form-no-1-calculation-quote-item.php",
        type: 'POST',
        dataType: 'json',
        data: datas,
                ...
                if (data[0] === 2) {
                    ...
                    if (data[0] === 1) {
                        ...
                        $.each(data[1], function (index, code) {
                            ...
                            if (!$("#quote-items-body-" + form_no_1_calculation_code + " .form-no-1-calculation-table").length) {
                                ...
                                $("#form-no-1-calculation-quote-items-wrapper-" + form_no_1_calculation_code).show();
                            } else {
                            ...
                            if (per_meter_option_array) {
                                ...
                                per_meter_element = '<span class="form-no-1-calculation-per-meters-wrapper">\n\
                                                    <select class="form-no-1-calculation-per-meters">\n\
                                                        <option value="">Per Meters</option>\n\
                                                        ' + per_meter_options + '\
                                                    </select>\n\
                            ...
                            $('<form id="calculation-form-' + code + '" class="update-form-no-1-calculation-quote-item-form" action="./" method="POST">\n\
                                <input type="hidden" name="calc-name" class="calc-name" value="form_no_1">\n\
                                <input type="hidden" name="cid" class="cid" value="' + cid + '">\n\
                                <input type="hidden" name="form-no-1-calculation-code" class="form-no-1-calculation-code" value="' + form_no_1_calculation_code + '">\n\
                                <input type="hidden" name="form-no-1-calculation-quote-item-code" class="form-no-1-calculation-quote-item-code" value="' + code + '">\n\
                                <table class="form-no-1-calculation-table '+ qty_class + '">\n\
                                    <thead class="thead">\n\
                                ...
                                <table id="calculation-table-more-' + code + '"  class="form-no-1-calculation-table-more">\n\
                                    <tr>\n\
                                        <td class="table-more-notes" colspan="3">\n\
                    ...
                    ').find(".bulk-action-button").button();
                        ...
                        this_form[0].reset();
                        this_form.find(".form-no-1-calculation-material").val("").find('option').not(':first').remove();
                        this_form.find(".form-no-1-calculation-colour").val("").find('option').not(':first').remove();
                        this_submit_bttn.prop('disabled', false).removeClass('field-loader');

                        form_no_1_calculation_group_discount(result_parent.find(".group-discount-form"));
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            this_submit_bttn.prop('disabled', false).removeClass('field-loader');
            alert(JSON.stringify(jqXHR));
            alert("Error! @add-form-no-1-calculation-quote-item");
        }
    });
});

function update_form_no_1_calculation_quote_item(this_element, quote_items_array) {
    ...
    var this_form = this_field.parents(".update-form-no-1-calculation-quote-item-form");
    var this_chcekedbox = this_form.find(".checkbox-input");
    var checked_checkbox = this_form.parents(".form-no-1-calculation-quote-items-body").find(".checkbox-input:checked");

    $.ajax({
        url: "form-no-1-calculation/scripts/update-form-no-1-calculation-quote-item.php",
        type: 'POST',
        dataType: 'json',
                    ...
                    if (data[0] === 1) {
                        ...
                        if (this_chcekedbox.is(":checked") && checked_checkbox.length) {
                            checked_checkbox.each(function () {
                                ...
                                var note_length = this_form_x.find('.form-no-1-calculation-notes').val().length;
                                var accessory_length = this_form_x.find('.form-no-1-calculation-accessory').length;
                                var per_meter_length = this_form_x.find('.form-no-1-calculation-per-meter').length;
                                var fitting_charge_length = this_form_x.find('.form-no-1-calculation-fitting-charge').length;

                                if (note_length || accessory_length || per_meter_length || fitting_charge_length) {
                                    this_form_x.find('.form-no-1-calculation-table-more-bttn').addClass("red");
                                } else {
                                    this_form_x.find('.form-no-1-calculation-table-more-bttn').removeClass("red");
                                }
                            });

                        } else {

                            var note_length = this_form.find('.form-no-1-calculation-notes').val().length;
                            var accessory_length = this_form.find('.form-no-1-calculation-accessory').length;
                            var per_meter_length = this_form.find('.form-no-1-calculation-per-meter').length;
                            var fitting_charge_length = this_form.find('.form-no-1-calculation-fitting-charge').length;
                        ...
                        // if (this_field.attr("name") === "cost" || this_field.attr("name") === "markup" || this_field.attr("name") === "price" || this_field.hasClass('form-no-1-calculation-field')) {
                        form_no_1_calculation_group_discount(this_form);
                        // } else {
                        //     //$('#getsum').load('getsum.php?cid=' + cid).fadeIn("fast");
                        //     //$('#totalx').load('megaTotal.php?cid=' + cid).fadeIn("fast");
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            this_field.removeClass('field-loader');
            alert(JSON.stringify(jqXHR));
            alert("Error! @update-form-no-1-calculation-quote-item");
        }
    });
}

$(document).on("change", ".update-form-no-1-calculation-quote-item-form .data-field", function (event) {
    event.preventDefault();
    ...
    if (this_chcekedbox.is(":checked") && checked_checkbox.length) {
        ...
        checked_checkbox.each(function () {
            ...
            if (this_field_x.attr("name") === "cost" || this_field_x.attr("name") === "markup" || this_field_x.hasClass('form-no-1-calculation-field')) {
                if (quote_status !== '1') {
                    get_form_no_1_calculation_price(this_field_x);
                }
            }

            if (this_field_x.attr("name") === "price" || this_field_x.attr("name") === "qty" || this_field_x.hasClass('form-no-1-calculation-field')) {
                if (quote_status !== '1') {
                    update_form_no_1_calculation_total_price(this_form_x);
                }
            }
            ...
            if (this_field_x.attr("name") === "cost" || this_field_x.attr("name") === "markup" || this_field_x.hasClass('form-no-1-calculation-field')) {
                ...
                if (quote_status !== '1') {
                    ...
                    if (checked_checkbox.length === no) {
                        update_form_no_1_calculation_quote_item(this_field, quote_items_array);
                    }
                    //});
                } else {
                    no = no + 1;
        ...
        if (this_field.attr("name") === "cost" || this_field.attr("name") === "markup" || this_field.hasClass('form-no-1-calculation-field')) {
            if (quote_status !== '1') {
                get_form_no_1_calculation_price(this_field);
            }
        }

        if (this_field.attr("name") === "price" || this_field.attr("name") === "qty" || this_field.hasClass('form-no-1-calculation-field')) {
            if (quote_status !== '1') {
                update_form_no_1_calculation_total_price(this_form);
            }
        }
...
$(document).on("keypress", ".add-form-no-1-calculation-accessory-qty", function (event) {
    if (event.keyCode === 13) {
        event.preventDefault();
        var this_element = $(this);
        var add_bttn = this_element.siblings('.add-form-no-1-calculation-accessories');
        add_bttn.click();
    }
});

$(document).on("click", ".add-form-no-1-calculation-accessories", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents('.update-form-no-1-calculation-quote-item-form');
    var accessory_element = this_bttn.siblings('.form-no-1-calculation-accessories');
    var accessory_qty_element = this_bttn.siblings('.add-form-no-1-calculation-accessory-qty');

    var form_no_1_calculation_code = this_form.find('.form-no-1-calculation-code').val();
    var form_no_1_calculation_quote_item_code = this_form.find('.form-no-1-calculation-quote-item-code').val();
    ...
    if (accessory) {
        ...
        $.ajax({
            url: "form-no-1-calculation/scripts/add-form-no-1-calculation-quote-item-accessory.php",
            type: 'POST',
            dataType: 'json',
            data: { cid: cid, form_no_1_calculation_code: form_no_1_calculation_code, form_no_1_calculation_quote_item_code: form_no_1_calculation_quote_item_code, accessory: accessory, accessory_qty: accessory_qty },
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                accessory_qty_element.removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @add-form-no-1-calculation-quote-item-accessory");
            }
        });
    }
});

$(document).on("click", ".delete-form-no-1-calculation-accessory", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents('.update-form-no-1-calculation-quote-item-form');
    var accessory_element = this_form.find('.form-no-1-calculation-accessories');
    var this_wrapper = this_bttn.parent('.form-no-1-calculation-accessories-wrapper');
    ...
    $.ajax({
        url: "form-no-1-calculation/scripts/delete-form-no-1-calculation-quote-item-accessory.php",
        type: 'POST',
        dataType: 'json',
        data: { cid: cid, form_no_1_calculation_code: form_no_1_calculation_code, form_no_1_calculation_quote_item_code: form_no_1_calculation_quote_item_code, accessory_code: accessory_code },
        beforeSend: function () {
            this_bttn.prop('disabled', false).addClass('field-loader');
        },
        success: function (data) {
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            this_bttn.prop('disabled', false).removeClass('field-loader');
            alert(JSON.stringify(jqXHR));
            alert("Error! @delete-form-no-1-calculation-quote-item-accessory");
        }
    });
});

$(document).on("keypress", ".add-form-no-1-calculation-per-meter-width", function (event) {
    if (event.keyCode === 13) {
        event.preventDefault();
        var this_element = $(this);
        var add_bttn = this_element.siblings('.add-form-no-1-calculation-per-meters');
        add_bttn.click();
    }
});

$(document).on("click", ".add-form-no-1-calculation-per-meters", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents('.update-form-no-1-calculation-quote-item-form');
    var per_meter_element = this_bttn.siblings('.form-no-1-calculation-per-meters');
    var per_meter_width_element = this_bttn.siblings('.add-form-no-1-calculation-per-meter-width');
    ...
    if (per_meter) {
        ...
        $.ajax({
            url: "form-no-1-calculation/scripts/add-form-no-1-calculation-quote-item-per-meter.php",
            type: 'POST',
            dataType: 'json',
            data: { cid: cid, form_no_1_calculation_code: form_no_1_calculation_code, form_no_1_calculation_quote_item_code: form_no_1_calculation_quote_item_code, per_meter: per_meter, per_meter_width: per_meter_width },
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                per_meter_width_element.removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @add-form-no-1-calculation-quote-item-per-meter");
            }
        });
    }
});

$(document).on("click", ".delete-form-no-1-calculation-per-meter", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents('.update-form-no-1-calculation-quote-item-form');
    var per_meter_element = this_form.find('.form-no-1-calculation-per-meters');
    var this_wrapper = this_bttn.parent('.form-no-1-calculation-per-meters-wrapper');
    ...
    $.ajax({
        url: "form-no-1-calculation/scripts/delete-form-no-1-calculation-quote-item-per-meter.php",
        type: 'POST',
        dataType: 'json',
        data: { cid: cid, form_no_1_calculation_code: form_no_1_calculation_code, form_no_1_calculation_quote_item_code: form_no_1_calculation_quote_item_code, per_meter_code: per_meter_code },
        beforeSend: function () {
            this_bttn.prop('disabled', false).addClass('field-loader');
        },
        success: function (data) {
...
$(document).on("click", ".add-form-no-1-calculation-fitting-charges", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents('.update-form-no-1-calculation-quote-item-form');
    var fitting_charge_element = this_bttn.siblings('.form-no-1-calculation-fitting-charges');
    ...
    if (fitting_charge) {
        ...
        $.ajax({
            url: "form-no-1-calculation/scripts/add-form-no-1-calculation-quote-item-fitting-charge.php",
            type: 'POST',
            dataType: 'json',
            data: { cid: cid, form_no_1_calculation_code: form_no_1_calculation_code, form_no_1_calculation_quote_item_code: form_no_1_calculation_quote_item_code, fitting_charge: fitting_charge },
            beforeSend: function () {
                this_bttn.prop('disabled', false).addClass('field-loader');
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                fitting_charge_element.toggleClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @add-form-no-1-calculation-quote-item-fitting-charge");
            }
        });
    }
});

$(document).on("click", ".delete-form-no-1-calculation-fitting-charge", function () {

    var this_bttn = $(this);
    var this_form = this_bttn.parents('.update-form-no-1-calculation-quote-item-form');
    var fitting_charge_element = this_form.find('.form-no-1-calculation-fitting-charges');
    var this_wrapper = this_bttn.parent('.form-no-1-calculation-fitting-charges-wrapper');
    ...
    $.ajax({
        url: "form-no-1-calculation/scripts/delete-form-no-1-calculation-quote-item-fitting-charge.php",
        type: 'POST',
        dataType: 'json',
        data: { cid: cid, form_no_1_calculation_code: form_no_1_calculation_code, form_no_1_calculation_quote_item_code: form_no_1_calculation_quote_item_code, fitting_charge_code: fitting_charge_code },
        beforeSend: function () {
            this_bttn.prop('disabled', false).addClass('field-loader');
        },
        success: function (data) {
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            this_bttn.prop('disabled', false).removeClass('field-loader');
            alert(JSON.stringify(jqXHR));
            alert("Error! @delete-form-no-1-calculation-quote-item-fitting-charge");
        }
    });
});

$(document).on("submit", "#form-no-1-calculation-quote-items-results .group-discount-form", function (event) {
    event.preventDefault();
    ...
    $.ajax({
        url: "form-no-1-calculation/scripts/update-form-no-1-calculation-group-discount.php",
        type: 'POST',
        dataType: 'json',
        data: { cid: cid, discount: discount, form_no_1_calculation_code: form_no_1_calculation_code },
        beforeSend: function () {
            this_bttn.prop('disabled', false).addClass('field-loader');
        },
        success: function (data) {
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            this_bttn.prop('disabled', false).removeClass('field-loader');
            alert(JSON.stringify(jqXHR));
            alert("Error! @update-form-no-1-calculation-group-discount");
        }
    });
