...
while ($stmt_1->fetch()) {
    ...
    $field_th_left = '';
    $cost_th = $cost_select === 1 && $cost_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Cost</td>' : '';
    $markup_th = $markup_select === 1 && $markup_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Markup</td>' : '';
    $price_th = $price_print[0] === '1' ? '<th style="text-align: right; border: 0.5px solid #787877;">Price</th>' : '';
    $qty_th = $qty_select === 1 && $total_print[0] === '1' ? '<th style="text-align: right; border: 0.5px solid #787877;">Qty</th>' : '';
    $total_th = $qty_select === 1 && $total_print[0] === '1' ? '<th style="text-align: right; border: 0.5px solid #787877;">Total</th>' : '';
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $location_td = $locations_select === 1 && $location_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $form_no_1_calculation_quote_item_location)[0] . '</td>' : '';
            $cost_td = $cost_select === 1 && $cost_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $form_no_1_calculation_quote_item_cost . '</td>' : '';
            $markup_td = $markup_select === 1 && $markup_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $form_no_1_calculation_quote_item_markup . '</td>' : '';
            $price_td = $price_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #787877;">' . number_format($form_no_1_calculation_quote_item_price, 2) . '</td>' : '';
            $qty_td = $qty_select === 1 && $qty_print[0] === '1' ? '<td style="text-align: center; border: 0.5px solid #787877;">' . $form_no_1_calculation_quote_item_qty . '</td>' : '';
            $total_td = $qty_select === 1 && $total_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #787877;">' . number_format($form_no_1_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($form_no_1_calculation_quote_item_notes || $form_no_1_calculation_quote_item_accessories || $form_no_1_calculation_quote_item_per_meters || $form_no_1_calculation_quote_item_fitting_charges) {
                ...
                if ($form_no_1_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[0] === '1') {
                ...
                if ($form_no_1_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[0] === '1') {
                ...
                if ($form_no_1_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[0] === '1') {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[0] === '1' && $form_no_1_calculation_quote_item_accessories ||
                    $per_meters_select === 1 && $per_meter_print[0] === '1' && $form_no_1_calculation_quote_item_per_meters ||
                    $fitting_charges_select === 1 && $fitting_charge_print[0] === '1' && $form_no_1_calculation_quote_item_fitting_charges
                ) {
