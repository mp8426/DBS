...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM form_no_1_calculation_fields WHERE customer_copy = 1 AND form_no_1_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            //     . "WHERE "
            //     . "form_no_1_calculation_fields.customer_copy = 1 AND "
            ...
            if ($form_no_1_calculation_quote_item_notes && $note_print[1] === '1') {
