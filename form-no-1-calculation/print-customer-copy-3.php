    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            if ($form_no_1_calculation_quote_item_notes || $form_no_1_calculation_quote_item_accessories || $form_no_1_calculation_quote_item_per_meters || $form_no_1_calculation_quote_item_fitting_charges) {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[1] === '1' && $form_no_1_calculation_quote_item_accessories ||
                    $per_meters_select === 1 && $per_meter_print[1] === '1' && $form_no_1_calculation_quote_item_per_meters ||
                    $fitting_charges_select === 1 && $fitting_charge_print[1] === '1' && $form_no_1_calculation_quote_item_fitting_charges
                ) {
