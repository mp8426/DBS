...
while ($stmt_1->fetch()) {
    ...
    $curtain_type_1_th = $curtain_type_1_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">Non Continuous</td>' : '';
    $cont_meter_th = $cont_meter_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">Cont. Meter</td>' : '';
    $curtain_type_2_th = $curtain_type_2_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">Continuous </td>' : '';
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $left_return_td = $left_return_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_curtain_calculation_quote_item_left_return . '</td>' : '';
            ...
            $qty_td = $qty_select === 1 && $qty_print[0] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_curtain_calculation_quote_item_qty . '</td>' : '';
            $total_td = $qty_select === 1 && $price_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_curtain_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($window_curtain_calculation_quote_item_notes || $window_curtain_calculation_quote_item_accessories || $window_curtain_calculation_quote_item_per_meters || $window_curtain_calculation_quote_item_fitting_charges) {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[0] === '1' && $accessory_print[0] === '1' && $window_curtain_calculation_quote_item_accessories ||
