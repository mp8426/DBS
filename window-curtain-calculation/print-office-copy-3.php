...
while ($stmt_1->fetch()) {
    ...
    $width_th = $width_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Width</td>' : '';
    $right_return_th = $right_return_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Right Return</td>' : '';
    $left_return_th = $left_return_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Left Return</td>' : '';
    $overlap_th = $overlap_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Overlap</td>' : '';
    $fullness_th = $fullness_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Fullness</td>' : '';
    $supplier_th = $supplier_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Supplier</td>' : '';
    $fabric_th = $fabric_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Fabric</td>' : '';
    $fabric_colour_th = $fabric_colour_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Colour</td>' : '';
    $qty_drop_th = $qty_drop_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Qty Drop</td>' : '';
    $curtain_type_1_th = $curtain_type_1_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Curtain Type 1</td>' : '';
    $cont_meter_th = $cont_meter_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Cont. Meter</td>' : '';
    $curtain_type_2_th = $curtain_type_2_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Curtain Type 2</td>' : '';
    $drop_x_th = $drop_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Drop</td>' : '';
    $hem_heading_th = $hem_heading_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Hem Heading</td>' : '';
    $pattern_repeate_th = $pattern_repeate_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Pattern Repeate</td>' : '';
    $fabric_cut_length_th = $fabric_cut_length_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Fabric Cut Length</td>' : '';
    $fabric_qty_th = $fabric_qty_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">Fabric Qty</td>' : '';
    $field_th_right = '';
    $field_th_left = '';
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_curtain_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_field_name . $window_curtain_calculation_quote_item_field_price_x . '</td>';
                }
                if ($window_curtain_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_field_name . $window_curtain_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $location_td = $locations_select === 1 && $location_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_curtain_calculation_quote_item_location)[0] . '</td>' : '';
            $width_td = $width_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_width . '</td>' : '';
            $right_return_td = $right_return_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_right_return . '</td>' : '';
            $left_return_td = $right_return_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_left_return . '</td>' : '';
            $overlap_td = $overlap_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_overlap . '</td>' : '';
            $fullness_td = $fullness_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_fullness . '</td>' : '';
            $supplier_td = $supplier_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_curtain_calculation_quote_item_supplier)[0] . '</td>' : '';
            $fabric_td = $fabric_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_curtain_calculation_quote_item_fabric)[0] . '</td>' : '';
            $fabric_colour_td = $fabric_colour_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_curtain_calculation_quote_item_fabric_colour)[0] . '</td>' : '';
            $qty_drop_td = $qty_drop_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_qty_drop . '</td>' : '';
            $curtain_type_1_td = $curtain_type_1_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_curtain_calculation_quote_item_curtain_type_1)[0] . '</td>' : '';
            $cont_meter_td = $cont_meter_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_continuous_meter . '</td>' : '';
            $curtain_type_2_td = $curtain_type_2_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_curtain_calculation_quote_item_curtain_type_2)[0] . '</td>' : '';
            $drop_x_td = $drop_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_drop . '</td>' : '';
            $hem_heading_td = $hem_heading_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_hem_heading . '</td>' : '';
            $pattern_repeate_td = $pattern_repeate_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_pattern_repeate . '</td>' : '';
            $fabric_cut_length_td = $fabric_cut_length_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_fabric_cut_length . '</td>' : '';
            $fabric_qty_td = $fabric_qty_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_curtain_calculation_quote_item_fabric_qty . '</td>' : '';
            $price_td = $price_print[0] === '1' ? '<td style="text-align: right; border: 0.5px solid #787877;">' . number_format($window_curtain_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($window_curtain_calculation_quote_item_notes || $window_curtain_calculation_quote_item_accessories || $window_curtain_calculation_quote_item_per_meters || $window_curtain_calculation_quote_item_fitting_charges) {
                ...
                if ($window_curtain_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[0] === '1') {
                ...
                if ($window_curtain_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[0] === '1') {
                ...
                if ($window_curtain_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[0] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[0] === '1' && $accessory_print[0] === '1' && $window_curtain_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[0] === '1' && $window_curtain_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[0] === '1' && $window_curtain_calculation_quote_item_fitting_charges
                ) {
