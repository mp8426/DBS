    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_shutter_5_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $window_shutter_5_calculation_quote_item_field_name . $window_shutter_5_calculation_quote_item_field_price_x . '</td>';
                }
                if ($window_shutter_5_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $window_shutter_5_calculation_quote_item_field_name . $window_shutter_5_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            if ($window_shutter_5_calculation_quote_item_notes || $window_shutter_5_calculation_quote_item_accessories || $window_shutter_5_calculation_quote_item_per_meters || $window_shutter_5_calculation_quote_item_fitting_charges) {
                ...
                if ($accessories_select === 1 && $accessory_print[0] === '1' && $window_shutter_5_calculation_quote_item_accessories ||
