...
$query_1 = "SELECT name, locations, accessories, per_meters, fitting_charges FROM window_shutter_5_calculations WHERE code = ? ORDER BY position ASC";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('s', $window_shutter_5_calculation_code);
$stmt_1->execute();
$stmt_1->bind_result($window_shutter_5_calculation_name, $locations_select, $accessories_select, $per_meters_select, $fitting_charges_select);
$stmt_1->store_result();
...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM window_shutter_5_calculation_fields WHERE order_sheet = 1 AND window_shutter_5_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT window_shutter_5_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "window_shutter_5_calculation_fields.order_sheet = 1 AND "
            ...
            while ($stmt_3_1->fetch()) {
                if ($window_shutter_5_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $window_shutter_5_calculation_quote_item_field_name . '</td>';
                }
                if ($window_shutter_5_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $window_shutter_5_calculation_quote_item_field_name . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $location_td = $locations_select === 1 && $location_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_shutter_5_calculation_quote_item_location)[0] . '</td>' : '';
            $width_x_td = $width_x_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_shutter_5_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_shutter_5_calculation_quote_item_drop . '</td>' : '';
            $type_td = $type_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_shutter_5_calculation_quote_item_type)[0] . '</td>' : '';
            $price_td = $price_print[2] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_shutter_5_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($window_shutter_5_calculation_quote_item_notes || $window_shutter_5_calculation_quote_item_accessories || $window_shutter_5_calculation_quote_item_per_meters || $window_shutter_5_calculation_quote_item_fitting_charges) {
                ...
                if ($window_shutter_5_calculation_quote_item_notes && $note_print[2] === '1') {
                ...
                if ($window_shutter_5_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[2] === '1') {
                ...
                if ($window_shutter_5_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[2] === '1') {
                ...
                if ($window_shutter_5_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[2] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[2] === '1' && $window_shutter_5_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[2] === '1' && $window_shutter_5_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[2] === '1' && $window_shutter_5_calculation_quote_item_fitting_charges
                ) {
            ...
            if ($group_discount_print[2] === '1') {
                ...
                $window_shutter_5_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_shutter_5_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($window_shutter_5_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_shutter_5_calculation_total_table_colspan . '">Discount (' . $window_shutter_5_calculation_quote_item_discount . '%) </th>'
