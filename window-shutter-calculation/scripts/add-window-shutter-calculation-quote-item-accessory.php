...
$query_1 = "INSERT INTO window_shutter_calculation_quote_item_accessories ( code, name, price, qty, window_shutter_calculation_quote_item_code, window_shutter_calculation_code, cid ) VALUES( ?, ?, ?, ?, ?, ?, ? )";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('sssssss', $accessory_code, $accessory_name, $accessory_price, $accessory_qty, $window_shutter_calculation_quote_item_code, $window_shutter_calculation_code, $cid);
