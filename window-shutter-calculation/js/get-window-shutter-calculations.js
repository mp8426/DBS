$(function() {
            ...
            if (data[0] === 1) {
                ...
                $.each(data[1], function(index, value) {
                    ...
                    if (value.status === 1) {
                        ...
                        $('<li><a href="#tab-' + value.code + '" class="active-calcs" data-calc-code="window_shutter_calculation"  data-calc-name="' + value.name + '">' + value.name + '</a></li>').prependTo("#window-shutter-calculation-tabs .tabs ul");
                        $('<div id="tab-' + value.code + '" class="window-shutter-calculation-tab-div"></div>')
                            ...
                            .append('<input type="hidden" name="calc-name" class="calc-name" value="window_shutter">')
                                ...
                                .append($('<table class="window-shutter-calculation-table"></table>')
                                    ...
                                    .append($('<tbody></tbody>')
                                        .append($('<tr class="tbody-tr"></tr>')
                                            ...
                                            .append('<td><input type="number" name="width" data-column="width_x" class="window-shutter-calculation-width number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="mm"></td>')
                                            .append('<td><input type="number" name="drop" data-column="drop_x" class="window-shutter-calculation-drop number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="mm"></td>')
                                            .append(type_element)
                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="window-shutter-calculation-quote-items-wrapper-' + window_shutter_calculation_code + '" class="window-shutter-calculation-quote-items-wrapper"></div>')
                            ...
                            .append('<div id="quote-items-body-' + window_shutter_calculation_code + '" class="window-shutter-calculation-quote-items-body added-calcs" data-calc-code="window_shutter_calculation" data-calc-name="' + value.name + '"></div>')
                            .append('<div class="bulk-action-button-wrapper">\n\
                                            ...
                                            <button class="fa-btn quote-item-sort-bttn tltip bulk-action-button" style="padding-left:5px; padding-right:5px;" data-calc-code="'+ window_shutter_calculation_code + '" data-title="Move Blind">Move<i class="fa fa-sort" aria-hidden="true"></i></button>\n\
                                            <button class="fa-btn window-shutter-calculation-bulk-copy-quote-bttn copy-quote-bttn tltip bulk-action-button" style="padding-left:5px; padding-right:5px;" data-title="Copy Quote">Copy Quote</button>\n\
                                            <a href="print/order-sheet-window-shutter-calculation-' + window_shutter_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 130px;">Print Order Sheet</a>\n\
                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-window-shutter-calculation-' + window_shutter_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 160px;">Print Order Sheet Xlsx</a>\n\
                                            ...
                                            <input type="tel" class="production-date-21 quote_details" id="production-date-21" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + window_shutter_calculation_code + '" placeholder="Date" autocomplete="off" value="' + value.production_date + '"style="width:100px; height:35px !important; margin-left:2px; margin-right:2px; border-radius: 6px;border: 1px solid #cdd5da; text-align: center; ' +  approved_date + '">\n\
                                            <input type="tel" class="install-date-21 quote_details" id="install-date-21" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + window_shutter_calculation_code + '" placeholder="Date" autocomplete="off" value="' + value.install_date + '"style="width:100px; height:35px !important; margin-left:2px; margin-right:2px; border-radius: 6px; border: 1px solid #cdd5da; text-align: center; ' +  approved_date + '">\n\
                                            </form>\n\
                                        ...
                                        </div>').prependTo("#window-shutter-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button().end()
                                        .find(".production-date-21").datepicker({ dateFormat: "dd/mm/yy" }).end()
                                        .find(".install-date-21").datepicker({ dateFormat: "dd/mm/yy" });
                        ...
                        $.each(value.quote_items, function(quote_item_index, quote_item_value) {
                            ...
                            <input type="hidden" name="calc-name" class="calc-name" value="window_shutter">\n\
                                    ...
                                    <table class="window-shutter-calculation-table row_item_table">\n\
                                        ...
                                        <tbody>\n\
                                            <tr>\n\
                                                ...
                                                ' + field_element_left + '\
                                                ' + location_element + '\
                                                <td><input type="number" name="width" data-column="width_x" class="window-shutter-calculation-width number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.width + '" placeholder="mm"></td>\n\
                                                <td><input type="number" name="drop" data-column="drop_x" class="window-shutter-calculation-drop number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.drop + '" placeholder="mm"></td>\n\
                                                ' + type_element + '\
                                                ' + field_element_right + '\
                                                <td>\n\
                                                    <table class="right-fixed-column" style="margin-top: -20px;">\n\
    ...
    $(document).on("click", ".window-shutter-calculation-bulk-copy-bttn", function() {
        ...
        var window_shutter_calculation_code = this_bttn.siblings('.group-discount-form').find('.window-shutter-calculation-code').val();
    
        var max_row_no = -Infinity;
        $(document).find("#quote-items-body-" + window_shutter_calculation_code).find(".quote-item-row-no").each(function () {
    ...
    $(document).on("submit", ".add-window-shutter-calculation-quote-item-form", function(event) {
        ...
        if (user_type === 4) {
            ...
            var row_length = result_parent.find(".update-window-shutter-calculation-quote-item-form").length;
            if (!row_length) {
            ...
            success: function(data) {
                ...
                if (data[0] === 1) {
                    ...
                    result_parent.find('.bulk-action-button-wrapper').html('<input type="button" class="bulk-action-button window-shutter-calculation-select-all-bttn" value="✔">\n\
                                                                            ...
                                                                            <form style="display: contents; margin-right: -6px; font-size: 14px;">\n\
                                                                            <input type="hidden" class="window-shutter-calculation-code" value="' + window_shutter_calculation_code + '">\n\
                                                                            <input type="tel" class="production-date-21 quote_details" id="production-date-21" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + window_shutter_calculation_code + '" placeholder="Production Date" autocomplete="off" value=""style="width:100px; height:35px !important; margin-left:2px; margin-right:2px; border-radius: 6px;border: 1px solid #cdd5da; text-align: center; ' +  approved_date + '">\n\
                                                                            <input type="tel" class="install-date-21 quote_details" id="install-date-21" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + window_shutter_calculation_code + '" placeholder="Install Date" autocomplete="off" value=""style="width:100px; height:35px !important; margin-left:2px; margin-right:2px; border-radius: 6px; border: 1px solid #cdd5da; text-align: center; ' +  approved_date + '">\n\
                                                                            </form>\n\
                                                                            <form class="group-discount-form" style="float: right; margin-right: -6px; font-size: 12px;">\n\
    ...
    $(document).on("change", "#window-shutter-calculation-quote-items-results .production-date-21", function(event) {
        event.preventDefault();
        ...
        var window_shutter_calculation_code = this_form.find(".window-shutter-calculation-code").val();
        var window_shutter_calculation_name = this_form.find(".window-shutter-calculation-name").val();
        ...
        $.ajax({
            ...
            beforeSend: function() {
                //	alert(window_shutter_calculation_code);
                //	alert(name);
                //	alert(state_select);
            ...
            success: function(data) {
                //	alert(window_shutter_calculation_name);
                //alert(data);
                // if (data[0] === 1) {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                // this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @update-window-shutter-calculation-Product-date");
            }
        });

    });
    
    $(document).on("change", "#window-shutter-calculation-quote-items-results .install-date-21", function(event) {
        event.preventDefault();
