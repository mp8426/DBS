                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="window-shutter-calculation-quote-items-wrapper-' + window_shutter_calculation_code + '" class="window-shutter-calculation-quote-items-wrapper"></div>')
                            ...
                            .append('<div class="bulk-action-button-wrapper">\n\
                                            ...
                                            <a href="print/order-sheet-window-shutter-calculation-' + window_shutter_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 110px;">Print Order Sheet</a>\n\
                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-window-shutter-calculation-' + window_shutter_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 145px;">Print Order Sheet Xlsx</a>\n\
                                        ...
                                        </div>').prependTo("#window-shutter-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button();
