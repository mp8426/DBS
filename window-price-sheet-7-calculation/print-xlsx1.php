...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM window_price_sheet_7_calculation_fields WHERE " . $print_type . " = 1 AND window_price_sheet_7_calculation_code = ? ORDER BY position ASC";
    ...
    while ($stmt_2->fetch()) {
        if ($window_price_sheet_7_calculation_field_side === 0) { // Right Side
            $field_th_right .= '<th style="border: 1px solid #000000;">' . $window_price_sheet_7_calculation_field_name . '</th>';
        }
        if ($window_price_sheet_7_calculation_field_side === 1) { // Left Side
            $field_th_left .= '<th style="border: 1px solid #000000;">' . $window_price_sheet_7_calculation_field_name . '</th>';
        }
    }
    $stmt_2->close();
    ...
    $window_price_sheet_7_calculation_table_header = '<table><thead>'
            . '<tr><th colspan="' . $tot_th_colspan_x . '"><strong>' . $window_price_sheet_7_calculation_name . '</strong></th></tr>'
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT window_price_sheet_7_calculation_quote_item_fields.name, "
                    . "window_price_sheet_7_calculation_quote_item_fields.price, "
                    ...
                    . "WHERE "
                    . "window_price_sheet_7_calculation_fields." . $print_type . " = 1 AND "
            ...
            $stmt_3_1->execute();
            $stmt_3_1->bind_result($window_price_sheet_7_calculation_quote_item_field_name, $window_price_sheet_7_calculation_quote_item_field_price, $window_price_sheet_7_calculation_field_side);
            $stmt_3_1->store_result();
            $field_td_num_rows = $stmt_3_1->num_rows;

            while ($stmt_3_1->fetch()) {

                if ($window_price_sheet_7_calculation_quote_item_field_price > 0) {
                    $window_price_sheet_7_calculation_quote_item_field_price_x = ' | ' . number_format($window_price_sheet_7_calculation_quote_item_field_price, 2);
                } else {
                    $window_price_sheet_7_calculation_quote_item_field_price_x = '';
                }

                if ($window_price_sheet_7_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 1px solid #000000;">' . $window_price_sheet_7_calculation_quote_item_field_name . $window_price_sheet_7_calculation_quote_item_field_price_x . '</td>';
                }
                if ($window_price_sheet_7_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 1px solid #000000;">' . $window_price_sheet_7_calculation_quote_item_field_name . $window_price_sheet_7_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $window_price_sheet_7_calculation_quote_item_accessories .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Accessory - ' . $window_price_sheet_7_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $window_price_sheet_7_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $window_price_sheet_7_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($window_price_sheet_7_calculation_quote_item_accessory_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $window_price_sheet_7_calculation_quote_item_per_meters .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Per Meter - ' . $window_price_sheet_7_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $window_price_sheet_7_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $window_price_sheet_7_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($window_price_sheet_7_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $window_price_sheet_7_calculation_quote_item_fitting_charges .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Fitting Charge - ' . $window_price_sheet_7_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $window_price_sheet_7_calculation_quote_item_fitting_charge_price . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            $location_td = $locations_select === 1 && $location_print[$no] === '1' ? '<td style="border: 1px solid #000000;">' . explode('<->', $window_price_sheet_7_calculation_quote_item_location)[0] . '</td>' : '';
            $width_x_td = $width_x_print[$no] === '1' ? '<td style="border: 1px solid #000000; text-align: left;">' . $window_price_sheet_7_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[$no] === '1' ? '<td style="border: 1px solid #000000; text-align: left;">' . $window_price_sheet_7_calculation_quote_item_drop . '</td>' : '';
            $type_td = $type_print[$no] === '1' ? '<td style="border: 1px solid #000000;">' . explode('<->', $window_price_sheet_7_calculation_quote_item_type)[0] . '</td>' : '';
            $material_td = $materials_and_colours_select === 1 && $material_print[$no] === '1' ? '<td style="border: 1px solid #000000;">' . explode('<->', $window_price_sheet_7_calculation_quote_item_material)[0] . '</td>' : '';
            $colour_td = $materials_and_colours_select === 1 && $colour_print[$no] === '1' ? '<td style="border: 1px solid #000000;">' . explode('<->', $window_price_sheet_7_calculation_quote_item_colour)[0] . '</td>' : '';
            $price_td = $price_print[$no] === '1' ? '<td style="text-align: right; border: 1px solid #000000;">' . number_format($window_price_sheet_7_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($window_price_sheet_7_calculation_quote_item_notes || $window_price_sheet_7_calculation_quote_item_accessories || $window_price_sheet_7_calculation_quote_item_per_meters || $window_price_sheet_7_calculation_quote_item_fitting_charges) {
                ...
                if ($window_price_sheet_7_calculation_quote_item_notes && $note_print[$no] === '1') {

                    $window_price_sheet_7_calculation_quote_item_notes_table = '<tr>'
                ...
                if ($window_price_sheet_7_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[$no] === '1') {

                    $window_price_sheet_7_calculation_quote_item_accessories_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                ...
                if ($window_price_sheet_7_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[$no] === '1') {

                    $window_price_sheet_7_calculation_quote_item_per_meters_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($window_price_sheet_7_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1') {

                    $window_price_sheet_7_calculation_quote_item_fitting_charges_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($accessories_select === 1 && $accessory_print[$no] === '1' && $window_price_sheet_7_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[$no] === '1' && $window_price_sheet_7_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1' && $window_price_sheet_7_calculation_quote_item_fitting_charges
                ) {

                    $table_more .= $window_price_sheet_7_calculation_quote_item_accessories_table
                            . $window_price_sheet_7_calculation_quote_item_per_meters_table
                            . $window_price_sheet_7_calculation_quote_item_fitting_charges_table;
                } else {
                    $table_more .= "";
            ...
            $window_price_sheet_7_calculation_quote_items .= '<tr>'
            ...
            if ($group_discount_print[$no] === '1') {
                ...
                $window_price_sheet_7_calculation_total = '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($window_price_sheet_7_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Discount (' . $window_price_sheet_7_calculation_quote_item_discount . ' % ) </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">-' . number_format($window_price_sheet_7_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($window_price_sheet_7_calculation_quote_item_price_total, 2) . '</th>'
                        . '</tr>';
            } else {
        ...
        $window_price_sheet_7_calculation_quote_tables .= $window_price_sheet_7_calculation_table_header . $window_price_sheet_7_calculation_quote_items . $window_price_sheet_7_calculation_total . "</tbody></table>";
    } else {
        $window_price_sheet_7_calculation_quote_tables .= "";
    }
    $stmt_3->close();
