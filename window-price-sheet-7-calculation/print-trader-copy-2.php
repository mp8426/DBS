...
//                }
        ...
        $window_price_sheet_7_calculation_quote_tables .= $window_price_sheet_7_calculation_table_header . $quote_items . $table_more . $window_price_sheet_7_calculation_total . "<div></div>";
    } else {
        $window_price_sheet_7_calculation_quote_tables .= "";
    }
    $stmt_3->close();
