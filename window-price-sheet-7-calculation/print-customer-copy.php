...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $width_x_td = $width_x_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_7_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_7_calculation_quote_item_drop . '</td>' : '';
            ...
            if ($group_discount_print[1] === '1') {
                ...
                $window_price_sheet_7_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        ...
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Total (Blinds) </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($window_price_sheet_7_calculation_quote_item_price_sub_total_x, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Accessories </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($window_price_sheet_7_calculation_quote_item_accessory_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Extras </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($window_price_sheet_7_calculation_quote_item_per_meter_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
