...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $price_sub_total += $window_price_sheet_7_calculation_quote_item_price;
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_price_sheet_7_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_7_calculation_quote_item_field_name . $window_price_sheet_7_calculation_quote_item_field_price_x . '</td>';
                }
                if ($window_price_sheet_7_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $window_price_sheet_7_calculation_quote_item_field_name . $window_price_sheet_7_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $quote_item_accessories_price_td = $price_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($window_price_sheet_7_calculation_quote_item_accessory_total, 2) . '</td>' : '';

                $quote_item_accessories .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $window_price_sheet_7_calculation_quote_item_accessory_name . ' ($' . $window_price_sheet_7_calculation_quote_item_accessory_price . ' x ' . $window_price_sheet_7_calculation_quote_item_accessory_qty . ')</td>'
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $quote_item_per_meters_price_td = $price_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($window_price_sheet_7_calculation_quote_item_per_meter_total, 2) . '</td>' : '';

                $quote_item_per_meters .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $window_price_sheet_7_calculation_quote_item_per_meter_name . ' ($' . $window_price_sheet_7_calculation_quote_item_per_meter_price . ' x ' . $window_price_sheet_7_calculation_quote_item_per_meter_width . ')</td>'
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $quote_item_fitting_charges_price_td = $price_td_num_rows ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($window_price_sheet_7_calculation_quote_item_fitting_charge_price, 2) . '</td>' : '';

                $quote_item_fitting_charges .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $quote_item_no . '</td>'
                        . '<td style="border: 0.5px solid #000000;" colspan="' . $table_colspan . '">' . $window_price_sheet_7_calculation_quote_item_fitting_charge_name . '</td>'
            ...
            if ($group_discount_print[0] === '1') {
                ...
                $window_price_sheet_7_calculation_quote_item_discount_value = $price_sub_total * $window_price_sheet_7_calculation_quote_item_discount / 100;
                $window_price_sheet_7_calculation_quote_item_price_total = $price_sub_total - $window_price_sheet_7_calculation_quote_item_discount_value;
                ...
                $window_price_sheet_7_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        ...
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $total_table_colspan . '">Discount (' . $window_price_sheet_7_calculation_quote_item_discount . '%) </th>'
        ...
        $window_price_sheet_7_calculation_quote_tables .='<span>' . $window_price_sheet_7_calculation_table_header . $quote_items . $table_more . $window_price_sheet_7_calculation_total . "</span><div></div>";
    } else {
        $window_price_sheet_7_calculation_quote_tables .= "";
    }
    $stmt_3->close();
