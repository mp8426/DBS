        ...
        while ($stmt_3->fetch()) {
            ...
            if ($group_discount_print[0] === '1') {
                ...
                $window_price_sheet_7_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Sub Total (Blinds)</th>'
                        ...
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold; color:red;" colspan="' . $window_price_sheet_7_calculation_total_table_colspan . '">Discount (' . $window_price_sheet_7_calculation_quote_item_discount . '%) </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold; color:red;">-' . number_format($window_price_sheet_7_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
