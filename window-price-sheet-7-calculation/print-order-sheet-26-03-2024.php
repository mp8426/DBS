...
while ($stmt_1->fetch()) {
    ...
    $query_3 = "SELECT code, location, width_x, drop_x, type, material, colour,fullness, notes FROM window_price_sheet_7_calculation_quote_items WHERE window_price_sheet_7_calculation_code = ? AND cid = ? ORDER BY id ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        $window_price_sheet_7_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.9em; text-align: center;" border="1">'
                . '<tr>'
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $window_price_sheet_7_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="text-align: left; border-right: 0.5px solid #000000;">' . $quote_item_accessory_no . '. ' . $window_price_sheet_7_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="text-align: center;">' . $window_price_sheet_7_calculation_quote_item_accessory_qty . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $window_price_sheet_7_calculation_quote_item_per_meters .= '<tr>'
                        . '<td style=" text-align: left; border-right: 0.5px solid #000000;">' . $quote_item_per_meter_no . '. ' . $window_price_sheet_7_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="text-align: center;">' . $window_price_sheet_7_calculation_quote_item_per_meter_width . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_price_sheet_7_calculation_field_name === 'Location') {
                ...
                if ($window_price_sheet_7_calculation_field_name === 'Main Slat Colour') {
                    $window_price_sheet_7_calculation_quote_item_Main_Slat_Colour = $window_price_sheet_7_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_7_calculation_field_name === 'Stripe Required?') {
                    $window_price_sheet_7_calculation_quote_item_Stripe_Required = $window_price_sheet_7_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_7_calculation_field_name === 'Stripe Type (From Bottom)') {
                    $window_price_sheet_7_calculation_quote_item_Stripe_Type = $window_price_sheet_7_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_7_calculation_field_name === 'Stripe Colour') {
                    $window_price_sheet_7_calculation_quote_item_Stripe_Colour = $window_price_sheet_7_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_7_calculation_field_name === 'Box Colour') {
                    $window_price_sheet_7_calculation_quote_item_Box_Colour = $window_price_sheet_7_calculation_quote_item_field_name;
                }
                if ($window_price_sheet_7_calculation_field_name === 'Guide Colour') {
                    $window_price_sheet_7_calculation_quote_item_Guide_Colour = $window_price_sheet_7_calculation_quote_item_field_name;
                }
                ...
                if ($window_price_sheet_7_calculation_field_name === 'Fitting') {
                    ...
                    //     $window_price_sheet_7_calculation_quote_item_width_skins = $window_price_sheet_7_calculation_quote_item_width - 31;
                    // }
                    // else if($window_price_sheet_7_calculation_quote_item_field_name === "FF"){
                    //     $window_price_sheet_7_calculation_quote_item_width_skins = $window_price_sheet_7_calculation_quote_item_width - 26;
                    // }
                    // else{
                    //     $window_price_sheet_7_calculation_quote_item_width_skins = '';
                    // }

                    // if($window_price_sheet_7_calculation_quote_item_field_name === "Reveal"){
                    //     $window_price_sheet_7_calculation_quote_item_width = $window_price_sheet_7_calculation_quote_item_width - 5;
                    // }
                }
            ...
            $window_price_sheet_7_calculation_quote_item_width_skins_de = $window_price_sheet_7_calculation_quote_item_width_skins - $window_price_sheet_7_calculation_quote_item_Tube_Type_width_deduction;
            

            if ($window_price_sheet_7_calculation_quote_item_notes) {
            ...
            if ($window_price_sheet_7_calculation_quote_item_accessories) {

                $window_price_sheet_7_calculation_quote_item_accessories_table =  '<tr>'
            ...
            if ($window_price_sheet_7_calculation_quote_item_per_meters) {

                $window_price_sheet_7_calculation_quote_item_per_meters_table =  '<tr style="font-size: 0.9em;">'
                        . '<td style="border: 0.5px solid #000000;" colspan="20">'
                        . '<table cellpadding="4" cellspacing="0" style="line-height: 6px;">'
                        . '<tr style="font-weight: bold; background-color: #f2f2f2;">'
			...
			$window_price_sheet_7_calculation_quote_tables .= '<tr nobr="true">'
                    . '<td>' . $quote_item_no . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_7_calculation_quote_item_location)[0] . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_width . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_drop . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_7_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_7_calculation_quote_item_type)[0] . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_7_calculation_quote_item_colour)[0] . '</td>'
                    . '<td>' . explode('<->', $window_price_sheet_7_calculation_quote_item_fullness)[0] . '</td>'
                    . '<td>' . ($window_price_sheet_7_calculation_quote_item_fullness_dection + 160) . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_fullness_dection . '</td>'
                    . '<td>' . ($window_price_sheet_7_calculation_quote_item_drop - 50) . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_fullness_number . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_Control_Side . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_Controls . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_Fixing . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_curtain_heading . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_curved_track . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_track_type . '</td>'
                    . '<td>' . $window_price_sheet_7_calculation_quote_item_track_Colour . '</td>'
