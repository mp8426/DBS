...
while ($stmt_1->fetch()) {
    ...
    if($calculation_name === 'Ziptrak'){
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                ...
                . '<th style="width: 20px; border: 1px solid #000000;"><b>No</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Fabric Name & Type</b></th>'
                . '<th colspan="2" style="width: 50px; border: 1px solid #000000;"><b>Fabric/Colour</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Control Type</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Control Side</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets Colour</b></th>'
        ...
        while ($stmt_3->fetch()) {
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_2_calculation_quote_item_Tube_size = $window_price_sheet_2_calculation_quote_item_width - 65;
                $window_price_sheet_2_calculation_quote_item_Key_Way_Side = $window_price_sheet_2_calculation_quote_item_width - 100;
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . '</td>'
                    // . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                    . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
