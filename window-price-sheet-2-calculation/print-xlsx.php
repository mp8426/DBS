...
$window_price_sheet_2_calculation_code = filter_input(INPUT_GET, 'code');
...
while ($stmt_1->fetch()) {
    ...
    if($calculation_name === 'Ziptrak' || $calculation_name === 'Ziptrak®' || $calculation_name === 'Ziptrak® Interior1' || $calculation_name === 'Ziptrak ®' || $calculation_name === 'Ziptrak ® Skins' || $calculation_name === 'Ziptrak ® Interior1'){
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size:15px; text-align: center;" border="1">'
                ...
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size:14px; text-align: center;" border="1">'
                ...
                $window_price_sheet_2_calculation_quote_tables_2 = '<table cellspacing="0" cellpadding="4" style="font-size:18px; text-align: center;" border="1">'
                . '<tr style="border: 1px solid #000000;">'
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size:18px; text-align: center;" border="2">'
                ...
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="text-align: center;" border="1">'
                        . '<tr style="border: 1px solid #000000; font-size:14px;">'
                        . '<th rowspan="2" style="width: 20px; font-size:14px;"><b>No</b></th>'
                ...
                $window_price_sheet_2_calculation_quote_tables_2 = '<table cellspacing="0" cellpadding="4" style="font-size:14px; text-align: center;" border="1">'
                . '<tr>'
                . '<th style="width: 20px;"><b>Job Reference</b></th>'
                . '<th style="width: 40px;"><b>Window Width</b></th>'
                . '<th style="width: 50px;"><b>Window Drop</b></th>'
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                . '<tr style="border: 1px solid #000000;  font-size:14px;">'
                . '<th style="width: 20px; border: 1px solid #000000;  font-size:14px;"><b>No</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;  font-size:14px;"><b>Fabric Name & Type</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;  font-size:14px;"><b>Fabric/Colour</b></th>'
                ...
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                        . '<tr>'
                        . '<th rowspan="2" style="width: 20px; font-size:14px;"><b>No</b></th>'
                        . '<th colspan="2" style="width: 60px; font-size:14px;"><b>Finish Size</b></th>'
                        . '<th colspan="2" style="width: 60px; font-size:14px; background-color: #d8d6d7;"><b>Skin Size</b></th>'
                ...
                $window_price_sheet_2_calculation_quote_tables_2 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                . '<tr>'
                . '<th style="width: 20px;"><b>Job Reference</b></th>'
                . '<th style="width: 40px;"><b>Window Width</b></th>'
                . '<th style="width: 50px;"><b>Window Drop</b></th>'
        ...
        while ($stmt_3->fetch()) {
            ...
            $window_price_sheet_2_calculation_quote_item_accessories = "";

            $query_3_2 = "SELECT code, name, price, qty, (price*qty) AS total FROM window_price_sheet_2_calculation_quote_item_accessories WHERE window_price_sheet_2_calculation_quote_item_code = ? AND window_price_sheet_2_calculation_code = ? AND cid = ?";
            ...
            $stmt_3_2->execute();
            $stmt_3_2->bind_result($window_price_sheet_2_calculation_quote_item_accessory_code, $window_price_sheet_2_calculation_quote_item_accessory_name, $window_price_sheet_2_calculation_quote_item_accessory_price, $window_price_sheet_2_calculation_quote_item_accessory_qty, $window_price_sheet_2_calculation_quote_item_accessory_total);

            while ($stmt_3_2->fetch()) {

                $window_price_sheet_2_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="border: 1px solid #000000; text-align: left;">' . $quote_item_no . '. ' . $quote_item_accessory_no . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="10">Accessory - ' . $window_price_sheet_2_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $window_price_sheet_2_calculation_quote_item_accessory_qty . '</td>'
                        . '</tr>';
            ...
            $query_3_3 = "SELECT code, name, price, width, (price*width) AS total FROM window_price_sheet_2_calculation_quote_item_per_meters WHERE window_price_sheet_2_calculation_quote_item_code = ? AND window_price_sheet_2_calculation_code = ? AND cid = ?";

            $stmt_3_3 = $mysqli->prepare($query_3_3);
            $stmt_3_3->bind_param('sss', $window_price_sheet_2_calculation_quote_item_code, $window_price_sheet_2_calculation_code, $cid);
            $stmt_3_3->execute();
            $stmt_3_3->bind_result($window_price_sheet_2_calculation_quote_item_per_meter_code, $window_price_sheet_2_calculation_quote_item_per_meter_name, $window_price_sheet_2_calculation_quote_item_per_meter_price, $window_price_sheet_2_calculation_quote_item_per_meter_width, $window_price_sheet_2_calculation_quote_item_per_meter_total);

            while ($stmt_3_3->fetch()) {

                $window_price_sheet_2_calculation_quote_item_per_meters .= '<tr>'
                . '<td style="border: 1px solid #000000; text-align: left;">' . $quote_item_no . '. ' . $quote_item_per_meter_no . '</td>'
                        . '<td style=" text-align: left; border-right: 0.5px solid #000000;" colspan="10">Permeter - ' . $window_price_sheet_2_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_per_meter_width . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_price_sheet_2_calculation_field_name === 'Fitting') {
                    ...
                    //     $window_price_sheet_2_calculation_quote_item_width_skins = $window_price_sheet_2_calculation_quote_item_width - 31;
                    // }
                    // if($window_price_sheet_2_calculation_quote_item_field_name === "FF"){
                    //     $window_price_sheet_2_calculation_quote_item_width_skins = $window_price_sheet_2_calculation_quote_item_width - 26;
                    // }
                }
            ...
            if($calculation_name === 'Ziptrak' || $calculation_name === 'Ziptrak®' || $calculation_name === 'Ziptrak® Interior1' || $calculation_name === 'Ziptrak ®' || $calculation_name === 'Ziptrak ® Skins' || $calculation_name === 'Ziptrak ® Interior1'){
                ...
                if ($window_price_sheet_2_calculation_quote_item_notes) {

                    $window_price_sheet_2_calculation_quote_item_notes_table = '<tr>'
                            . '<td style="border: 1px solid #000000;" colspan="12">'
                            . nl2br($window_price_sheet_2_calculation_quote_item_notes)
                            . '</td>'
                            . '</tr>';
                } else {
                    $window_price_sheet_2_calculation_quote_item_notes_table = "";
                }
    
                if ($window_price_sheet_2_calculation_quote_item_accessories) {

                    $window_price_sheet_2_calculation_quote_item_accessories_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                    ...
                    $window_price_sheet_2_calculation_quote_item_accessories_table = "";
                }
    
                if ($window_price_sheet_2_calculation_quote_item_per_meters) {
    
                    $window_price_sheet_2_calculation_quote_item_per_meters_table =  '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                    ...
                    $window_price_sheet_2_calculation_quote_item_per_meters_table = "";
                }


            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . '</td>'
                    // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_track_Colour . '</td>'
                    . '</tr>'
                    . $window_price_sheet_2_calculation_quote_item_notes_table
                    . $window_price_sheet_2_calculation_quote_item_accessories_table;

                    $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $quote_item_no . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_location)[0] . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; background-color: #d8d6d7;">' . $window_price_sheet_2_calculation_quote_item_Skins_width_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; background-color: #d8d6d7;">' . $window_price_sheet_2_calculation_quote_item_Skins_drop_size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_Tube_size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                            //. '<td>' . $window_price_sheet_2_calculation_quote_item_mounting_rail_length . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Type . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
        
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                            
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Fittment . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_track_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Weight_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                    ...
                    $window_price_sheet_2_calculation_quote_tables_2 .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; background-color: #d8d6d7;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; background-color: #d8d6d7;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;"></td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_location)[0] . '</td>'
                    . '</tr>';
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_2_calculation_quote_item_Side_Spline_Size = $window_price_sheet_2_calculation_quote_item_drop + 120;
        
                $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_2_calculation_quote_item_width - 81;
                $window_price_sheet_2_calculation_quote_item_Hood_size = $window_price_sheet_2_calculation_quote_item_width - 7;
                $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size = ceil(($window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size/2) - 80);
                $window_price_sheet_2_calculation_quote_item_Weight_Size = $window_price_sheet_2_calculation_quote_item_width - 181;
                $window_price_sheet_2_calculation_quote_item_Tube_size = $window_price_sheet_2_calculation_quote_item_width - 121;
                $window_price_sheet_2_calculation_quote_item_Key_Way_Side = $window_price_sheet_2_calculation_quote_item_width - 100;
                $window_price_sheet_2_calculation_quote_item_Skins_width_size = $window_price_sheet_2_calculation_quote_item_width - 73;
                $window_price_sheet_2_calculation_quote_item_Skins_drop_size = $window_price_sheet_2_calculation_quote_item_drop + 310;
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $quote_item_no . '</td>'
                    . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                    ...
                    $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                            ...
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
                            . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Weight_Size . '</td>'
                            . '</tr>';
            ...
            else if($calculation_name === 'eZip Blinds'){
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_2_calculation_quote_item_width - 53;
                $window_price_sheet_2_calculation_quote_item_Hood_size = $window_price_sheet_2_calculation_quote_item_width;
                $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size = ceil(($window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size/2) - 80);
                $window_price_sheet_2_calculation_quote_item_Weight_Size = $window_price_sheet_2_calculation_quote_item_width - 450;
                $window_price_sheet_2_calculation_quote_item_Tube_size = $window_price_sheet_2_calculation_quote_item_width - 57;
                $window_price_sheet_2_calculation_quote_item_Key_Way_Side = $window_price_sheet_2_calculation_quote_item_width - 100;
                $window_price_sheet_2_calculation_quote_item_Skins_width_size = $window_price_sheet_2_calculation_quote_item_width - 55;
                $window_price_sheet_2_calculation_quote_item_Skins_drop_size = $window_price_sheet_2_calculation_quote_item_drop + 400;
                ...
                $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                        ...
                        . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                        . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                        . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                        . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                        . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                        . '</tr>'
                        . $window_price_sheet_2_calculation_quote_item_notes_table
                        . $window_price_sheet_2_calculation_quote_item_accessories_table;
                        ...
                        $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                                ...
                                . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px; background-color: #d8d6d7;">' . $window_price_sheet_2_calculation_quote_item_Skins_drop_size . '</td>'
                                . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_Tube_size . '</td>'
                                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
                                . '</tr>';
             ...
             $quote_item_no++;
              ...
              $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_2_calculation_quote_item_width - 108;
              $window_price_sheet_2_calculation_quote_item_Hood_size = $window_price_sheet_2_calculation_quote_item_width;
              $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size = ceil(($window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size/2) - 80);
              $window_price_sheet_2_calculation_quote_item_Weight_Size = $window_price_sheet_2_calculation_quote_item_width - 208;
              $window_price_sheet_2_calculation_quote_item_Tube_size = $window_price_sheet_2_calculation_quote_item_width - 71;
              $window_price_sheet_2_calculation_quote_item_Key_Way_Side = $window_price_sheet_2_calculation_quote_item_width - 100;
              $window_price_sheet_2_calculation_quote_item_Skins_width_size = $window_price_sheet_2_calculation_quote_item_width - 106;
              $window_price_sheet_2_calculation_quote_item_Skins_drop_size = $window_price_sheet_2_calculation_quote_item_drop + 400;
              ...
              $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                      ...
                      . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                      . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                      . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                      . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                      . '</tr>'
                      . $window_price_sheet_2_calculation_quote_item_notes_table
                      . $window_price_sheet_2_calculation_quote_item_accessories_table;
           ...
           $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_2_calculation_quote_item_width - 73;
           $window_price_sheet_2_calculation_quote_item_Hood_size = $window_price_sheet_2_calculation_quote_item_width;
           $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size = ceil(($window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size/2) - 80);
           $window_price_sheet_2_calculation_quote_item_Weight_Size = $window_price_sheet_2_calculation_quote_item_width - 173;
           $window_price_sheet_2_calculation_quote_item_Tube_size = $window_price_sheet_2_calculation_quote_item_width - 70;
           $window_price_sheet_2_calculation_quote_item_Key_Way_Side = $window_price_sheet_2_calculation_quote_item_width - 100;
           $window_price_sheet_2_calculation_quote_item_Skins_width_size = $window_price_sheet_2_calculation_quote_item_width - 75;
           $window_price_sheet_2_calculation_quote_item_Skins_drop_size = $window_price_sheet_2_calculation_quote_item_drop + 400;
        ...
        $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_2_calculation_quote_item_width - 68;
        $window_price_sheet_2_calculation_quote_item_Hood_size = $window_price_sheet_2_calculation_quote_item_width;
        $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size = ceil(($window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size/2) - 80);
        $window_price_sheet_2_calculation_quote_item_Weight_Size = $window_price_sheet_2_calculation_quote_item_width - 173;
        $window_price_sheet_2_calculation_quote_item_Tube_size = $window_price_sheet_2_calculation_quote_item_width - 57;
        $window_price_sheet_2_calculation_quote_item_Key_Way_Side = $window_price_sheet_2_calculation_quote_item_width - 100;
        $window_price_sheet_2_calculation_quote_item_Skins_width_size = $window_price_sheet_2_calculation_quote_item_width - 70;
        $window_price_sheet_2_calculation_quote_item_Skins_drop_size = $window_price_sheet_2_calculation_quote_item_drop + 400;
        ...
        $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
             ...
             //    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                ...
                . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
             //    . '<td colspan="2" style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                . '</tr>'
                . $window_price_sheet_2_calculation_quote_item_notes_table
     ...
     $quote_item_no++;
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width_skins_Tube_Length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bracket_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Size . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    //. '<td>' . $window_price_sheet_2_calculation_quote_item_mounting_rail_length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Direction . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Fit . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Chain_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_Chain_Size . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
                    //. '<td>' . get_price_from_csv($csv_price_sheet, $window_price_sheet_2_calculation_quote_item_width, $window_price_sheet_2_calculation_quote_item_drop) . '</td>'
                    //. '<td style="background-color: #ff0;">' . $window_price_sheet_2_calculation_quote_item_No_Of_Rail_Brackets . '</td>'
                    //. '<td>' . $window_price_sheet_2_calculation_quote_item_Bracket_Covers . '</td>'
                    . '</tr>'
        ...
        $window_price_sheet_2_calculation_quote_tables_2 .= '</table>';
    } else {
        $window_price_sheet_2_calculation_quote_tables .= "";
        $window_price_sheet_2_calculation_quote_tables_1 .= "";
        $window_price_sheet_2_calculation_quote_tables_2 .= "";
    }
	
                $window_price_sheet_2_calculation_total_table_colspan = $table_td_num_rows + $field_td_num_rows + $price_td_num_rows;
