    ...
    if ($stmt_3->num_rows()) {
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.9em; text-align: center;" border="1">'
            ...
            . '</tr>';
                ...
                elseif($calculation_name === 'Ziptrak' || $calculation_name === 'Ziptrak Skins' || $calculation_name === 'Ziptrak®' || $calculation_name === 'Ziptrak® Interior1' || $calculation_name === 'Ziptrak ®' || $calculation_name === 'Ziptrak ® Skins' || $calculation_name === 'Ziptrak ® Interior'){
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.9em; text-align: center;" border="1">'
                        . '<tr>'
                        . '<th style="width: 50px;"><b>No</b></th>'
                        . '<th style="width: 100px;"><b>Fabric Name & Type</b></th>'
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $window_price_sheet_2_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="text-align: left; border-right: 0.5px solid #000000;">' . $quote_item_accessory_no . '. ' . $window_price_sheet_2_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="text-align: center;">' . $window_price_sheet_2_calculation_quote_item_accessory_qty . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $window_price_sheet_2_calculation_quote_item_per_meters .= '<tr>'
                        . '<td style=" text-align: left; border-right: 0.5px solid #000000;">' . $quote_item_per_meter_no . '. ' . $window_price_sheet_2_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="text-align: center;">' . $window_price_sheet_2_calculation_quote_item_per_meter_width . '</td>'
                        . '</tr>';
		...
		if($calculation_name === 'Roller Shutters'){
            ...
            if ($window_price_sheet_2_calculation_quote_item_accessories) {
                ...
                $window_price_sheet_2_calculation_quote_item_accessories_table =  '<tr>'
            ...
            if ($window_price_sheet_2_calculation_quote_item_per_meters) {
                ...
                $window_price_sheet_2_calculation_quote_item_per_meters_table =  '<tr style="font-size: 0.9em;">'
                        . '<td style="border: 0.5px solid #000000;" colspan="20">'
                        . '<table cellpadding="4" cellspacing="0" style="line-height: 6px;">'
                        . '<tr style="font-weight: bold; background-color: #f2f2f2;">'
            ...
            if ($window_price_sheet_2_calculation_quote_item_per_meters) {
                ...
                elseif($calculation_name === 'Ziptrak' || $calculation_name === 'Ziptrak Skins' || $calculation_name === 'Ziptrak®' || $calculation_name === 'Ziptrak® Interior' || $calculation_name === 'Ziptrak ®' || $calculation_name === 'Ziptrak ® Skins' || $calculation_name === 'Ziptrak ® Interior'){
                ...
                $window_price_sheet_2_calculation_quote_item_per_meters_table = "";
                    ...
                    $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true">'
                        ...
                        $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true">'
                            ...
                            $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true">'
                            . '<td>' . $quote_item_no . '</td>'
                            . '<td colspan="2">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . '</td>'
                            . '<td colspan="2">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                            // . '<td>' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                            // . '<td>' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                            // . '<td>' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Colour . '</td>'
                            . '<td colspan="2">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                            ...
                            . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                            // . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                            . '<td colspan="2">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                            . '<td>' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                            . '</tr>'
                            . $window_price_sheet_2_calculation_quote_item_notes_table
                            . $window_price_sheet_2_calculation_quote_item_accessories_table;
                            ...
                            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true">'
                                    ...
                                    . '<td style="background-color: #f2f2f2;">' . $window_price_sheet_2_calculation_quote_item_Skins_drop_size . '</td>'
                                    // . '<td>' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Size . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_2_calculation_quote_item_Tube_size . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                                    . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
                                    // . '<td>' . $window_price_sheet_2_calculation_quote_item_Weight_Size . '</td>'
                                    // . '<td>' . $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                                    . '</tr>';
                        ...
                        if ($window_price_sheet_2_calculation_quote_item_per_meters) {
                            ...
                            $window_price_sheet_2_calculation_quote_item_per_meters_table = "";
                                ...
                                . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                                // . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                                . '<td>' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                                . '<td>' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                                . '</tr>'
                                . $window_price_sheet_2_calculation_quote_item_notes_table
                                . $window_price_sheet_2_calculation_quote_item_accessories_table;
                        ...
                        if ($window_price_sheet_2_calculation_quote_item_per_meters) {
                            ...
                            $window_price_sheet_2_calculation_quote_item_per_meters_table = "";
                                    ...
                                    . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                                    // . '<td>' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                                    . '<td colspan="2">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                                    . '<td>' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                                    . '</tr>'
                                    . $window_price_sheet_2_calculation_quote_item_notes_table
                                    . $window_price_sheet_2_calculation_quote_item_accessories_table;
