...
while ($stmt_1->fetch()) {
    ...
    if($calculation_name === 'Ziptrak'){
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                ...
                . '<th style="width: 20px; border: 1px solid #000000;"><b>No</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Fabric Name & Type</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Fabric/Colour</b></th>'
                . '<th style="width: 35px; border: 1px solid #000000;"><b>Side Spline Colour</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Control Type</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Control Side</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets Colour</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Bottom Rail Colour</b></th>'
                . '<th style="width: 35px; border: 1px solid #000000;"><b>Bottom Bar Seal</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Fitting Type</b></th>'
                . '<th style="width: 35px; border: 1px solid #000000;"><b>Track Colour</b></th>'
                . '</tr>';
                ...
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                        ...
                        . '<th colspan="2" style="width: 60px; background-color: #f2f542;"><b>Skin Size</b></th>'
                        ...
                        . '<th style="width: 30px; background-color: #f2f542;"><b>Width</b></th>'
                        . '<th style="width: 30px; background-color: #f2f542;"><b>Height</b></th>'
                        . '</tr>';
    ...
    } else if($calculation_name === 'Zipscreen' || $calculation_name === 'Zipscreen Blinds'){
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                . '<tr style="border: 1px solid #000000;">'
                . '<th style="width: 20px; border: 1px solid #000000;"><b>No</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Fabric Name & Type</b></th>'
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                ...
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                        ...
                        . '<th rowspan="2" style="width: 40px;"><b>Hood/Brackets Size</b></th>'
                        . '<th rowspan="2" style="width: 40px;"><b>Bottom Bar Size</b></th>'
                        . '<th colspan = "2" rowspan="2" style="width: 40px; text-align: center;"><b>Weight Size</b></th>'
                        // . '<th rowspan="2" style="width: 40px;"><b></b></th>'
                        . '</tr>'
                        . '<tr>'
                        . '<th style="width: 30px; background-color: #f2f2f2;"><b>Width</b></th>'
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                . '<tr style="border: 1px solid #000000;">'
                . '<th style="width: 20px; border: 1px solid #000000;"><b>No</b></th>'
                . '<th colspan="2" style="width: 50px; border: 1px solid #000000;"><b>Fabric Name & Type</b></th>'
                . '<th style="width: 50px; border: 1px solid #000000;"><b>Fabric/Colour</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Control Type</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Control Side</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets</b></th>'
                ...
                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                        ...
                        . '<th rowspan="2" style="width: 40px;"><b>Hood/Brackets Size</b></th>'
                        . '<th rowspan="2" style="width: 40px;"><b>Bottom Bar Size</b></th>'
                        . '<th colspan="2" rowspan="2" style="width: 40px;"><b>Weight Size</b></th>'
                        . '</tr>'
                        . '<tr>'
                        . '<th style="width: 30px; background-color: #f2f2f2; border: 1px solid #000000;"><b>Width</b></th>'
                        . '<th style="width: 30px; background-color: #f2f2f2; border: 1px solid #000000;"><b>Height</b></th>'
                        . '<th style="width: 30px; background-color: #f2f542; border: 1px solid #000000;"><b>Width</b></th>'
                        . '<th style="width: 30px; background-color: #f2f542; border: 1px solid #000000;"><b>Height</b></th>'
                        . '</tr>';
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                ...
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets</b></th>'
                . '<th style="width: 40px; border: 1px solid #000000;"><b>Hood/Brackets Colour</b></th>'
                . '<th colspan ="2" style="width: 50px; border: 1px solid #000000;"><b>Bottom Rail Colour</b></th>'
                // . '<th style="width: 35px; border: 1px solid #000000;"><b>Bottom Bar Seal</b></th>'
                // . '<th style="width: 50px; border: 1px solid #000000;"><b>Fitting Type</b></th>'
                // . '<th style="width: 35px; border: 1px solid #000000;"><b>Track Colour</b></th>'
                . '<th colspan ="2" style="width: 35px; border: 1px solid #000000;"><b>Valance Type</b></th>'
                . '<th colspan ="2" style="width: 35px; border: 1px solid #000000;"><b>Arm Size</b></th>'
                . '</tr>';

                $window_price_sheet_2_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                        . '<tr>'
                        . '<th rowspan="2" style="width: 20px;"><b>No</b></th>'
                        . '<th colspan="2" style="width: 60px; background-color: #f2f2f2; border: 1px solid #000000;"><b>Finish Size</b></th>'
                        . '<th colspan="2" style="width: 60px; background-color: #f2f542; border: 1px solid #000000;"><b>Skin Size</b></th>'
                        // . '<th rowspan="2" style="width: 50px;"><b>Side Spline Side</b></th>'
                        . '<th rowspan="2" style="width: 35px;"><b>Tube Type</b></th>'
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                ...
                // . '<th style="width: 50px; border: 1px solid #000000;"><b>Fitting Type</b></th>'
                // . '<th style="width: 35px; border: 1px solid #000000;"><b>Track Colour</b></th>'
                . '<th style="width: 35px; border: 1px solid #000000;"><b>Valance Type</b></th>'
                . '<th colspan ="2" style="width: 35px; border: 1px solid #000000;"><b>Arm Size</b></th>'
                . '</tr>';
        ...
        $window_price_sheet_2_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                ...
                . '<th colspan="2" style="width: 50px; border: 1px solid #000000;"><b>Bottom Rail Colour</b></th>'
                // . '<th style="width: 35px; border: 1px solid #000000;"><b>Bottom Bar Seal</b></th>'
                . '<th colspan ="2" style="width: 50px; border: 1px solid #000000;"><b>Fitting Type</b></th>'
                // . '<th style="width: 35px; border: 1px solid #000000;"><b>Track Colour</b></th>'
                . '<th colspan ="2" style="width: 35px; border: 1px solid #000000;"><b>Valance Type</b></th>'
                // . '<th colspan ="2" style="width: 35px; border: 1px solid #000000;"><b>Arm Size</b></th>'
                . '</tr>';
        ...
        while ($stmt_3->fetch()) {
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . '</td>'
                    // . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_track_Colour . '</td>'
                    . '</tr>';

                    $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_location)[0] . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Skins_width_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Skins_drop_size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Side_Spline_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Tube_size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                            //. '<td>' . $window_price_sheet_2_calculation_quote_item_mounting_rail_length . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Type . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
        
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                            
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Fittment . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_track_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Weight_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                    ...
                    $window_price_sheet_2_calculation_quote_tables_2 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; background-color: #f2f542;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; background-color: #f2f542;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    ...
                    $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                            ...
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
                            . '<td colspan = "2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Weight_Size . '</td>'
                            // . '<td style="text-align: center; border: 1px solid #000000;"></td>'
                            . '</tr>';
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                    ...
                    $window_price_sheet_2_calculation_quote_tables_2 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Finish_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; background-color: #f2f542;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; background-color: #f2f542;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;"></td>'
            ...
            $quote_item_no++;
                ...
                $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                        ...
                        . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Hood_Type . '</td>'
                        . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                        . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                        . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                        . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                        . '</tr>';
                        ...
                        $window_price_sheet_2_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                                ...
                                . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Skins_drop_size . '</td>'
                                . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                                . '<td colspan="2" style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_Tube_size . '</td>'
                                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_size . '</td>'
                                . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Size . '</td>'
                                . '</tr>';
             ...
             $quote_item_no++;
              ...
              $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                      ...
                      . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                      . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                      . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                      . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                      . '</tr>';
        ...
        $quote_item_no++;
           ...
           $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                ...
                //    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                   ...
                   . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Hood_Colour . '</td>'
                   . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                   . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_fitting_type . '</td>'
                   . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_valance_type . '</td>'
                //    . '<td colspan="2" style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_arm_size . '</td>'
                   . '</tr>';
        ...
        $quote_item_no++;
            ...
            $window_price_sheet_2_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Tube_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width_skins_Tube_Length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bracket_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Size . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Bottom_Bar_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    //. '<td>' . $window_price_sheet_2_calculation_quote_item_mounting_rail_length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Direction . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Fit . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Chain_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_Chain_Size . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
                    //. '<td>' . get_price_from_csv($csv_price_sheet, $window_price_sheet_2_calculation_quote_item_width, $window_price_sheet_2_calculation_quote_item_drop) . '</td>'
                    //. '<td style="background-color: #ff0;">' . $window_price_sheet_2_calculation_quote_item_No_Of_Rail_Brackets . '</td>'
                    //. '<td>' . $window_price_sheet_2_calculation_quote_item_Bracket_Covers . '</td>'
                    . '</tr>';
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_2_calculation_quote_item_drop_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;"></td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_2_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_2_calculation_quote_item_location)[0] . '</td>'
                    . '</tr>';
