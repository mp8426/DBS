...
$query_1 = "INSERT INTO window_price_sheet_2_calculation_quote_item_per_meters ( code, name, price, width, window_price_sheet_2_calculation_quote_item_code, window_price_sheet_2_calculation_code, cid ) VALUES( ?, ?, ?, ?, ?, ?, ? )";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('sssssss', $per_meter_code, $per_meter_name, $per_meter_price, $per_meter_width, $window_price_sheet_2_calculation_quote_item_code, $window_price_sheet_2_calculation_code, $cid);
