<?php
    ...
    include '../../cPanel/connect.php';
        ...
        $query_1 = "DELETE FROM window_price_sheet_2_calculation_quote_item_accessories WHERE code = ? AND window_price_sheet_2_calculation_quote_item_code = ? AND window_price_sheet_2_calculation_code = ? AND cid = ?";
        
        $stmt_1 = $mysqli -> prepare( $query_1 );
        $stmt_1 -> bind_param( 'ssss', $accessory_code, $window_price_sheet_2_calculation_quote_item_code, $window_price_sheet_2_calculation_code, $cid );
