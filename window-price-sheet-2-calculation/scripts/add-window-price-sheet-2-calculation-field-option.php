...
$window_price_sheet_2_calculation_field_code = filter_input(INPUT_POST, 'field_code');
$window_price_sheet_2_calculation_code = filter_input(INPUT_POST, 'window_price_sheet_2_calculation_code');

if ($name !== "") {

    $query_1 = "INSERT INTO window_price_sheet_2_calculation_field_options ( code, name, window_price_sheet_2_calculation_field_code, window_price_sheet_2_calculation_code ) VALUES( ?, ?, ?, ? )";

    $stmt_1 = $mysqli->prepare($query_1);
    $stmt_1->bind_param('ssss', $code, $name, $window_price_sheet_2_calculation_field_code, $window_price_sheet_2_calculation_code);
