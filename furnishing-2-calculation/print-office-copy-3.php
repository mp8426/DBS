        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $furnishing_2_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; color:red;">' . $quote_item_accessory_no . '. ' . $furnishing_2_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: right; color:red;">' . $furnishing_2_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; color:red;">' . $furnishing_2_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; color:red;">' . number_format($furnishing_2_calculation_quote_item_accessory_total, 2) . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $furnishing_2_calculation_quote_item_per_meters .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; color:red;">' . $quote_item_per_meter_no . '. ' . $furnishing_2_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: right; color:red;">' . $furnishing_2_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; color:red;">' . $furnishing_2_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; color:red;">' . number_format($furnishing_2_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $furnishing_2_calculation_quote_item_fitting_charges .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; color:red;">' . $quote_item_fitting_charge_no . '. ' . $furnishing_2_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; color:red;">' . $furnishing_2_calculation_quote_item_fitting_charge_price . '</td>'
                        . '</tr>';
            ...
            if ($furnishing_2_calculation_quote_item_notes || $furnishing_2_calculation_quote_item_accessories || $furnishing_2_calculation_quote_item_per_meters || $furnishing_2_calculation_quote_item_fitting_charges) {
                ...
                if ($furnishing_2_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[0] === '1') {
                ...
                if ($furnishing_2_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[0] === '1') {
                ...
                if ($furnishing_2_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[0] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[0] === '1' && $furnishing_2_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[0] === '1' && $furnishing_2_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[0] === '1' && $furnishing_2_calculation_quote_item_fitting_charges
                ) {
