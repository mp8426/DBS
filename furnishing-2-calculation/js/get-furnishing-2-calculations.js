$(function() {
                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="furnishing-2-calculation-quote-items-wrapper-' + furnishing_2_calculation_code + '" class="furnishing-2-calculation-quote-items-wrapper"></div>')
                            ...
                            .append('<div class="bulk-action-button-wrapper">\n\
                                            ...
                                            <input type="tel" class="production-furnishing-2-date quote_details" id="production-furnishing-2-date" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + furnishing_2_calculation_code + '" placeholder="Date" autocomplete="off" value="' + value.production_date + '"style="width:100px; height:35px !important; margin-left:2px; margin-right:2px; border-radius: 6px; border: 1px solid #cdd5da;  ' +  approved_date + ' text-align: center;">\n\
                                            <input type="tel" class="install-furnishing-2-date quote_details" id="install-furnishing-2-date" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + furnishing_2_calculation_code + '" placeholder="Date" autocomplete="off" value="' + value.install_date + '"style="width:100px; height:35px !important; margin-left:2px; margin-right:2px; border-radius: 6px; border: 1px solid #cdd5da;  ' +  approved_date + ' text-align: center;">\n\
                                            </form>\n\
                                        ...
                                        </div>').prependTo("#furnishing-2-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button().end()
                                        .find(".production-furnishing-2-date").datepicker({ dateFormat: "dd/mm/yy" }).end()
                                        .find(".install-furnishing-2-date").datepicker({ dateFormat: "dd/mm/yy" });
            ...
            success: function(data) {
                ...
                if (data[0] === 1) {
                    ...
                    result_parent.find('.bulk-action-button-wrapper').html('<input type="button" class="bulk-action-button furnishing-2-calculation-select-all-bttn" value="✔">\n\
                                                                            ...
                                                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-furnishing-2-calculation-' + furnishing_2_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 175px;">Print Order Sheet Xlsx</a>\n\
                                                                            <form style="display: contents; margin-right: -6px; font-size: 14px;">\n\
                                                                            <input type="tel" class="production-furnishing-2-date quote_details" id="production-furnishing-2-date" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + furnishing_2_calculation_code + '" placeholder="Production Date" autocomplete="off" value=""style="width:100px; height:35px !important; margin-left:2px; margin-right:2px;text-align: center; border-radius: 6px; border: 1px solid #cdd5da;  ' +  approved_date + '">\n\
                                                                            <input type="tel" class="install-furnishing-2-date quote_details" id="install-furnishing-2-date" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + furnishing_2_calculation_code + '"  placeholder="Install Date" autocomplete="off" value=""style="width:100px; height:35px !important; margin-left:2px; margin-right:2px;text-align: center; border-radius: 6px; border: 1px solid #cdd5da;  ' +  approved_date + '">\n\
                                                                            </form>\n\
                                                                            <form class="group-discount-form" style="float: right; margin-right: -6px; font-size: 12px;">\n\
    ...
    $(document).on("change", "#furnishing-2-calculation-quote-items-results .production-furnishing-2-date", function(event) {
        event.preventDefault();
        ...
        var furnishing_2_calculation_code = this_form.find(".furnishing-2-calculation-code").val();
        var furnishing_2_calculation_name = this_form.find(".furnishing-2-calculation-name").val();
        ...
        $.ajax({
            ...
            beforeSend: function() {
                //	alert(furnishing_2_calculation_code);
                //	alert(name);
                //	alert(state_select);
            ...
            success: function(data) {
                //	alert(furnishing_2_calculation_name);
                //alert(data);
                // if (data[0] === 1) {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                // this_bttn.prop('disabled', false).removeClass('field-loader');
                alert(JSON.stringify(jqXHR));
                alert("Error! @update-furnishing-2-calculation-Product-date");
            }
        });

    });
    
    $(document).on("change", "#furnishing-2-calculation-quote-items-results .install-furnishing-2-date", function(event) {
        event.preventDefault();
