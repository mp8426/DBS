<?php
    ...
    include '../../cPanel/connect.php';
        ...
        $query_1 = "DELETE FROM furnishing_2_calculation_quote_item_fitting_charges WHERE code = ? AND furnishing_2_calculation_quote_item_code = ? AND furnishing_2_calculation_code = ? AND cid = ?";
        
        $stmt_1 = $mysqli -> prepare( $query_1 );
        $stmt_1 -> bind_param( 'ssss', $fitting_charge_code, $furnishing_2_calculation_quote_item_code, $furnishing_2_calculation_code, $cid );
