    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                if ($furnishing_2_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $furnishing_2_calculation_quote_item_field_name . '</td>';
                }
                if ($furnishing_2_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $furnishing_2_calculation_quote_item_field_name . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $furnishing_2_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; ">' . $quote_item_accessory_no . '. ' . $furnishing_2_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: right; ">' . $furnishing_2_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; ">' . $furnishing_2_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; ">' . number_format($furnishing_2_calculation_quote_item_accessory_total, 2) . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $furnishing_2_calculation_quote_item_per_meters .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; ">' . $quote_item_per_meter_no . '. ' . $furnishing_2_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: right; ">' . $furnishing_2_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; ">' . $furnishing_2_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; ">' . number_format($furnishing_2_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $furnishing_2_calculation_quote_item_fitting_charges .= '<tr>'
                        . '<td style="border: 0.5px solid #000000; ">' . $quote_item_fitting_charge_no . '. ' . $furnishing_2_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center; ">' . $furnishing_2_calculation_quote_item_fitting_charge_price . '</td>'
                        . '</tr>';
                $quote_item_fitting_charge_no++;
            }
            $stmt_3_4->close();

            $location_td = $locations_select === 1 && $location_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $furnishing_2_calculation_quote_item_location)[0] . '</td>' : '';
            $cost_td = $cost_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $furnishing_2_calculation_quote_item_cost . '</td>' : '';
            $markup_td = $markup_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $furnishing_2_calculation_quote_item_markup . '</td>' : '';
            $price_td = $price_print[1] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($furnishing_2_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($group_discount_print[1] === '1') {
                ...
                $furnishing_2_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Sub Total (Blinds)</th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($furnishing_2_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold; color:red;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Discount (' . $furnishing_2_calculation_quote_item_discount . '%) </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold; color:red;">-' . number_format($furnishing_2_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Total (Blinds)</th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right;">' . number_format($furnishing_2_calculation_quote_item_price_sub_total_x, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Accessories </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right;">' . number_format($furnishing_2_calculation_quote_item_accessory_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Extras </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right;">' . number_format($furnishing_2_calculation_quote_item_per_meter_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Total</th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right;">' . number_format($furnishing_2_calculation_quote_item_price_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">GST</th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right;">' . number_format($furnishing_2_calculation_quote_item_price_total/10, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 1em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $furnishing_2_calculation_total_table_colspan . '">Total GST Inc </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($furnishing_2_calculation_quote_item_price_total + ($furnishing_2_calculation_quote_item_price_total/10), 2) . '</th>'
                        . '</tr>'
                        . '</table>';
            } else {
