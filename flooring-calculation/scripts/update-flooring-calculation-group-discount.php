...
$query_1 = "UPDATE flooring_calculation_quote_items SET discount = ? WHERE flooring_calculation_code = ? AND cid = ?";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('sss', $discount, $flooring_calculation_code, $cid);
if ($stmt_1->execute()) {
