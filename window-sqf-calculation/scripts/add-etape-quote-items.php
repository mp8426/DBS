...
if ($result[0] === 200) {
    ...
    foreach ($m_data as $value) {
        ...
        $query_1 = "INSERT INTO " . $mc_db . "_quote_items ( code, location, width_x, drop_x, type, price, " . $mc_db . "_code, cid ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ? )";

        $stmt_1 = $mysqli->prepare($query_1);
        $stmt_1->bind_param('ssssssss', $qi_code, $location, $width, $drop, $type, $price, $sc_code, $cid);
        $stmt_1->execute();
        $stmt_1->close();
