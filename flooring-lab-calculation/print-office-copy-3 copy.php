...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM flooring_lab_calculation_fields WHERE office_copy = 1 AND flooring_lab_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT flooring_lab_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_lab_calculation_fields.office_copy = 1 AND "
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $flooring_lab_calculation_quote_item_accessories .= '<tr>'
                        . '<td style="border: 0.5px solid #000000;">' . $quote_item_accessory_no . '. ' . $flooring_lab_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: right;">' . $flooring_lab_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $flooring_lab_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . number_format($flooring_lab_calculation_quote_item_accessory_total, 2) . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $flooring_lab_calculation_quote_item_per_meters .= '<tr>'
                        . '<td style="border: 0.5px solid #000000;">' . $quote_item_per_meter_no . '. ' . $flooring_lab_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: right;">' . $flooring_lab_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . $flooring_lab_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . number_format($flooring_lab_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $flooring_lab_calculation_quote_item_fitting_charges .= '<tr>'
                        . '<td style="border: 0.5px solid #000000;">' . $quote_item_fitting_charge_no . '. ' . $flooring_lab_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 0.5px solid #000000; text-align: center;">' . number_format($flooring_lab_calculation_quote_item_fitting_charge_price, 2) . '</td>'
                        . '</tr>';
                $quote_item_fitting_charge_no++;
            }
            $stmt_3_4->close();

            $location_td = $locations_select === 1 && $location_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_lab_calculation_quote_item_unit . '</td>' : '';
            $installation_type_td = $installation_type_print[0] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_calculation_quote_item_installation_type)[0] . '</td>' : '';
            $price_td = $price_print[0] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[0] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($flooring_lab_calculation_quote_item_notes || $flooring_lab_calculation_quote_item_accessories || $flooring_lab_calculation_quote_item_fitting_charges) {
                ...
                if ($flooring_lab_calculation_quote_item_notes && $note_print[0] === '1') {
                ...
                if ($flooring_lab_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[0] === '1') {

                    $flooring_lab_calculation_quote_item_accessories_table = '<td style="border: 0.5px solid #000000;">'
                ...
                if ($flooring_lab_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[0] === '1') {

                    $flooring_lab_calculation_quote_item_per_meters_table = '<td style="border: 0.5px solid #000000;">'
                            . '<table cellpadding="4" cellspacing="0" style="line-height: 6px;">'
                            . '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                ...
                if ($flooring_lab_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[0] === '1') {

                    $flooring_lab_calculation_quote_item_fitting_charges_table = '<td style="border: 0.5px solid #000000;">'
                            . '<table cellpadding="4" cellspacing="0" style="line-height: 6px;">'
                ...
                if ($accessories_select === 1 && $accessory_print[0] === '1' && $flooring_lab_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[0] === '1' && $flooring_lab_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[0] === '1' && $flooring_lab_calculation_quote_item_fitting_charges
                ) {
            ...
            if ($group_discount_print[0] === '1') {
                ...
                $flooring_lab_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="width:800px; border-top: 0.5px solid #616060; border-left: 0.5px solid #616060; border-bottom: 0.5px solid #616060; color:#303030; font-size: 1.9em; text-align: center; font-weight: 14px; vertical-align: middle;" rowspan="3">'.$flooring_lab_calculation_name.'</th>'
                        . '<th style="width:100px;  border-top: 0.5px solid #616060; border-right: 0.5px solid #616060; color:#303030; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="width:100px; border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($flooring_lab_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border-top: 0.5px solid #616060; border-right: 0.5px solid #616060; border-bottom: 0.5px solid #616060; color:#277cbe; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Discount (' . $flooring_lab_calculation_quote_item_discount . '%) </th>'
                        . '<th style="border: 0.5px solid #000000; color:#277cbe; text-align: right; font-weight: bold;">-' . number_format($flooring_lab_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        // . '<tr style="font-size: 0.9em;">'
                        // . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Total </th>'
