...
$query_1 = "SELECT name, locations, accessories, per_meters, fitting_charges FROM flooring_lab_calculations WHERE code = ? ORDER BY position ASC";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('s', $flooring_lab_calculation_code);
$stmt_1->execute();
$stmt_1->bind_result($flooring_lab_calculation_name, $locations_select, $accessories_select, $per_meters_select, $fitting_charges_select);
$stmt_1->store_result();
...
while ($stmt_1->fetch()) {
    ...
    $installation_type_th = $installation_type_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">Installation Type</td>' : '';
    $field_th_right = '';
    $field_th_left = '';
    ...
    $query_2 = "SELECT code, name, side FROM flooring_lab_calculation_fields WHERE order_sheet = 1 AND flooring_lab_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT flooring_lab_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_lab_calculation_fields.order_sheet = 1 AND "
            ...
            $location_td = $locations_select === 1 && $location_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_lab_calculation_quote_item_unit . '</td>' : '';
            $installation_type_td = $installation_type_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_calculation_quote_item_installation_type)[0] . '</td>' : '';
            $price_td = $price_print[2] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[2] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($flooring_lab_calculation_quote_item_notes || $flooring_lab_calculation_quote_item_accessories || $flooring_lab_calculation_quote_item_fitting_charges) {
                ...
                if ($flooring_lab_calculation_quote_item_notes && $note_print[2] === '1') {
                ...
                if ($flooring_lab_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[2] === '1') {
                ...
                if ($flooring_lab_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[2] === '1') {
                ...
                if ($flooring_lab_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[2] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[2] === '1' && $flooring_lab_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[2] === '1' && $flooring_lab_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[2] === '1' && $flooring_lab_calculation_quote_item_fitting_charges
                ) {
            ...
            if ($group_discount_print[2] === '1') {
                ...
                $flooring_lab_calculation_total = '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;">' . number_format($flooring_lab_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="font-size: 0.9em;">'
                        . '<th style="border: 0.5px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Discount (' . $flooring_lab_calculation_quote_item_discount . '%) </th>'
