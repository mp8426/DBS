...
while ($stmt_1->fetch()) {
    ...
    $query_2 = "SELECT code, name, side FROM flooring_lab_calculation_fields WHERE " . $print_type . " = 1 AND flooring_lab_calculation_code = ? ORDER BY position ASC";
    ...
    $flooring_lab_calculation_table_header = '<table><thead>'
            . '<tr><th colspan="' . $tot_th_colspan_x . '"><strong>' . $flooring_lab_calculation_name . '</strong></th></tr>'
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT flooring_lab_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_lab_calculation_fields." . $print_type . " = 1 AND "
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($flooring_lab_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $flooring_lab_calculation_quote_item_field_name . $flooring_lab_calculation_quote_item_field_price_x . '</td>';
                }
                if ($flooring_lab_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $flooring_lab_calculation_quote_item_field_name . $flooring_lab_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $flooring_lab_calculation_quote_item_accessories .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Accessory - ' . $flooring_lab_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $flooring_lab_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $flooring_lab_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_accessory_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $flooring_lab_calculation_quote_item_per_meters .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Per Meter - ' . $flooring_lab_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $flooring_lab_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $flooring_lab_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $flooring_lab_calculation_quote_item_fitting_charges .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Fitting Charge - ' . $flooring_lab_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $flooring_lab_calculation_quote_item_fitting_charge_price . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            $location_td = $locations_select === 1 && $location_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_lab_calculation_quote_item_unit . '</td>' : '';
            $installation_type_td = $installation_type_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_lab_calculation_quote_item_installation_type)[0] . '</td>' : '';
            $price_td = $price_print[$no] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[$no] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($flooring_lab_calculation_quote_item_notes || $flooring_lab_calculation_quote_item_accessories || $flooring_lab_calculation_quote_item_per_meters || $flooring_lab_calculation_quote_item_fitting_charges) {

                if ($flooring_lab_calculation_quote_item_notes && $note_print[$no] === '1') {

                    $flooring_lab_calculation_quote_item_notes_table = '<tr>'
                ...
                if ($flooring_lab_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[$no] === '1') {

                    $flooring_lab_calculation_quote_item_accessories_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                ...
                if ($flooring_lab_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[$no] === '1') {

                    $flooring_lab_calculation_quote_item_per_meters_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($flooring_lab_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1') {

                    $flooring_lab_calculation_quote_item_fitting_charges_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($accessories_select === 1 && $accessory_print[$no] === '1' && $flooring_lab_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[$no] === '1' && $flooring_lab_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1' && $flooring_lab_calculation_quote_item_fitting_charges
                ) {


                    $table_more .= $flooring_lab_calculation_quote_item_accessories_table
                            . $flooring_lab_calculation_quote_item_per_meters_table
                            . $flooring_lab_calculation_quote_item_fitting_charges_table;
                } else {
                    $table_more .= "";
            ...
            $flooring_lab_calculation_quote_items .= '<tr>'
            ...
            if ($group_discount_print[$no] === '1') {
                ...
                $flooring_lab_calculation_total = '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($flooring_lab_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Discount (' . $flooring_lab_calculation_quote_item_discount . ' % ) </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">-' . number_format($flooring_lab_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        . '<tr>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_lab_calculation_total_table_colspan . '">Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($flooring_lab_calculation_quote_item_price_total, 2) . '</th>'
                        . '</tr>';
            } else {
        ...
        $flooring_lab_calculation_quote_tables .= $flooring_lab_calculation_table_header . $flooring_lab_calculation_quote_items . $flooring_lab_calculation_total . "</tbody></table>";
        $flooring_lab_calculation_quote_tables_2 .= "";
    } else {
        $flooring_lab_calculation_quote_tables .= "";
        $flooring_lab_calculation_quote_tables_2 .= "";
    }
