    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($flooring_lab_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #787877;">' . $flooring_lab_calculation_quote_item_field_name . $flooring_lab_calculation_quote_item_field_price_x . '</td>';
                }
                if ($flooring_lab_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #787877;">' . $flooring_lab_calculation_quote_item_field_name . $flooring_lab_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $location_td = $locations_select === 1 && $location_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $flooring_lab_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . $flooring_lab_calculation_quote_item_unit . '</td>' : '';
            $installation_type_td = $installation_type_print[0] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $flooring_lab_calculation_quote_item_installation_type)[0] . '</td>' : '';
            $price_td = $price_print[0] === '1' ? '<td style="border: 0.5px solid #787877; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[0] === '1' ? '<td style="border: 0.5px solid #787877; text-align: right;">' . number_format($flooring_lab_calculation_quote_item_total, 2) . '</td>' : '';
