                ...
                $.each(data[1], function(index, value) {
                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="window-price-sheet-6-calculation-quote-items-wrapper-' + window_price_sheet_6_calculation_code + '" class="window-price-sheet-6-calculation-quote-items-wrapper"></div>')
                            ...
                            .append('<div id="quote-items-body-' + window_price_sheet_6_calculation_code + '" class="window-price-sheet-6-calculation-quote-items-body added-calcs" data-calc-name="' + value.name + '"></div>')
                            .append('<div class="bulk-action-button-wrapper">\n\
                                            ...
                                            <button class="fa-btn quote-item-sort-bttn tltip bulk-action-button" style="padding-left:5px; padding-right:5px;" data-calc-code="'+ window_price_sheet_6_calculation_code + '" data-title="Move Blind">Move Blind<i class="fa fa-sort" aria-hidden="true"></i></button>\n\
