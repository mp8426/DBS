        ...
        success: function(data) {
            ...
            if (data[0] === 1) {
                ...
                $.each(data[1], function(index, value) {
                    ...
                    fullness_element = '<td>\n\
                                        <select name="fullness" data-column="fullness" class="window-price-sheet-6-calculation-fullness data-field approved-disabled">\n\
                                            <option value=""></option>\n\
                                            ' + fullness_options + '\
                                        </select>\n\
                                    </td>';
                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="window-price-sheet-6-calculation-quote-items-wrapper-' + window_price_sheet_6_calculation_code + '" class="window-price-sheet-6-calculation-quote-items-wrapper"></div>')
                            ...
                            .append('<div class="bulk-action-button-wrapper">\n\
                                        ...
                                        </div>').prependTo("#window-price-sheet-6-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button();
