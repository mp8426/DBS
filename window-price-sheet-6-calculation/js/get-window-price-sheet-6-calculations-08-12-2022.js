    ...
    $(document).on("click", ".add-window-price-sheet-6-calculation-accessories", function() {
        ...
        if (accessory) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: { cid: cid, window_price_sheet_6_calculation_code: window_price_sheet_6_calculation_code, window_price_sheet_6_calculation_quote_item_code: window_price_sheet_6_calculation_quote_item_code, accessory: accessory, accessory_qty: accessory_qty },
                beforeSend: function() {
                    this_bttn.prop('disabled', false).addClass('field-loader');
