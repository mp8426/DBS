...
while ($stmt_1->fetch()) {
    ...
    $query_3 = "SELECT code, location, width_x, drop_x, type, material, colour, fullness FROM window_price_sheet_6_calculation_quote_items WHERE window_price_sheet_6_calculation_code = ? AND cid = ? ORDER BY id ASC";

    $stmt_3 = $mysqli->prepare($query_3);
    $stmt_3->bind_param('ss', $window_price_sheet_6_calculation_code, $cid);
    $stmt_3->execute();
    $stmt_3->bind_result($window_price_sheet_6_calculation_quote_item_code, $window_price_sheet_6_calculation_quote_item_location, $window_price_sheet_6_calculation_quote_item_width, $window_price_sheet_6_calculation_quote_item_drop, $window_price_sheet_6_calculation_quote_item_type, $window_price_sheet_6_calculation_quote_item_material, $window_price_sheet_6_calculation_quote_item_colour, $window_price_sheet_6_calculation_quote_item_fullness);
    $stmt_3->store_result();
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_price_sheet_6_calculation_field_name === 'Valance Type') {
                    $window_price_sheet_6_calculation_quote_item_valance_type = $window_price_sheet_6_calculation_quote_item_field_name;
                    
                }
				
                if ($window_price_sheet_6_calculation_field_name === 'Arm Size') {
                    $window_price_sheet_6_calculation_quote_item_arm_size = $window_price_sheet_6_calculation_quote_item_field_name;
            ...
            // else{
            $window_price_sheet_6_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_location)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_6_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_fullness)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . ($window_price_sheet_6_calculation_quote_item_fullness_dection + 160) . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_fullness_dection . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . ($window_price_sheet_6_calculation_quote_item_drop - 50) . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_fullness_number . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_opening . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_Fixing . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_curtain_heading . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_curved_track . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_track_type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_track_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_width . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px; ">' . $window_price_sheet_6_calculation_quote_item_drop . '</td>'
                    //. '<td>' . $window_price_sheet_6_calculation_quote_item_mounting_rail_length . '</td>'
                    // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_Fit . '</td>'
                    // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_Chain_Colour . '</td>'
                    // . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_Chain_Size . '</td>'
                    // . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_width_skins . '</td>'
                    // . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_drop_skins . '</td>'
                    ...
                    . '</tr>';
                    $window_price_sheet_6_calculation_quote_tables_1 .= '';
                    $window_price_sheet_6_calculation_quote_tables_2 .= '<tr nobr="true" style="border: 1px solid #000000;  font-size:14px;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;  font-size:14px;">' . $window_price_sheet_6_calculation_quote_item_drop_skins . '</td>'
