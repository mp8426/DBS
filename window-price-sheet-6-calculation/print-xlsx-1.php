...
$window_price_sheet_6_calculation_code = filter_input(INPUT_GET, 'code');
...
while ($stmt_1->fetch()) {
    ...
    $query_3 = "SELECT code, location, width_x, drop_x, type, material, colour FROM window_price_sheet_6_calculation_quote_items WHERE window_price_sheet_6_calculation_code = ? AND cid = ? ORDER BY id ASC";

    $stmt_3 = $mysqli->prepare($query_3);
    $stmt_3->bind_param('ss', $window_price_sheet_6_calculation_code, $cid);
    $stmt_3->execute();
    $stmt_3->bind_result($window_price_sheet_6_calculation_quote_item_code, $window_price_sheet_6_calculation_quote_item_location, $window_price_sheet_6_calculation_quote_item_width, $window_price_sheet_6_calculation_quote_item_drop, $window_price_sheet_6_calculation_quote_item_type, $window_price_sheet_6_calculation_quote_item_material, $window_price_sheet_6_calculation_quote_item_colour);
    $stmt_3->store_result();

    if ($stmt_3->num_rows()) {

    if($calculation_name === 'Ziptrak'){
        $window_price_sheet_6_calculation_quote_tables = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                . '<tr>'
                ...
                $window_price_sheet_6_calculation_quote_tables_1 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                        . '<tr>'
                ...
                $window_price_sheet_6_calculation_quote_tables_2 = '<table cellspacing="0" cellpadding="4" style="font-size: 0.7em; text-align: center;" border="1">'
                . '<tr>'
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_2 = "SELECT name, width FROM window_price_sheet_6_calculation_quote_item_per_meters WHERE window_price_sheet_6_calculation_quote_item_code = ? AND window_price_sheet_6_calculation_code = ? AND cid = ?";
            ...
            $stmt_3_2->execute();
            $stmt_3_2->bind_result($window_price_sheet_6_calculation_quote_item_per_meter_name, $window_price_sheet_6_calculation_quote_item_per_meter_width);
            $stmt_3_2->fetch();
            $stmt_3_2->close();
            ...
            while ($stmt_3_1->fetch()) {
                ...
                // if ($window_price_sheet_6_calculation_quote_item_field_name === 'Locations') {
                //     $window_price_sheet_6_calculation_quote_item_location_1 = $window_price_sheet_6_calculation_quote_item_field_name;
                // }

                if ($window_price_sheet_6_calculation_field_name === 'Tube Type') {
                    $window_price_sheet_6_calculation_quote_item_Tube_Type = $window_price_sheet_6_calculation_quote_item_field_name;
                }

                /*if ($window_price_sheet_6_calculation_quote_item_field_name === 'Base_Rail_Heading_Type') {
                    $window_price_sheet_6_calculation_quote_item_Base_Rail_Heading_Type = $window_price_sheet_6_calculation_quote_item_field_name;
                }*/
                ...
                if ($window_price_sheet_6_calculation_field_name === 'Control Type') {
                    ...
                    /*if ($window_price_sheet_6_calculation_quote_item_per_meter_name === "Rs") {
                        $window_price_sheet_6_calculation_quote_item_width_skins = $window_price_sheet_6_calculation_quote_item_width - explode(' | ', $window_price_sheet_6_calculation_quote_item_field_name)[1];
                        $window_price_sheet_6_calculation_quote_item_mounting_rail_length = $window_price_sheet_6_calculation_quote_item_width - explode(' | ', $window_price_sheet_6_calculation_quote_item_field_name)[2];
                    } else
                    if ($window_price_sheet_6_calculation_quote_item_per_meter_name === "Rl") {
                        $window_price_sheet_6_calculation_quote_item_width_skins = $window_price_sheet_6_calculation_quote_item_width - explode(' | ', $window_price_sheet_6_calculation_quote_item_field_name)[3];
                    } else {
                        $window_price_sheet_6_calculation_quote_item_width_skins = "N/A";
                        $window_price_sheet_6_calculation_quote_item_mounting_rail_length = "N/A";
                    }*/
                    
                    // Strat Edit 12-11-2021
					// $window_price_sheet_6_calculation_quote_item_width_skins_Tube_Length = $window_price_sheet_6_calculation_quote_item_width - explode(' | ', $window_price_sheet_6_calculation_quote_item_field_name)[1];
					// $window_price_sheet_6_calculation_quote_item_width_skins = $window_price_sheet_6_calculation_quote_item_width - explode(' | ', $window_price_sheet_6_calculation_quote_item_field_name)[3];
                ...
                if ($window_price_sheet_6_calculation_field_name === 'Fitting') {
                    ...
                    //     $window_price_sheet_6_calculation_quote_item_width_skins = $window_price_sheet_6_calculation_quote_item_width - 31;
                    // }
                    // if($window_price_sheet_6_calculation_quote_item_field_name === "FF"){
                    //     $window_price_sheet_6_calculation_quote_item_width_skins = $window_price_sheet_6_calculation_quote_item_width - 26;
                    // }
                }
                if ($window_price_sheet_6_calculation_field_name === 'Track Colour') {
                ...
                if ($window_price_sheet_6_calculation_field_name === 'Fixing') {
                ...
                if ($window_price_sheet_6_calculation_field_name === 'Hood / Brackets') {
                    $window_price_sheet_6_calculation_quote_item_Hood_Type = $window_price_sheet_6_calculation_quote_item_field_name;
                }

                if ($window_price_sheet_6_calculation_field_name === 'Hood / Bracket Colour') {
                ...
                if ($window_price_sheet_6_calculation_field_name === 'Box Size') {
                    $window_price_sheet_6_calculation_quote_item_box_size = $window_price_sheet_6_calculation_quote_item_field_name;
                    
                }

                /* if ($window_price_sheet_6_calculation_quote_item_field_name === 'No_Of_Rail_Brackets') {
                  $window_price_sheet_6_calculation_quote_item_No_Of_Rail_Brackets = $window_price_sheet_6_calculation_quote_item_field_name;
                  }

                  if ($window_price_sheet_6_calculation_quote_item_field_name === 'Bracket_Covers') {
                  $window_price_sheet_6_calculation_quote_item_Bracket_Covers = $window_price_sheet_6_calculation_quote_item_field_name;
                  } */
            }
            $stmt_3_1->close();
            ...
            if($calculation_name === 'Ziptrak'){
                ...
                $window_price_sheet_6_calculation_quote_item_Side_Spline_Size = $window_price_sheet_6_calculation_quote_item_drop - 90;
        
                $window_price_sheet_6_calculation_quote_item_Bottom_Rail_Size = $window_price_sheet_6_calculation_quote_item_width - 99;
                $window_price_sheet_6_calculation_quote_item_Hood_size = $window_price_sheet_6_calculation_quote_item_width - 7;
                $window_price_sheet_6_calculation_quote_item_Central_Flat_Bar_Size = ceil(($window_price_sheet_6_calculation_quote_item_Bottom_Rail_Size/2) - 80);
                $window_price_sheet_6_calculation_quote_item_Weight_Size = $window_price_sheet_6_calculation_quote_item_width - 199;
                $window_price_sheet_6_calculation_quote_item_Tube_size = $window_price_sheet_6_calculation_quote_item_width - 100;
                $window_price_sheet_6_calculation_quote_item_Key_Way_Side = $window_price_sheet_6_calculation_quote_item_width - 100;
                $window_price_sheet_6_calculation_quote_item_Skins_width_size = $window_price_sheet_6_calculation_quote_item_width - 90;
                $window_price_sheet_6_calculation_quote_item_Skins_drop_size = $window_price_sheet_6_calculation_quote_item_drop + 150;

            $window_price_sheet_6_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_6_calculation_quote_item_type)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Side_Spline_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_6_calculation_quote_item_Hood_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Hood_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_fitting_type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_track_Colour . '</td>'
                    . '</tr>';

                    $window_price_sheet_6_calculation_quote_tables_1 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_location)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_material)[0] . ' - ' . explode('<->', $window_price_sheet_6_calculation_quote_item_type)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_colour)[0] . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_width . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_drop . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Skins_width_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Skins_drop_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Controls . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Control_Side . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Side_Spline_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Side_Spline_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Tube_Type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_6_calculation_quote_item_Tube_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_6_calculation_quote_item_Hood_Type . '</td>'
                            //. '<td>' . $window_price_sheet_6_calculation_quote_item_mounting_rail_length . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Hood_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Hood_size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Rail_Type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Rail_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Rail_Size . '</td>'
        
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Bar_Seal . '</td>'
                            
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Fittment . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_fitting_type . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_track_Colour . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Weight_Size . '</td>'
                            . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Central_Flat_Bar_Size . '</td>'
                    ...
                    $window_price_sheet_6_calculation_quote_tables_2 .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $quote_item_no . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_width . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_drop . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_width_skins . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_drop_skins . '</td>'
            ...
            $window_price_sheet_6_calculation_quote_tables .= '<tr nobr="true" style="border: 1px solid #000000;" >'
                    ...
                    . '<td style="text-align: center; border: 1px solid #000000;">' . explode('<->', $window_price_sheet_6_calculation_quote_item_colour)[0] . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Tube_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_width_skins_Tube_Length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Control_Side . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Controls . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bracket_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Bar_Size . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Bar_Type . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Bottom_Bar_Colour . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_width . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000; ">' . $window_price_sheet_6_calculation_quote_item_drop . '</td>'
                    //. '<td>' . $window_price_sheet_6_calculation_quote_item_mounting_rail_length . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Direction . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Fit . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Chain_Colour . '</td>'
                    . '<td style="text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_Chain_Size . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_width_skins . '</td>'
                    . '<td style="background-color: #f2f2f2; text-align: center; border: 1px solid #000000;">' . $window_price_sheet_6_calculation_quote_item_drop_skins . '</td>'
                    //. '<td>' . get_price_from_csv($csv_price_sheet, $window_price_sheet_6_calculation_quote_item_width, $window_price_sheet_6_calculation_quote_item_drop) . '</td>'
                    //. '<td style="background-color: #ff0;">' . $window_price_sheet_6_calculation_quote_item_No_Of_Rail_Brackets . '</td>'
                    //. '<td>' . $window_price_sheet_6_calculation_quote_item_Bracket_Covers . '</td>'
                    . '</tr>';
        ...
        $window_price_sheet_6_calculation_quote_tables_2 .= '</table>';
    } else {
        // $window_price_sheet_6_calculation_quote_tables .= "";
        $window_price_sheet_6_calculation_quote_tables_1 .= "";
        $window_price_sheet_6_calculation_quote_tables_2 .= "";
    }
