...
$query_1 = "SELECT name, locations, materials_and_colours, accessories, per_meters, fitting_charges FROM window_panel_glide_calculations WHERE code = ? ORDER BY position ASC";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('s', $window_panel_glide_calculation_code);
$stmt_1->execute();
$stmt_1->bind_result($window_panel_glide_calculation_name, $locations_select, $materials_and_colours_select, $accessories_select, $per_meters_select, $fitting_charges_select);
$stmt_1->store_result();
...
while ($stmt_1->fetch()) {
    ...
    $panel_th = $panel_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">Panels</td>' : '';
    $field_th_right = '';
    $field_th_left = '';
    ...
    $query_2 = "SELECT code, name, side FROM window_panel_glide_calculation_fields WHERE order_sheet = 1 AND window_panel_glide_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT window_panel_glide_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "window_panel_glide_calculation_fields.order_sheet = 1 AND "
            ...
            $location_td = $locations_select === 1 && $location_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_location)[0] . '</td>' : '';
            $width_x_td = $width_x_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_panel_glide_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_panel_glide_calculation_quote_item_drop . '</td>' : '';
            $type_td = $type_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_type)[0] . '</td>' : '';
            $material_td = $materials_and_colours_select === 1 && $material_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_material)[0] . '</td>' : '';
            $colour_td = $materials_and_colours_select === 1 && $colour_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_colour)[0] . '</td>' : '';
            $panel_td = $panel_print[2] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_panel_glide_calculation_quote_item_panel . '</td>' : '';
            $price_td = $price_print[2] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_panel_glide_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($window_panel_glide_calculation_quote_item_notes || $window_panel_glide_calculation_quote_item_accessories || $window_panel_glide_calculation_quote_item_per_meters || $window_panel_glide_calculation_quote_item_fitting_charges) {
                ...
                if ($window_panel_glide_calculation_quote_item_notes && $note_print[2] === '1') {
                ...
                if ($window_panel_glide_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[2] === '1') {
                ...
                if ($window_panel_glide_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[2] === '1') {
                ...
                if ($window_panel_glide_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[2] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[2] === '1' && $window_panel_glide_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[2] === '1' && $window_panel_glide_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[2] === '1' && $window_panel_glide_calculation_quote_item_fitting_charges
                ) {
