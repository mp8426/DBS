...
while ($stmt_1->fetch()) {
    ...
    $panel_th = $panel_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">Panels</td>' : '';
    $field_th_right = '';
    $field_th_left = '';
...
//                }
            ...
            $location_td = $locations_select === 1 && $location_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_location)[0] . '</td>' : '';
            $width_x_td = $width_x_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_panel_glide_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . $window_panel_glide_calculation_quote_item_drop . '</td>' : '';
            $type_td = $type_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_type)[0] . '</td>' : '';
            $material_td = $materials_and_colours_select === 1 && $material_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_material)[0] . '</td>' : '';
            $colour_td = $materials_and_colours_select === 1 && $colour_print[1] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $window_panel_glide_calculation_quote_item_colour)[0] . '</td>' : '';
            $panel_td = $panel_print[1] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_panel_glide_calculation_quote_item_panel . '</td>' : '';
            $price_td = $price_print[1] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_panel_glide_calculation_quote_item_price, 2) . '</td>' : '';
