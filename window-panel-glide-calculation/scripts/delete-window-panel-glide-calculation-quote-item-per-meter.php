...
$query_1 = "DELETE FROM window_panel_glide_calculation_quote_item_per_meters WHERE code = ? AND window_panel_glide_calculation_quote_item_code = ? AND window_panel_glide_calculation_code = ? AND cid = ?";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('ssss', $per_meter_code, $window_panel_glide_calculation_quote_item_code, $window_panel_glide_calculation_code, $cid);
