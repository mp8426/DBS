$(function() {
        ...
        success: function(data) {
            ...
            if (data[0] === 1) {
                ...
                $.each(data[1], function(index, value) {
                    ...
                    if (value.accessories_select_2 === 1) {

                        var accessory_2_element = "";
                        var accessory_2_options = "";
                        // var accessory_2_option_array = '';
                        var accessory_2_option_array = '<input type="hidden" class="accessory-2-option-array" value=\'' + JSON.stringify(value.accessory_2_options) + '\'>';

                        $.each(value.accessory_2_options, function(accessory_2_option_index, accessory_2_option_value) {
                            accessory_2_options += '<option data-code="' + accessory_2_option_value.code + '" value="' + accessory_2_option_value.code + '<->' + accessory_2_option_value.name + '<->' + accessory_2_option_value.price + '">' + accessory_2_option_value.name + ' | ' + accessory_2_option_value.price + '</option>';
                        });
                        accessory_2_element = '<span class="window-price-sheet-calculation-accessories-2-wrapper">\n\
                                                <select class="window-price-sheet-calculation-accessories-2">\n\
                                                    <option value="">Packers, Angles & Brackets</option>\n\
                                                    ' + accessory_2_options + '\
                                                </select>\n\
                                                <input type="tel" class="add-window-price-sheet-calculation-accessory-2-mm qty-input" placeholder="mm">\n\
                                                <input type="tel" class="add-window-price-sheet-calculation-accessory-2-qty qty-input" placeholder="Qty">\n\
                                                <input type="button" class="add-window-price-sheet-calculation-accessories-2 bttn-input" value="✚">\n\
                                            </span>';

                    } else {
                        accessory_2_element = '';
                        accessory_2_option_array = '';
                    }
                    ...
                    if (value.status === 1) {
                        ...
                        $('<div id="tab-' + value.code + '" class="window-price-sheet-calculation-tab-div"></div>')
                            .append($('<form class="add-window-price-sheet-calculation-quote-item-form ' + etape_activated + '" action="./" method="POST"></form>')
                                ...
                                .append(accessory_2_option_array)
    ...
    $(document).on("submit", ".add-window-price-sheet-calculation-quote-item-form", function(event) {
        ...
        var accessory_2_option_array = this_form.find(".accessory-2-option-array").val();
            ...
            success: function(data) {
                ...
                if (data[0] === 1) {
                    ...
                    $.each(data[1], function(index, code) {
                        ...
                        if (accessory_2_option_array) {

                            var accessory_2_element = "";
                            var accessory_2_options = "";

                            $.each(JSON.parse(accessory_2_option_array), function(accessory_2_option_index, accessory_2_option_value) {
                                accessory_2_options += '<option data-code="' + accessory_2_option_value.code + '" value="' + accessory_2_option_value.code + '<->' + accessory_2_option_value.name + '<->' + accessory_2_option_value.price + '">' + accessory_2_option_value.name + ' | ' + accessory_2_option_value.price + '</option>';
                            });
                            accessory_2_element = '<span class="window-price-sheet-calculation-accessories-2-wrapper">\n\
                                                    <select class="window-price-sheet-calculation-accessories-2">\n\
                    ...
                    result_parent.find('.bulk-action-button-wrapper').html('<input type="button" class="bulk-action-button window-price-sheet-calculation-select-all-bttn" value="✔">\n\
                                                                            ...
                                                                            <form style="display: contents; margin-right: -6px; font-size: 14px;">\n\
                                                                            <input type="tel" class="production-date quote_details" id="production-date" data-customer-id="' + customer_id + '" data-customer-no="' + customer_no + '" data-quote-id="' + quote_id + '" data-quote-no="' + quote_no + '" data-job-no="' + job_no + '"  data-pro-code="' + window_price_sheet_calculation_code + '" placeholder="Production Date" autocomplete="off" value=""style="width:100px; height:35px !important; margin-left:2px; margin-right:2px;text-align: center; border-radius: 6px; border: 1px solid #cdd5da;  ' +  approved_date + '">\n\
    ...
    $(document).on("keypress", ".add-window-price-sheet-calculation-accessory-2-qty", function(event) {
        if (event.keyCode === 13) {
            event.preventDefault();
            var this_element = $(this);
            var add_bttn = this_element.siblings('.add-window-price-sheet-calculation-accessories-2');
            add_bttn.click();
        }
    });

    $(document).on("click", ".add-window-price-sheet-calculation-accessories-2", function() {

        var this_bttn = $(this);
        var this_form = this_bttn.parents('.update-window-price-sheet-calculation-quote-item-form');
        var accessory_2_element = this_bttn.siblings('.window-price-sheet-calculation-accessories-2');
        var accessory_2_qty_element = this_bttn.siblings('.add-window-price-sheet-calculation-accessory-2-qty');
        var accessory_2_mm_element = this_bttn.siblings('.add-window-price-sheet-calculation-accessory-2-mm');

        var window_price_sheet_calculation_code = this_form.find('.window-price-sheet-calculation-code').val();
        var window_price_sheet_calculation_quote_item_code = this_form.find('.window-price-sheet-calculation-quote-item-code').val();
        var accessory = accessory_2_element.val();
        var accessory_mm = accessory_2_mm_element.val();
        var accessory_qty = +accessory_2_qty_element.val();
        accessory_qty = accessory_qty !== 0 ? accessory_qty : 1;
        ...
        if (accessory) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    this_bttn.prop('disabled', false).addClass('field-loader');
                    accessory_2_element.addClass('field-loader');
                    accessory_2_qty_element.addClass('field-loader');
                    accessory_2_mm_element.addClass('field-loader');
                },
                success: function(data) {
                    if (data[0] === 4) {
                        document.location.replace(data[1]);
                    ...
                    if (data[0] === 2) {
                        this_bttn.prop('disabled', false).removeClass('field-loader');
                        accessory_2_element.removeClass('field-loader');
                        accessory_2_qty_element.removeClass('field-loader');
                        accessory_2_mm_element.removeClass('field-loader');
                        alert(data[1]);
                    } else
                    if (data[0] === 1) {
                        ...
                        // accessory_element.find('option[data-code="' + accessory_code + '"]').hide();
                        accessory_2_element.val("").focus();
                        accessory_2_qty_element.val("");
                        accessory_2_mm_element.val("");
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    ...
                    accessory_2_mm_element.removeClass('field-loader');
                    alert(JSON.stringify(jqXHR));
                    alert("Error! @add-window-price-sheet-calculation-quote-item-accessory-2");
                }
            });
        }
    });
