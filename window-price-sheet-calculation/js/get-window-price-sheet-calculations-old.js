                ...
                $.each(data[1], function (index, value) {
                    ...
                    if (value.materials_and_colour_select === 1) {
                        ...
                        var material_element = '<td>\n\
                                                    <select name="material" data-column="material" class="window-price-sheet-calculation-material data-field approved-disabled">\n\
                                                        <option value=""></option>\n\
                                                    </select>\n\
                                                </td>';
                        var colour_header = '<th>Colours</th>';
                        var colour_element = '<td>\n\
                                                    <select name="colour" data-column="colour" class="window-price-sheet-calculation-colour data-field approved-disabled">\n\
                                                        <option value=""></option>\n\
                                                    </select>\n\
                        ...
                        if (field_value.side === 1) { //left side
                            ...
                            if (field_value.field_type === 0) {
                                ...
                                field_element_left += '<td>\n\
                                                        <select name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="window-price-sheet-calculation-field data-field">\n\
                                                            <option value=""></option>\n\
                                                            ' + field_options + '\
                                                        </select>\n\
                                ...
                                field_element_left += '<td>\n\
                                                        <input type="text" name="field[' + field_value.code + ']" data-code="' + field_value.code + '" data-column="field-' + field_value.code + '" class="window-price-sheet-calculation-field data-field text-field" autocomplete="off">\n\
                                                    </td>';
                            }
                        }
                    ...
                    if (value.status === 1) {
                        ...
                        $('<li><a href="#tab-' + value.code + '">' + value.name + '</a></li>').prependTo("#window-price-sheet-calculation-tabs .tabs ul");
                                        ...
                                        .append($('<table class="window-price-sheet-calculation-table"></table>')
                                                ...
                                                .append($('<tbody></tbody>')
                                                        .append($('<tr class="tbody-tr"></tr>')
                                                                ...
                                                                .append('<td><input type="tel" name="width" data-column="width_x" class="window-price-sheet-calculation-width number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="mm"></td>')
                                                                .append('<td><input type="tel" name="drop" data-column="drop_x" class="window-price-sheet-calculation-drop number-input data-field" maxlength="4" autocomplete="off" min="0" placeholder="mm"></td>')
                                                                .append(type_element)
                    ...
                    if (JSON.stringify(value.quote_items) !== '[]') {
                        ...
                        $('<div id="window-price-sheet-calculation-quote-items-wrapper-' + window_price_sheet_calculation_code + '" class="window-price-sheet-calculation-quote-items-wrapper"></div>')
                                ...
                                .append('<div id="quote-items-body-' + window_price_sheet_calculation_code + '" class="window-price-sheet-calculation-quote-items-body"></div>')
                                .append('<div class="bulk-action-button-wrapper">\n\
                                            ...
                                            <a href="print/order-sheet-window-price-sheet-calculation-' + window_price_sheet_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 145px;">Print Order Sheet</a>\n\
                                            <a href="https://file-gen.blinq.com.au/clients/' + user_account + '/order-sheet-xlsx-window-price-sheet-calculation-' + window_price_sheet_calculation_code + '-' + cid + '" target="_blank" class="bulk-action-button print-bttn" style="width: 175px;">Print Order Sheet Xlsx</a>\n\
                                        ...
                                        ).prependTo("#window-price-sheet-calculation-quote-items-results").find(".bttn-input, .bulk-action-button").button();
                        ...
                        $.each(value.quote_items, function (quote_item_index, quote_item_value) {
                            ...
                            $('<form id="calculation-form-' + quote_item_value.code + '" class="update-window-price-sheet-calculation-quote-item-form" action="./" method="POST">\n\
                                    ...
                                    <table class="window-price-sheet-calculation-table">\n\
                                        ...
                                        <tbody>\n\
                                            <tr>\n\
                                                ...
                                                ' + field_element_left + '\
                                                ' + location_element + '\
                                                <td><input type="tel" name="width" data-column="width_x" class="window-price-sheet-calculation-width number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.width + '" placeholder="mm"></td>\n\
                                                <td><input type="tel" name="drop" data-column="drop_x" class="window-price-sheet-calculation-drop number-input data-field" maxlength="4" autocomplete="off" min="0" value="' + quote_item_value.drop + '" placeholder="mm"></td>\n\
                                                ' + type_element + '\
                                                ' + material_element + '\
                                                ' + colour_element + '\
                                                ' + field_element_right + '\
    ...
    $(document).on("click", ".add-window-price-sheet-calculation-accessories", function () {
        ...
        if (accessory) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: {cid: cid, window_price_sheet_calculation_code: window_price_sheet_calculation_code, window_price_sheet_calculation_quote_item_code: window_price_sheet_calculation_quote_item_code, accessory: accessory, accessory_qty: accessory_qty},
                beforeSend: function () {
                    this_bttn.prop('disabled', false).addClass('field-loader');
