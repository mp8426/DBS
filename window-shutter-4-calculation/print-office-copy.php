    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                ...
                if ($window_shutter_4_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #000000;">' . $window_shutter_4_calculation_quote_item_field_name . $window_shutter_4_calculation_quote_item_field_price_x . '</td>';
                }
                if ($window_shutter_4_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #000000;">' . $window_shutter_4_calculation_quote_item_field_name . $window_shutter_4_calculation_quote_item_field_price_x . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $width_x_td = $width_x_print[0] === '1' ? '<td style="border: 0.5px solid #000000; font-size:1.3em;"><strong>' . $window_shutter_4_calculation_quote_item_width . '</strong></td>' : '';
            $drop_x_td = $drop_x_print[0] === '1' ? '<td style="border: 0.5px solid #000000; font-size:1.3em;"><strong>' . $window_shutter_4_calculation_quote_item_drop . '</strong></td>' : '';
            ...
            $window_shutter_4_calculation_quote_items .= '<table cellpadding="4" cellspacing="0" style="text-align: center;" nobr="true">'
                    ...
                    . $width_x_td
                    . $drop_x_td
                    . '<td style="border: 0.5px solid #000000; font-size:1.3em;"><strong>' . number_format($window_shutter_4_calculation_quote_item_sqm, 2) . '</strong></td>'
                    . $type_td
                 //   . $table_td
                    . $field_td_right
                    . $price_td
