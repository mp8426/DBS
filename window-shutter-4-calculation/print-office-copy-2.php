...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        $window_shutter_4_calculation_quote_tables .= $window_shutter_4_calculation_table_header . $quote_items . $table_more . $window_shutter_4_calculation_sqm_total_tot . $window_shutter_4_calculation_total . "<div></div>";
    } else {
        $window_shutter_4_calculation_quote_tables .= "";
    }
    $stmt_3->close();
