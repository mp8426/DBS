    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            while ($stmt_3_1->fetch()) {
                if ($window_shutter_4_calculation_field_side === 0) { // Right Side
                    $field_td_right .= '<td style="border: 0.5px solid #787877;">' . $window_shutter_4_calculation_quote_item_field_name . '</td>';
                }
                if ($window_shutter_4_calculation_field_side === 1) { // Left Side
                    $field_td_left .= '<td style="border: 0.5px solid #787877;">' . $window_shutter_4_calculation_quote_item_field_name . '</td>';
                }
            }
            $stmt_3_1->close();
            ...
            $location_td = $locations_select === 1 && $location_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_shutter_4_calculation_quote_item_location)[0] . '</td>' : '';
            $width_x_td = $width_x_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_shutter_4_calculation_quote_item_width . '</td>' : '';
            $drop_x_td = $drop_x_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . $window_shutter_4_calculation_quote_item_drop . '</td>' : '';
            $type_td = $type_print[1] === '1' ? '<td style="border: 0.5px solid #787877;">' . explode('<->', $window_shutter_4_calculation_quote_item_type)[0] . '</td>' : '';
            $price_td = $price_print[1] === '1' ? '<td style="text-align: right; border: 0.5px solid #787877;">' . number_format($window_shutter_4_calculation_quote_item_price, 2) . '</td>' : '';
            ...
            if ($window_shutter_4_calculation_quote_item_notes || $window_shutter_4_calculation_quote_item_accessories || $window_shutter_4_calculation_quote_item_per_meters || $window_shutter_4_calculation_quote_item_fitting_charges) {
                ...
                if ($accessories_select === 1 && $accessory_print[1] === '1' && $window_shutter_4_calculation_quote_item_accessories ||
