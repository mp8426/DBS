...
while ($stmt_1->fetch()) {
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $qty_td = $qty_select === 1 && $qty_print[1] === '1' ? '<td style="text-align: center; border: 0.5px solid #000000;">' . $window_shutter_4_calculation_quote_item_qty . '</td>' : '';
            $total_td = $qty_select === 1 && $total_print[1] === '1' ? '<td style="text-align: right; border: 0.5px solid #000000;">' . number_format($window_shutter_4_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($window_shutter_4_calculation_quote_item_notes || $window_shutter_4_calculation_quote_item_accessories || $window_shutter_4_calculation_quote_item_per_meters || $window_shutter_4_calculation_quote_item_fitting_charges) {
                ...
                if ($window_shutter_4_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[1] === '1') {
                ...
                if ($window_shutter_4_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[1] === '1') {
                ...
                if ($window_shutter_4_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[1] === '1') {
                ...
                if (
                    $accessories_select === 1 && $accessory_print[1] === '1' && $window_shutter_4_calculation_quote_item_accessories ||
                    $per_meters_select === 1 && $per_meter_print[1] === '1' && $window_shutter_4_calculation_quote_item_per_meters ||
                    $fitting_charges_select === 1 && $fitting_charge_print[1] === '1' && $window_shutter_4_calculation_quote_item_fitting_charges
                ) {
