...
while ($stmt_1->fetch()) {
    ...
    $required_unit_th = $required_unit_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">Required Unit</td>' : '';
    $square_meter_th = $square_meter_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">Square Meter</td>' : '';
    ...
    $query_2 = "SELECT code, name, side FROM flooring_sqm_calculation_fields WHERE " . $print_type . " = 1 AND flooring_sqm_calculation_code = ? ORDER BY position ASC";
    ...
    $flooring_sqm_calculation_table_header = '<table><thead>'
            . '<tr><th colspan="' . $tot_th_colspan_x . '"><strong>' . $flooring_sqm_calculation_name . '</strong></th></tr>'
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT flooring_sqm_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_sqm_calculation_fields." . $print_type . " = 1 AND "
            ...
            while ($stmt_3_2->fetch()) {
                ...
                $flooring_sqm_calculation_quote_item_accessories .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Accessory - ' . $flooring_sqm_calculation_quote_item_accessory_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $flooring_sqm_calculation_quote_item_accessory_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $flooring_sqm_calculation_quote_item_accessory_qty . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($flooring_sqm_calculation_quote_item_accessory_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_3->fetch()) {
                ...
                $flooring_sqm_calculation_quote_item_per_meters .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Per Meter - ' . $flooring_sqm_calculation_quote_item_per_meter_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $flooring_sqm_calculation_quote_item_per_meter_price . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: center;">' . $flooring_sqm_calculation_quote_item_per_meter_width . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . number_format($flooring_sqm_calculation_quote_item_per_meter_total, 2) . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            while ($stmt_3_4->fetch()) {
                ...
                $flooring_sqm_calculation_quote_item_fitting_charges .= '<tr>'
                        ...
                        . '<td style="border: 1px solid #000000; text-align: left;" colspan="' . $tot_th_colspan_for_acc . '">Fitting Charge - ' . $flooring_sqm_calculation_quote_item_fitting_charge_name . '</td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;"></td>'
                        . '<td style="border: 1px solid #000000; text-align: right;">' . $flooring_sqm_calculation_quote_item_fitting_charge_price . '</td>'
                        . $extra_td
                        . '</tr>';
            ...
            $location_td = $locations_select === 1 && $location_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_unit . '</td>' : '';
            $manufacturer_td = $manufacturer_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_manufacturer)[0] . '</td>' : '';
            $collection_td = $collection_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_collection)[0] . '</td>' : '';
            $colour_td = $colour_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_colour)[0] . '</td>' : '';
            $required_unit_td = $required_unit_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_required_unit . '</td>' : '';
            $square_meter_td = $square_meter_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_collection_sqm . '</td>' : '';
            $cost_td = $cost_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . number_format($flooring_sqm_calculation_quote_item_collection_cost, 2) . '</td>' : '';
            $markup_td = $markup_print[$no] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_collection_markup . '%</td>' : '';
            $price_td = $price_print[$no] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_sqm_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[$no] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_sqm_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($flooring_sqm_calculation_quote_item_notes || $flooring_sqm_calculation_quote_item_accessories || $flooring_sqm_calculation_quote_item_per_meters || $flooring_sqm_calculation_quote_item_fitting_charges) {
                ...
                if ($flooring_sqm_calculation_quote_item_notes && $note_print[$no] === '1') {

                    $flooring_sqm_calculation_quote_item_notes_table = '<tr>'
                ...
                if ($flooring_sqm_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[$no] === '1') {

                    $flooring_sqm_calculation_quote_item_accessories_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                ...
                if ($flooring_sqm_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[$no] === '1') {

                    $flooring_sqm_calculation_quote_item_per_meters_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($flooring_sqm_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1') {

                    $flooring_sqm_calculation_quote_item_fitting_charges_table = '<tr style="font-weight: bold; background-color: #f2f2f2;">'
                            . '<th style="border: 1px solid #000000; text-align: left;">#</th>'
                ...
                if ($accessories_select === 1 && $accessory_print[$no] === '1' && $flooring_sqm_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[$no] === '1' && $flooring_sqm_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[$no] === '1' && $flooring_sqm_calculation_quote_item_fitting_charges
                ) {


                    $table_more .= $flooring_sqm_calculation_quote_item_accessories_table
                            . $flooring_sqm_calculation_quote_item_per_meters_table
                            . $flooring_sqm_calculation_quote_item_fitting_charges_table;
                } else {
                    $table_more .= "";
            ...
            $flooring_sqm_calculation_quote_items .= '<tr>'
            ...
            if ($group_discount_print[$no] === '1') {
                ...
                $flooring_sqm_calculation_total = '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_sqm_calculation_total_table_colspan . '">Sub Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($flooring_sqm_calculation_quote_item_price_sub_total, 2) . '</th>'
                        . '</tr>'
                        . '<tr style="border: 1px solid #000000;">'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_sqm_calculation_total_table_colspan . '">Discount (' . $flooring_sqm_calculation_quote_item_discount . ' % ) </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">-' . number_format($flooring_sqm_calculation_quote_item_discount_value, 2) . '</th>'
                        . '</tr>'
                        . '<tr>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;" colspan="' . $flooring_sqm_calculation_total_table_colspan . '">Total </th>'
                        . '<th style="border: 1px solid #000000; text-align: right; font-weight: bold;">' . number_format($flooring_sqm_calculation_quote_item_price_total, 2) . '</th>'
                        . '</tr>';
            } else {
        ...
        $flooring_sqm_calculation_quote_tables .= $flooring_sqm_calculation_table_header . $flooring_sqm_calculation_quote_items . $flooring_sqm_calculation_total . "</tbody></table>";
        $flooring_sqm_calculation_quote_tables_2 .= "";
    } else {
        $flooring_sqm_calculation_quote_tables .= "";
        $flooring_sqm_calculation_quote_tables_2 .= "";
    }
