...
$query_1 = "SELECT name, locations, accessories, per_meters, fitting_charges FROM flooring_sqm_calculations WHERE code = ? ORDER BY position ASC";

$stmt_1 = $mysqli->prepare($query_1);
$stmt_1->bind_param('s', $flooring_sqm_calculation_code);
$stmt_1->execute();
$stmt_1->bind_result($flooring_sqm_calculation_name, $locations_select, $accessories_select, $per_meters_select, $fitting_charges_select);
$stmt_1->store_result();
...
while ($stmt_1->fetch()) {
    ...
    $required_unit_th = $required_unit_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">Required Unit</td>' : '';
    $square_meter_th = $square_meter_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">Square Meter</td>' : '';
    ...
    $query_2 = "SELECT code, name, side FROM flooring_sqm_calculation_fields WHERE order_sheet = 1 AND flooring_sqm_calculation_code = ? ORDER BY position ASC";
    ...
    if ($stmt_3->num_rows()) {
        ...
        while ($stmt_3->fetch()) {
            ...
            $query_3_1 = "SELECT flooring_sqm_calculation_quote_item_fields.name, "
                    ...
                    . "WHERE "
                    . "flooring_sqm_calculation_fields.order_sheet = 1 AND "
            ...
            $location_td = $locations_select === 1 && $location_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_location)[0] . '</td>' : '';
            $unit_td = $unit_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_unit . '</td>' : '';
            $manufacturer_td = $manufacturer_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_manufacturer)[0] . '</td>' : '';
            $collection_td = $collection_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_collection)[0] . '</td>' : '';
            $colour_td = $colour_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . explode('<->', $flooring_sqm_calculation_quote_item_colour)[0] . '</td>' : '';
            $required_unit_td = $required_unit_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_required_unit . '</td>' : '';
            $square_meter_td = $square_meter_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_collection_sqm . '</td>' : '';
            $cost_td = $cost_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . number_format($flooring_sqm_calculation_quote_item_collection_cost, 2) . '</td>' : '';
            $markup_td = $markup_print[2] === '1' ? '<td style="border: 0.5px solid #000000;">' . $flooring_sqm_calculation_quote_item_collection_markup . '%</td>' : '';
            $price_td = $price_print[2] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_sqm_calculation_quote_item_price, 2) . '</td>' : '';
            $total_td = $total_print[2] === '1' ? '<td style="border: 0.5px solid #000000; text-align: right;">' . number_format($flooring_sqm_calculation_quote_item_total, 2) . '</td>' : '';
            ...
            if ($flooring_sqm_calculation_quote_item_notes || $flooring_sqm_calculation_quote_item_accessories || $flooring_sqm_calculation_quote_item_per_meters || $flooring_sqm_calculation_quote_item_fitting_charges) {
                ...
                if ($flooring_sqm_calculation_quote_item_notes && $note_print[2] === '1') {
                ...
                if ($flooring_sqm_calculation_quote_item_accessories && $accessories_select === 1 && $accessory_print[2] === '1') {
                ...
                if ($flooring_sqm_calculation_quote_item_fitting_charges && $fitting_charges_select === 1 && $fitting_charge_print[2] === '1') {
                ...
                if ($flooring_sqm_calculation_quote_item_per_meters && $per_meters_select === 1 && $per_meter_print[2] === '1') {
                ...
                if ($accessories_select === 1 && $accessory_print[2] === '1' && $flooring_sqm_calculation_quote_item_accessories ||
                        $per_meters_select === 1 && $per_meter_print[2] === '1' && $flooring_sqm_calculation_quote_item_per_meters ||
                        $fitting_charges_select === 1 && $fitting_charge_print[2] === '1' && $flooring_sqm_calculation_quote_item_fitting_charges
                ) {
